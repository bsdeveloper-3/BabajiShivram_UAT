<%@ Page Title="Shipment Get In" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ShipmentGetIn.aspx.cs"
    Inherits="ExportCHA_ShipmentGetIn" Culture="en-GB" EnableEventValidation="false" %>
        ...
        <ContentTemplate>
            ...
            <div>
                <asp:SqlDataSource ID="PendingJobForShipmentGetIn" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                    SelectCommand="EX_GetAllJobsForShipmentGetIn" SelectCommandType="StoredProcedure">
                    <SelectParameters>
