<%@ Page Title="New Export Job" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="JobEntry.aspx.cs" Inherits="ExportCHA_JobEntry" Culture="en-GB" %>
    ...
    <asp:UpdatePanel ID="upJobDetail" runat="server">
        <ContentTemplate>
            <div>
                ...
                <div class="m clear">
                    <asp:Button ID="btnSubmit" Text="Save Job" OnClientClick="return CheckFields();" 
                        OnClick="btnSubmit_Click" runat="server" ValidationGroup="Required" />
                ...
                <fieldset>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="white">
                        <tr>
                           ...
                           <td>
                              <asp:DropDownList ID="ddlPreAlertExport" runat="server" AutoPostBack="true"  Width="200px"
                        ...
                        <tr>
                            <td>Job Number
                                <asp:RequiredFieldValidator ID="rfvJObNo" runat="server" ValidationGroup="Required"
                                   InitialValue="" Display="Dynamic" SetFocusOnError="true" ControlToValidate="txtJobNumber"
                                    Text="*" ErrorMessage="Please Enter Job Number"> </asp:RequiredFieldValidator>
                                <%--<asp:RegularExpressionValidator ID="revJobNo" runat="server" ControlToValidate="txtJobNumber" Display="Dynamic"
                                    SetFocusOnError="true" ErrorMessage="Invalid Job Number (eg:CBMBOE-1617-00001603)" Text="Invalid Job Number"
                                    ValidationGroup="Required" ValidationExpression="^[A-Z]{6}(-)[0-9]{4}(-)[0-9]{8}$" ForeColor="Red"></asp:RegularExpressionValidator>--%>
                            </td>
                            <td>
                                <asp:TextBox ID="txtJobNumber" runat="server" Width="50%" ToolTip="Shows Job Number." Enabled="false"></asp:TextBox>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlBabajiBranch" runat="server" Width="150px" DataSourceID="DataSourceBranch" 
                        ...
                        <tr>
                            <td>Customer
                                <asp:RequiredFieldValidator ID="rfvCustomerName" ValidationGroup="Required" SetFocusOnError="true"
                                   InitialValue="" runat="server" Display="Dynamic" ControlToValidate="txtCustomer" 
                                    ErrorMessage="Please Enter Customer Name" Text="*"></asp:RequiredFieldValidator>
                            </td>
                            <td>
                                <asp:TextBox ID="txtCustomer" Width="70%" runat="server" ToolTip="Enter Customer Name."
                                    CssClass="SearchTextbox" placeholder="Search" AutoPostBack="true" OnTextChanged="txtCustomer_TextChanged"></asp:TextBox>
                            ...
                            <td>Shipper
                                ...
                                AccessKeySetFocusOnError="true" Display="Dynamic" ControlToValidate="ddlShipper" ErrorMessage="Please Select Shipper Name"
                                    Text="*" InitialValue="0"></asp:RequiredFieldValidator>
                            </td>
                            <td>
                                <asp:DropDownList ID="ddlShipper" runat="server" Width="70%" DataTextField="ShipperName" DataValueField="ShipperId"></asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddPlant" runat="server">
                                    <asp:ListItem Value="0" Text="-Select-"></asp:ListItem>
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtConsignee" runat="server" Width="70%" ToolTip="Enter Consignee."></asp:TextBox>
                                <asp:HiddenField ID="hdnConsigneeId" runat="server" Value="0" />
                            </td>
                            <td>Customer Reference No
                            </td>
                            <td>
                                <asp:TextBox ID="txtCustRefNo" MaxLength="100" ToolTip="Enter Customer Reference No"
                                    runat="server" Width="37%"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtBuyerName" runat="server" Width="70%" ToolTip="Enter Buyer Name."></asp:TextBox>
                            </td>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlMode" runat="server" Width="40%">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlTransportBy" runat="server" ToolTip="Select Transport By" Width="40%" AutoPostBack="true" OnSelectedIndexChanged="ddlTransportBy_OnSelectedIndexChanged"> 
                                    <asp:ListItem Text="-Select-" Value="0"></asp:ListItem>
                        ...
                        <tr id="trTpPickupLocation" runat="server" visible="false">
                            ...
                            <td>
                                <asp:TextBox ID="txtPickupLocation" runat="server" Width="70%" ToolTip="Enter Pickup Location From"></asp:TextBox>
                            </td>
                            <td>To 
                            ...
                            <td>
                                <asp:TextBox ID="txtLocationTo" MaxLength="100" ToolTip="Enter Destination To." 
                                    runat="server" Width="40%"></asp:TextBox>
                            </td>
                        </tr>
                        <tr id="trTpPickupPersonDetails" runat="server" visible="false"> 
                            <td>Pick Up Date
                            ...
                            <td>
                                <asp:TextBox ID="txtPickUpDate" runat="server" Width="100px" placeholder="dd/mm/yyyy"></asp:TextBox>
                                <asp:Image ID="imgPickUpDate" ImageAlign="Top" ImageUrl="../Images/btn_calendar.gif" runat="server" />
                            </td>
                            <td>Pick Up Person Name
                            </td>
                            <td>
                                <asp:TextBox ID="txtPickupPersonName" runat="server" ToolTip="Pickup Person Name." Width="40%"></asp:TextBox>
                            </td>
                        </tr>
                        <tr id="trTpPickupPersonDetails2" runat="server" visible="false">
                            <td>Mobile No
                            </td>
                            <td>
                                <asp:TextBox ID="txtPickupMobileNo" runat="server" ></asp:TextBox>
                            </td>
                            <td>Dimension
                            ...
                            <td>
                                <asp:TextBox ID="txtDimension" runat="server" MaxLength="10" Width="95%" TextMode="MultiLine" Rows="2"
                        ...
                        <tr>
                            <td>Port of Loading
                                <asp:RequiredFieldValidator ID="rfvPortOfDischarge" ValidationGroup="Required" runat="server"
                                    SetFocusOnError="true" ControlToValidate="txtPortOfLoading" InitialValue=""
                                    ErrorMessage="Please Select Port of Loading" Text="*" ForeColor="Red"></asp:RequiredFieldValidator>
                            </td>
                            <td>
                                <asp:TextBox ID="txtPortOfLoading" Width="60%" runat="server" CssClass="SearchTextbox"
                            ...
                            <td>
                                <asp:TextBox ID="txtPortOfDischarge" Width="70%" runat="server" CssClass="SearchTextbox"
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtCountry" runat="server" CssClass="SearchTextbox" placeholder="Search"
                                    Width="70%" ToolTip="Enter Consignment Country."></asp:TextBox>
                            ...
                            <td>
                                <asp:TextBox ID="txtDestinationCountry" runat="server" CssClass="SearchTextbox" placeholder="Search"
                                    Width="70%" ToolTip="Enter Final Destination Country"></asp:TextBox>
                        ...
                        <tr id="trMBL" runat="server">
                            ...
                            <td>
                                <asp:TextBox ID="txtMblNo" runat="server" MaxLength="50" Text='<%#Eval("MAWBNo") %>' ></asp:TextBox>
                            </td>
                            <td>MBL/MAWBL Date
                            ...
                            <td>
                                <asp:TextBox ID="txtMAWBDate" runat="server" Width="100px" placeholder="dd/mm/yyyy" Text='<%#Eval("MAWBDate","{0:dd/MM/yyyy}")%>'></asp:TextBox>
                        ...
                        <tr id="trHBL" runat="server">
                            ...
                            <td>
                                <asp:TextBox ID="txtHblNo" runat="server" MaxLength="50" Text='<%#Eval("HAWBNo") %>'></asp:TextBox>
                            </td>
                            <td>HBL/HAWBL Date
                            ...
                            <td>
                                <asp:TextBox ID="txtHAWBDate" runat="server" Width="100px" placeholder="dd/mm/yyyy" Text='<%#Eval("HAWBDate","{0:dd/MM/yyyy}")%>'></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td>
                                <%--<asp:DropDownList ID="ddlExportType" Width="40%" runat="server" DataSourceID="DataSourceExportType"
                                    DataTextField="sName" DataValueField="lid" ToolTip="Select Shipping Bill Type" AutoPostBack="true" OnSelectedIndexChanged="ddlExportType_OnSelectedIndexchanged">
                                    <asp:ListItem Selected="True" Text="-- Select Bill Type --" Value="0"></asp:ListItem>
                                </asp:DropDownList>--%>

                                <asp:DropDownList ID="ddlExportType" Width="40%" runat="server" 
                                    ToolTip="Select Shipping Bill Type" AutoPostBack="true" OnSelectedIndexChanged="ddlExportType_OnSelectedIndexchanged">
                                    <asp:ListItem Selected="True" Text="-- Select Bill Type --" Value="0"></asp:ListItem>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlShippingBillType" Width="53%" runat="server" DataSourceID="DataSourceShippingBillType"
                                    DataTextField="sName" DataValueField="lid" ToolTip="Select Shipping Bill Type" AppendDataBoundItems="true">
                                    <asp:ListItem Selected="True" Text="-- Select Bill Type --" Value="0"></asp:ListItem>
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtProductDesc" runat="server" Width="70%" ToolTip="Enter Product Description."></asp:TextBox>
                            </td>
                            <td>Priority
                        ...
                        <tr>
                            <td>
                                Forward To Babaji Shivram
                                <asp:RequiredFieldValidator ID="RFVForwrd" runat="server" ControlToValidate="ddlForwardedBy"
                                    SetFocusOnError="true" ErrorMessage="Please Select Forward." Display="Dynamic" InitialValue="-1"
                                    Text="*" ValidationGroup="Required"></asp:RequiredFieldValidator>
                            </td>
                            <td>
                                <asp:DropDownList ID="ddlForwardedBy" runat="server" ToolTip="Select Forward To Babaji Shivram" Width="40%" 
                            ...
                            <td id="td_NonBabajiForwarder" runat="server">
                                <asp:TextBox ID="txtForwardedName" runat="server" ToolTip="Enter Forwarded Name."
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtNoOfPackages" runat="server" ToolTip="Enter No Of Packages."
                                    MaxLength="8" Width="80px" Text='<%#Eval("NoOfPackages") %>'></asp:TextBox>
                                ...
                                <asp:DropDownList ID="ddlPackageType" runat="server" DataSourceID="DataSourcePackageType"
                                    Width="100px" ToolTip="Select Package Type" DataTextField="sName"
                                    DataValueField="lId">
                                </asp:DropDownList>
                            </td>
                            <td>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlContainerLoaded" Width="40%" runat="server" 
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtGrossWT" runat="server" MaxLength="10" Width="36%" 
                            ...
                            <td style="width: 25%;">
                                <asp:TextBox ID="txtNetWT" runat="server" MaxLength="10" Width="37%"
                        ...
                        <tr>
                            <td>Job Remark</td>
                            <td colspan="3">
                                <asp:TextBox ID="txtJobRemark" runat="server" TextMode="MultiLine" Rows="3" ></asp:TextBox>
                            </td>
                        </tr>
                ...
                <fieldset>
                    <legend>Container Details</legend>
                        <asp:GridView ID="gvContainer" CssClass="table" runat="server" AutoGenerateColumns="false" Width="90%"
                            DataSourceID="DataSourceContainer">
                            <Columns>
