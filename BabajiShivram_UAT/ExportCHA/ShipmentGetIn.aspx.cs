...
public partial class ExportCHA_ShipmentGetIn : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            {
                lblMessage.Text = "No Job Found For Shipment Get In!";
                lblMessage.CssClass = "errorMsg";
            }
        }

        DataFilter1.DataSource = PendingJobForShipmentGetIn;
        DataFilter1.DataColumns = gvJobDetail.Columns;
        DataFilter1.FilterSessionID = "ShipmentGetIn.aspx";
    ...
    protected void gvJobDetail_RowCommand(Object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName.ToLower() == "select")
        {
            ...
            Response.Redirect("DocumentToShippingLine.aspx");
        }
    }
    ...
    {
        string strFileName = "PendingShipmentGetIn_" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
    ...
    private void ExportFunction(string header, string contentType)
    {
        ...
        gvJobDetail.Caption = "Shipment Get In On " + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt");
