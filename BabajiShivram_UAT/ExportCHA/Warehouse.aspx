<%@ Page Title="Warehouse Detail" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Warehouse.aspx.cs"
    Inherits="ExportCHA_Warehouse" Culture="en-GB" %>
        ...
        <ContentTemplate>
                ...
                <asp:GridView ID="gvJobDetail" runat="server" AutoGenerateColumns="False" CssClass="table"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="BS Job No" SortExpression="JobRefNo">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkSelect" CommandName="Select" ToolTip="Warehouse Detail" runat="server"
            ...
            <div>
                <asp:SqlDataSource ID="PendingJobForWarehouse" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                    SelectCommand="EX_GetJobPendingForWarehouse" SelectCommandType="StoredProcedure">
                    <SelectParameters>
            ...
            <div id="divDeliveredItems">
                ...
                <asp:Panel ID="Panel2" runat="server" CssClass="modalPopup1" BackColor="#F5F5DC" Width="100%" Height="300px">
