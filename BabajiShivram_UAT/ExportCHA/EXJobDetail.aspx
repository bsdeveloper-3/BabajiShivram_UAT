<%@ Page Title="Job Detail" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="EXJobDetail.aspx.cs"
    Inherits="ExportCHA_EXJobDetail" Culture="en-GB" %>
    ...
    <asp:UpdatePanel ID="upJobDetail" runat="server" UpdateMode="Conditional" RenderMode="Inline">
        <ContentTemplate>
            ...
            <AjaxToolkit:TabContainer runat="server" ID="Tabs" ActiveTabIndex="0" CssClass="Tab"
                                                ...
                                                <EditItemTemplate>
                                                    ...
                                                    <table id="tblJobDetail" runat="server" border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="white">
                                                        ...
                                                        <tr id="trCancel" runat="server" visible="false">
                                                            ...
                                                            <td>
                                                                <asp:DropDownList ID="ddlReason" runat="server"  ><%--SelectedValue='<%#Eval("REASON") %>'--%>
                                                                    <asp:ListItem Text="-Select-" Value="0"></asp:ListItem>
                                                        ...
                                                        <tr>
                                                           ...
                                                           <td>
                                                                <asp:Label ID="lblFreightJob" runat="server" Text='Freight Job No'></asp:Label>
                                                            </td>
                                                            <td>
                                                                <b>
                                                                    <asp:Label ID="lblFrJobNo" runat="server" Text=' <%# Bind("FRJobNo") %>'></asp:Label>
                                                                </b>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:DropDownList ID="ddlShippingBillType" Width="40%" runat="server" DataSourceID="DataSourceShippingBillType" SelectedValue='<%#Eval("ShippingBillTypeId") %>'
                                                                    DataTextField="sName" DataValueField="lid" TabIndex="17" ToolTip="Select Shipping Bill Type" AutoPostBack="true">
                                                                    <asp:ListItem Selected="True" Text="-- Select Bill Type --" Value="0"></asp:ListItem>
                                                                </asp:DropDownList>
                                                            </td>
                                                        </tr>
                                    ...
                                    <AjaxToolkit:AccordionPane ID="accSBPrepare" runat="server">
                                        ...
                                        <Content>
                                            <asp:FormView ID="FVSBPrepare" runat="server" Width="99%" DataKeyNames="lid" DataSourceID="DataSourceJobDetail" OnDataBound="FVSBPrepare_DataBound" OnItemCommand="FVSBPrepare_ItemCommand">
                                                ...
                                                <ItemTemplate>
                                                    <div class="m clear">
                                                        <asp:Button ID="btnEditPrepareDetail" runat="server" Visible="false" CommandName="Edit" Text="Edit" OnClick="btnEditPrepareDetail_OnClick" />
                                                    </div>
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="white">
                                                        <tr>
                                                            <td>BS Job No.
                                    ...
                                    <AjaxToolkit:AccordionPane ID="accSBFiling" runat="server">
                                        ...
                                        <Content>
                                            <asp:FormView ID="FVFilingCustomProcess" runat="server" Width="99%" DataKeyNames="lid" DataSourceID="DataSourceJobDetail" OnDataBound="FVFilingCustomProcess_DataBound" OnItemCommand="FVFilingCustomProcess_ItemCommand">
                                                ...
                                                <ItemTemplate>
                                                    <div class="m clear">
                                                        <asp:Button ID="btnEditFilingDetail" runat="server" CommandName="Edit" Visible="false" Text="Edit" OnClick="btnEditFilingDetail_OnClick" />
                                                    </div>
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="white">
                                                        <tr>
                                                            <td>BS Job No.
                                                        ...
                                                        <tr>
                                                            <td>SB Date
                                                                ...
                                                                <AjaxToolkit:MaskedEditValidator ID="MskValSBDate" ControlExtender="MskExtSBDate" ControlToValidate="txtSBDate" IsValidEmpty="false"
                                                                    ...
                                                                    MinimumValue="01/07/2014" MaximumValue="31/12/2026"
                                                        ...
                                                        <tr>
                                                            <td>Mark/Passing Date
                                                                ...
                                                                <AjaxToolkit:MaskedEditValidator ID="MEditValMarkPassingDate" ControlExtender="MEditMarkPassingDate" ControlToValidate="txtMarkPassingDate" IsValidEmpty="false"
                                                                    ...
                                                                    MinimumValue="01/01/2014" MaximumValue="31/12/2026" runat="Server" ValidationGroup="Required"></AjaxToolkit:MaskedEditValidator>
                                                            </td>
                                                            <td>
                                    ...
                                    <AjaxToolkit:AccordionPane ID="accForm13" runat="server">
                                        ...
                                        <Content>
                                            <asp:FormView ID="FVForm13Detail" runat="server" Width="99%" DataKeyNames="lid" DataSourceID="DataSourceJobDetail" OnDataBound="FVForm13Detail_DataBound" OnItemCommand="FVForm13Detail_ItemCommand">
                                                ...
                                                <ItemTemplate>
                                                    <div class="m clear">
                                                        <asp:Button ID="btnEditForm13Detail" runat="server" Visible="false" CommandName="Edit" Text="Edit" OnClick="btnEditForm13Detail_OnClick" />
                                                    </div>
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="white">
                                                        <tr>
                                                            <td>BS Job No.
                                    ...
                                    <AjaxToolkit:AccordionPane ID="accShipmentGetIn" runat="server">
                                        ...
                                        <Content>
                                            <asp:FormView ID="FVShipmentGetIN" runat="server" Width="99%" DataKeyNames="lid" DataSourceID="DataSourceJobDetail" OnItemCommand="FVShipmentGetIN_ItemCommand" OnDataBound="FVShipmentGetIN_DataBound">
                                                ...
                                                <ItemTemplate>
                                                    <div class="m clear">
                                                        <asp:Button ID="btnEditShipmentDetail" runat="server" Visible="false" CommandName="Edit" Text="Edit" OnClick="btnEditShipmentDetail_OnClick" />
                                                    </div>
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="white">
                                                        <tr>
                                                            <td>BS Job No.
                            ...
                            <div>
                                <asp:GridView ID="gvContainer" runat="server" AllowPaging="True" CssClass="table"
                                    ...
                                    <Columns>
                                        ...
                                        <%-- <asp:CommandField ShowEditButton="false" ShowDeleteButton="false" ValidationGroup="valGridContainer"
                                            HeaderText="Edit" />--%>
                                    </Columns>
                                    ...
                                    <tr>
                                        ...
                                        <AjaxToolkit:MaskedEditExtender ID="meeIncDate_footer" TargetControlID="txtInvoiceDate" Mask="99/99/9999"
                                            ...
                                            <AjaxToolkit:MaskedEditValidator ID="mevInvcDate_footer" ControlExtender="meeIncDate_footer"
                                                ...
                                                MaximumValue="01/01/2026" SetFocusOnError="true" runat="Server" ValidationGroup="vgAddInvoice"></AjaxToolkit:MaskedEditValidator>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <AjaxToolkit:MaskedEditValidator ID="mevLicenseDate_footer" ControlExtender="meeLicenseDate_footer"
                                                ...
                                                MaximumValueMessage="Invalid Date" MinimumValue="01/01/1900" MaximumValue="01/01/2026"
                                        ...
                                        <asp:TemplateField HeaderText="License Date">
                                            ...
                                            <EditItemTemplate>
                                                ...
                                                <AjaxToolkit:MaskedEditValidator ID="mevLicenseDate" ControlExtender="meeLicenseDate" ControlToValidate="txtLicenseDate"
                                                    ...
                                                    MinimumValueMessage="Invalid Date" MaximumValueMessage="Invalid Date" MinimumValue="01/01/1900"
                                                    MaximumValue="01/01/2026" SetFocusOnError="true" runat="Server" EmptyValueBlurredText="*"
                ...
                <!-- Billing-->
                <AjaxToolkit:TabPanel runat="server" ID="TabBiiling" HeaderText="Billing">
                    <ContentTemplate>
                        <div>
                            ...
                            <fieldset id="fsRepository" runat="server" visible="false">
                                ...
                                <asp:Button ID="btnBillingRepoDocCheck" runat="server" Text="Check Billing Repository Document" OnClick="btnBillingRepoDocCheck_Click" />
                ...
                <!-- Billing-->
                <AjaxToolkit:TabPanel runat="server" ID="TABExpenseDetails" HeaderText="Expense">
                    <ContentTemplate>
                        <div>
                            ...
                            <fieldset id="fldFundRequest" runat="server" visible="false">
                                <legend> Allow Vendor Payment</legend>
                                ...
                                <asp:Button ID="btnAllowFundRequest" runat="server" OnClick="btnAllowFundRequest_Click" CssClass="btn"
                                            Text="Save Vendor Payment Status" Enabled="false" />
                            </fieldset>
                            <div id="div2">
                ...
                <%-- Truck request --%>
                <AjaxToolkit:TabPanel runat="server" ID="TabPanel2" HeaderText="Truck Request">
                    <ContentTemplate>
                        <div class="clear"></div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="ddlExportType1" runat="server" TabIndex="2" AutoPostBack="true" OnSelectedIndexChanged="ddlExportType1_SelectedIndexChanged">
                                                        <asp:ListItem Text="-Select-" Value="0"></asp:ListItem>
                                            ...
                                            <tr>
                                                <td>Dimension</td>
                                                <td>
                                                    <asp:TextBox ID="txtDimension1" runat="server" TextMode="MultiLine" ToolTip="Enter Dimension"
