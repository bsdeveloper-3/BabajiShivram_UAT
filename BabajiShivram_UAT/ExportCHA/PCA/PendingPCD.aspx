<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PendingPCD.aspx.cs" Inherits="PendingPCD"
 MasterPageFile="~/MasterPage.master" Title="Pending PCA Document" EnableEventValidation="false" Culture="en-GB"%>
...
<script language="javascript" type="text/javascript" src="../JS/CheckBoxListPCDDocument.js"></script>
    ...
    <div>
        <asp:SqlDataSource ID="PCDSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
            SelectCommand="GetPendingPCDToCustomer" SelectCommandType="StoredProcedure">
            <SelectParameters>
