<%@ Page Title="Bill Final Typing Detail" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="PCDFinalTypingDate.aspx.cs" Inherits="PCA_PCDFinalTypingDate" Culture="en-GB" EnableEventValidation="false" %>
    ...
    <asp:UpdatePanel ID="upJobDetail" runat="server">
        <ContentTemplate>
            ...
            <style type="text/css">
                ...
                table#ctl00_ContentPlaceHolder1_TabJobDetail_TabPCDBilling1_gvRecievedJobDetail {
                    white-space: normal;
                }
            </style>
            ...
            <script type="text/javascript">
                function Confirm() {
                    ...
                    if (confirm("Do you want to Approve Bill Final Typing?"))
                        return true;
                    else
                        return false;
                ...
                function Reject() {
                    ...
                    if (confirm("Do you want to Reject Bill Final Typing?"))
                        return true;
                    else
                        return false;
                }
            ...
            <cc1:TabContainer ID="TabJobDetail" runat="server" CssClass="Tab" AutoPostBack="True" ActiveTabIndex="0" OnActiveTabChanged="TabJobDetail_ActiveTabChanged">
                <cc1:TabPanel ID="TabPCDBilling" runat="server" TabIndex="0" HeaderText="Non Receive">
                    <ContentTemplate>
                                ...
                                <tr>
                                    ...
                                    <td valign="top">
                                        <asp:Button ID="btnReceive" runat="server" Text="Receive" CssClass="buttons"
                                            ToolTip="Received File" OnClick="btnReceive_Click" /></td>
                                    <td>
                        ...
                        <asp:GridView ID="gvNonRecievedJobDetail" runat="server" AutoGenerateColumns="False"
                            CssClass="table" DataKeyNames="JobId" AllowPaging="True" AllowSorting="True" Width="100%" PageSize="20" DataSourceID="PCDSqlDataSource" OnRowDataBound="gvNonRecievedJobDetail_RowDataBound"
                            OnPreRender="gvNonRecievedJobDetail_PreRender" PagerSettings-Position="TopAndBottom" OnPageIndexChanging="gvNonRecievedJobDetail_PageIndexChanging">
                            <Columns>
                        ...
                        <asp:SqlDataSource ID="PCDSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                            SelectCommand="GetPendingPCDToFinalTyping" SelectCommandType="StoredProcedure">
                            <SelectParameters>
                ...
                <cc1:TabPanel ID="TabPCDBilling1" runat="server" TabIndex="1" HeaderText="Receive">
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="gvRecievedJobDetail" runat="server" AutoGenerateColumns="False" CssClass="table"
                            ...
                            OnRowEditing="gvRecievedJobDetail_RowEditing" OnRowUpdating="gvRecievedJobDetail_RowUpdating">
                            <Columns>
                                <asp:TemplateField HeaderText="Sl">
                                    <ItemTemplate>
                                        <%#Container.DataItemIndex +1 %>
                                ...
                                <asp:TemplateField HeaderText="Edit" ItemStyle-Width="2%">
                                    ...
                                    <EditItemTemplate>
                                        <asp:LinkButton ID="lnkUpdate" CommandName="Update" CommandArgument='<%#Eval("JobId") %>' ToolTip="Update" Width="45" runat="server" Text="Update" Font-Underline="true" ValidationGroup="PassingRequired"></asp:LinkButton>
                                ...
                                <asp:TemplateField HeaderText="BS Job No" SortExpression="JobRefNo">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkJobNo" runat="server" Text='<%#Eval("JobRefNo") %>' CommandName="DocumentPopup" CommandArgument='<%#Eval("JobId")+";"+ Eval("DocFolder")+";"+ Eval("FileDirName")%>' Enabled="false"></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField DataField="JobRefNo" HeaderText="BS Job No" Visible="false" />
                                ...
                                <asp:BoundField DataField="Customer" HeaderText="Customer" SortExpression="Customer" ReadOnly="true" ItemStyle-Width="18%" />
                                <asp:BoundField DataField="JobType" HeaderText="Job Type" ReadOnly="true" ItemStyle-Width="2%" />
                                <asp:BoundField DataField="LastDispatchDate" HeaderText="Dispatch Date" DataFormatString="{0:dd/MM/yyyy}" ItemStyle-Width="5%" SortExpression="LastDispatchDate" ReadOnly="true" />
                                <asp:BoundField DataField="ShippingLineDate" HeaderText="Document HandOver Date" ItemStyle-Width="5%" DataFormatString="{0:dd/MM/yyyy}" SortExpression="ShippingLineDate" ReadOnly="true" />
                                <asp:BoundField DataField="ReceivedDate" HeaderText="Received Date" DataFormatString="{0:dd/MM/yyyy}" SortExpression="ReceivedDate" ReadOnly="true" Visible="false" />
                                ...
                                <asp:BoundField DataField="CrossRemark" HeaderText="CrossRemark" SortExpression="CrossRemark" ReadOnly="true" />
                                <asp:TemplateField HeaderText="Comments" ItemStyle-Width="10%">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtCommentes" Enabled="false" TextMode="MultiLine" Text='<%#Eval("PCDFinalTypingComment") %>' runat="server" Width="70%" Height="70%" />
                                    </ItemTemplate>
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtCommentes1" Enabled="true" AutoPostBack="false" Text='<%#Eval("PCDFinalTypingComment") %>' TextMode="MultiLine" Wrap="true" runat="server" Width="70%" Height="70%" />
                                    </EditItemTemplate>
                                </asp:TemplateField>
             ...
             <ItemTemplate>
             <asp:LinkButton ID="lnkFA" runat="server" Text="FA" CommandName="FA"  CommandArgument='<%#Eval("JobId") %>' OnClientClick="if (!Confirm()) return false;"></asp:LinkButton>
             </ItemTemplate>
             </asp:TemplateField>--%>
                                ...
                                <asp:TemplateField HeaderText="Reject">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkReject" runat="server" Text="Reject" CommandName="Reject" ToolTip="Reject" CommandArgument='<%#Eval("JobId")+";"+ Eval("JobRefNo") %>'></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <asp:CheckBox ID="chkreasonofpendency" Text='<%#DataBinder.Eval(Container.DataItem,"ReasonforPendency") %>'
                                                                            runat="server" TabIndex="13" Width="110" ForeColor="Black" Font-Size="9" />
                                                                    </td>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        <div id="divUnderClear">
                                                                            ...
                                                                            <asp:CompareValidator ID="Comval" runat="server" ControlToValidate="txt" Operator="NotEqual" ValueToCompare="0" Type="Integer" ValidationGroup="validateform" Text="*"
                                                                                SetFocusOnError="true" ErrorMessage='<%#DataBinder.Eval(Container.DataItem,"ReasonforPendency") + "- Please select porper UserName."%>' ForeColor="Red"></asp:CompareValidator>
             ...
             <asp:Button ID="btnCancel" runat="server" Text="Cancel" ToolTip="Cancel" />
                        ...
                        <asp:SqlDataSource ID="PCDSqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                            SelectCommand="GetPendingPCDToFinalTyping" SelectCommandType="StoredProcedure" OnUpdated="PCDSqlDataSource1_Updated"
                            UpdateCommand="updfinaltypingComment" UpdateCommandType="StoredProcedure">
                            <SelectParameters>
                                <asp:SessionParameter Name="UserId" SessionField="UserId" />
                                <asp:SessionParameter Name="FinYearId" SessionField="FinYearId" />
