...
public partial class PCA_CheckingDate : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        ScriptManager1.RegisterPostBackControl(rptBJVDetails);
        //ScriptManager1.RegisterPostBackControl(gvNonRecievedJobDetail);
        ScriptManager1.RegisterPostBackControl(btnReceive);
        ...
        {
            lblMsgforNonReceived.Text = "No Job Found For Non Recieved file for Bill Check!";
        ...
        {
            lblMsgforReceived.Text = "No Job Found For Recieved file for Bill Check!";
    ...
    {
        string strFileName = "DraftCheck_nonreceiveJoblist" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
    ...
    protected void gvNonRecievedJobDetail_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            e.Row.Cells[9].ToolTip = "Today – FSDC"; //aging2
            ...
            if (DataBinder.Eval(e.Row.DataItem, "JobType") != DBNull.Value)
            {
                ...
                {
                    e.Row.Cells[10].ToolTip = "Today – Job came to Additional Tab.";
                    e.Row.Cells[6].Text = "";
                    e.Row.Cells[7].Text = "";
                }
                else
    ...
    protected void btnReceive_Click(object sender, EventArgs e)
    {
        ...
        foreach (GridViewRow gvr in gvNonRecievedJobDetail.Rows)
        {
            if (((CheckBox)gvr.FindControl("Chk1")).Checked)
            {
                ...
                GetModuleId();
                int Result = BillingOperation.receivedfile(Convert.ToInt32(JobId), LoggedInUser.glUserId, Convert.ToInt16(EnumBilltype.DraftCheck), ModuleId);
                Session["JobRefNo"] = "";
                ModuleId = 0;
                ...
                {
                    lblreceivemsg.Text = "Selected is Freight Export Job";
                    lblreceivemsg.CssClass = "errorMsg";
                }
                i++;
            }
    ...
    {
        string strFileName = "DraftCheck_ReceiveJoblist" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
    ...
    protected void gvRecievedJobDetail_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            foreach (DataControlField col in gvRecievedJobDetail.Columns)
            {
                ...
                e.Row.Cells[10].ToolTip = "Today – FRDC"; //aging2
                ...
                if (DataBinder.Eval(e.Row.DataItem, "JobType") != DBNull.Value)
                {
                    ...
                    {
                        e.Row.Cells[11].ToolTip = "Today – Job added to Additional Tab.";
                        e.Row.Cells[6].Text = "";
                        e.Row.Cells[7].Text = "";
                    }
                    else
    ...
    protected void OnPreRender(object sender, EventArgs e)
    {
        ...
        {
            var imgBtn = (ImageButton)row.FindControl("img1");
    ...
    protected void gvRecievedJobDetail_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName.ToLower() == "documentpopup" && e.CommandArgument != null)
        {
            ...
            string strCustDocFolder = "", strJobFileDir = "", strCustomer = "", strJobrefno = "";
            ...
            int Uploadtype = Convert.ToInt32(EnumBilltype.DraftCheck);
            ...
            //Label label3 = rptBJVDetails.Controls[0].FindControl("lblRMSNonRms2") as Label;
        ...
        if (e.CommandName.ToLower() == "tick" || e.CommandName.ToLower() == "cross")
        {
            ...
            bool bApprove = true;
            GetModuleId();
            result = BillingOperation.ApproveRejectChecking(id, bApprove, txtremarks.Text, reasonforPendency, "", Correct, 0, LoggedInUser.glUserId, ModuleId);
            Session["JobRefNo"] = "";
            ModuleId = 0;

            if (result == 0)
            {
                lblMsgforApproveReject.Text = "Bill Check Completed! Job Moved To Final Typing!.";
            ...
            {
                lblMsgforApproveReject.Text = "Bill Check Already Completed!";
                lblMsgforApproveReject.CssClass = "errorMsg";
            }
    ...
    {
        if (e.CommandName.ToLower() == "view" && e.CommandArgument != null)
        {
    ...
    protected void rptBJVDetails_ItemDataBound(Object Sender, RepeaterItemEventArgs e)
    {
        if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
        {
            ...
            if (lblDEBITAMT.Text.Trim() != "")
            {
                ViewState["lblDEBITAMT"] = Convert.ToInt64(ViewState["lblDEBITAMT"]) + int.Parse(lblDEBITAMT.Text.Trim());
            }
            else
            {
                ViewState["lblDEBITAMT"] = "0";
    ...
    protected void rptBJVDetails_ItemCommand(Object Sender, RepeaterCommandEventArgs e)
    {
        ...
        if (e.CommandName.ToLower() == "tick" || e.CommandName.ToLower() == "cross")
        {
            ...
            Label jobrefNo = rptDocument.Controls[0].FindControl("lbljobrefno2") as Label;
            Session["JobRefNo"] = jobrefNo.Text;
            GetModuleId();
            result = BillingOperation.ApproveRejectChecking(Convert.ToInt32(ViewState["JobId"]), bApprove, txtremarks.Text, reasonforPendency, "", Correct, 0, LoggedInUser.glUserId, ModuleId);
            ModuleId = 0;
            Session["JobRefNo"] = "";
    ...
    protected void btnReject_Click(object sender, EventArgs e)
    {
        ...
        if (Session["status"].ToString() == "Reject")
        {
            ...
            for (int i = 0; i < rpReason.Items.Count; i++)
            {
                ...
                if (chk.Checked)
                {
                    ...
                    if (checkedCount != 0)
                    {
                        ...
                        GetModuleId();
                        result = BillingOperation.ApproveRejectChecking(Convert.ToInt32(ViewState["JobId"]), bApprove, Remark, Convert.ToInt16(reasonforPendency), LRDC_Type, "2", CategoryId, LoggedInUser.glUserId, ModuleId);
                        Session["JobRefNo"] = "";
            ...
            if (ModuleId != 2)
            {
                int rejectedby = Convert.ToInt16(EnumBilltype.DraftCheck);
