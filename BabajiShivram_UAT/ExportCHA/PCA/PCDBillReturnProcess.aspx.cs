...
public partial class PCA_PCDBillReturnProcess : System.Web.UI.Page
{
    LoginClass loggedInClass = new LoginClass();
    protected void Page_Load(object sender, EventArgs e)
    {
        ScriptManager1.RegisterPostBackControl(gridBillReturn);
        AutoCompleteExtender10.ContextKey = Convert.ToString(loggedInClass.glFinYearId) + "," +"0";
    ...
    protected void gridBillReturn_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName.ToLower() == "updbillreturn")
        {
            ...
            if (chkIsReturn.Checked == true)
            {
                ...
                {
                    Result = DBOperations.AddBillReturnbyCust(Convert.ToInt32(strlid), Convert.ToInt32(strJobId), strBJVNo, INVAmount, Reason, strRemark, loggedInClass.glUserId);
