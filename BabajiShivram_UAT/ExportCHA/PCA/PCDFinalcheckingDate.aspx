<%@ Page Title="Bill Final Check Details" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeFile="PCDFinalcheckingDate.aspx.cs" Inherits="PCA_PCDFinalcheckingDate" EnableEventValidation="false" Culture="en-GB" %>
    ...
    <asp:UpdatePanel ID="upJobDetail" runat="server">
        <ContentTemplate>
            ...
            <script type="text/javascript">
                ...
                function Confirm() {
                    if (confirm("Do you want to Approve Bill Final Check?"))
                        return true;
                    else
                        return false;
                ...
                function Reject() {
                    ...
                    if (confirm("Do you want to Reject Bill Final Check?"))
                        return true;
                    else
                        return false;
                }
            ...
            <cc1:TabContainer ID="TabJobDetail" runat="server" AutoPostBack="True" ActiveTabIndex="0" CssClass="Tab" CssTheme="None" OnActiveTabChanged="TabJobDetail_ActiveTabChanged">
                <cc1:TabPanel ID="TabPCDBilling" runat="server" TabIndex="0" HeaderText="Non Receive">
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="gvNonRecievedJobDetail" runat="server" AutoGenerateColumns="False"
                            CssClass="table" DataKeyNames="JobId" AllowPaging="True" AllowSorting="True" Width="100%"
                            PageSize="20" PagerSettings-Position="TopAndBottom" OnRowCommand="gvNonRecievedJobDetail_RowCommand"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Audit Remark">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkAuditRemark" runat="server" Text='<%#Eval("AuditRemark") %>' CommandName="AuditRemark" CommandArgument='<%#Eval("JobId")%>'></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                        ...
                        <asp:SqlDataSource ID="PCDSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                            SelectCommand="GetPendingPCDToFinalChecking" SelectCommandType="StoredProcedure">
                            <SelectParameters>
                    ...
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="gvRecievedJobDetail" runat="server" AutoGenerateColumns="False" CssClass="table"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="BS Job No" SortExpression="JobRefNo">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkJobNo" runat="server" Text='<%#Eval("JobRefNo") %>' CommandName="DocumentPopup" CommandArgument='<%#Eval("JobId")+";"+ Eval("DocFolder")+";"+ Eval("FileDirName")+";"+ Eval("Customer")+";"+ Eval("JobRefNo")+";"+ Eval("RMSNonRMS")%>'></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField DataField="JobRefNo" HeaderText="BS Job No" Visible="false" />
                                <%--<asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Audit Remark">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnk2AuditRemark" runat="server" Text='<%#Eval("AuditRemark") %>' CommandName="AuditRemark" CommandArgument='<%#Eval("JobId")%>'></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField DataField="LastDispatchDate" HeaderText="Dispatch Date" DataFormatString="{0:dd/MM/yyyy}" SortExpression="LastDispatchDate" />
                                <asp:BoundField DataField="ShippingLineDate" HeaderText="Document HandOver Date" DataFormatString="{0:dd/MM/yyyy}" SortExpression="ShippingLineDate" />
                                ...
                                <%--   <asp:ButtonField ButtonType="Image" ImageUrl="~/Images/success.png"  CommandName="Tick" DataTextField="JobID"  HeaderText="Tick" />
                <asp:ButtonField ButtonType="Image" ImageUrl="~/Images/cross.png"   CommandName="Cross"  DataTextField="JobID" HeaderText="Cross" />--%>
            ...
            <EditItemTemplate>
                                                                    ...
                                                                    <td>
                                                                        <div id="divUnderClear">
                                                                            ...
                                                                            <asp:CompareValidator ID="Comval" runat="server" ControlToValidate="txt" Operator="NotEqual" ValueToCompare="0" Type="Integer" ValidationGroup="validateform" 
                                                                                Text="*" SetFocusOnError="true" ErrorMessage='<%#DataBinder.Eval(Container.DataItem,"ReasonforPendency") + "- Please select porper UserName."%>' ForeColor="Red"></asp:CompareValidator>
			 ...
			 <td><asp:Label ID="lblRMSNonRms" runat="server" Text="RMS/NONRMS" Font-Bold="true"></asp:Label></td>
                          <h1><%# Eval("RMSNonRMS")%></h1>                        
                        <td  colspan="4"><asp:label ID="lblRMSNonRms2" runat="server" ForeColor="Black"/></td>
                        </tr>--%>
                      ...
                      <asp:Button ID='lnkReject' runat="server" Text="Reject" OnClick="lnkReject_click" ToolTip="" CommandName="Reject" CommandArgument='<%#Eval("JobId") %>'></asp:Button></td>--%>
                                                    ...
                                                    <tr align="center" valign="middle" class="header">
                                                        ...
                                                        <td colspan="10">
                                                            ...
                                                            <asp:ImageButton ID="imgtick" runat="server" ImageAlign="AbsMiddle" ImageUrl="~/Images/success.png" CommandName="Tick" CommandArgument='<%#Eval("JobID") %>' />

                                                            &nbsp;&nbsp;
                      <asp:ImageButton ID="imgcross" runat="server" ImageAlign="AbsMiddle" ImageUrl="~/Images/cross.png" CommandName="Cross" CommandArgument='<%#Eval("JobID") %>' />
                                                            &nbsp;&nbsp;
                <asp:Button ID="imgReject" runat="server" Text="Reject" CommandName="Reject" CommandArgument='<%#Eval("JobID") %>' />
                        ...
                        <div>
                <asp:LinkButton ID="lnkAuditR" runat="server"></asp:LinkButton>
            </div>

            <div id="divBJVAudit">
                <cc1:ModalPopupExtender ID="AuditModalPopupExtender" runat="server" CacheDynamicResults="false" PopupControlID="panAuditJob" 
                    CancelControlID="imgbtnAudit" TargetControlID="lnkAuditR" BackgroundCssClass="modalBackground" DropShadow="true">
                </cc1:ModalPopupExtender>
                <asp:Panel ID="panAuditJob" runat="server" CssClass="ModalPopupPanel" Width="600px">
                    <div class="header">
                        <div class="fleft">
                            <asp:Label ID="lblPopupName" runat="server" Text="Audit Remark"></asp:Label>

                        </div>
                        <div class="fright">
                            <asp:ImageButton ID="imgbtnAudit" ImageUrl="../Images/delete.gif" runat="server"
                                ToolTip="Close" />
                        </div>
                    </div>
                    <div id="Div2" runat="server" style="max-height: 250px; overflow: auto; padding: 5px">
                        <div>
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="white">
                                <div class="m">
                                    <center>
                                        <asp:Label ID="lblError_Audit" runat="server"></asp:Label>
                                    </center>
                                </div>
                                <tr>
                                    <td>BS Job Number</td>
                                    <td colspan="2">
                                        <asp:Label ID="lblFAJobNumber" runat="server"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        <asp:RequiredFieldValidator ID="RFVReason" runat="server" ControlToValidate="txtAuditRemark" SetFocusOnError="true" Display="Dynamic"
                            ForeColor="Red" ErrorMessage="Enter Remark" ValidationGroup="ValidateAudit" Font-Bold="true"></asp:RequiredFieldValidator>
                        <div>
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="white">
                                <tr>
                                    <td>Remark                                      
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtAuditRemark" runat="server" TextMode="MultiLine" Rows="4" MaxLength="200" Width="300px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                        <asp:Button ID="btnAuditJob" runat="server" Text="Save Remark" OnClick="btnAuditJob_Click" ValidationGroup="ValidateAudit" />
                                    </td>
                                </tr>
                            </table>
                        </div>
