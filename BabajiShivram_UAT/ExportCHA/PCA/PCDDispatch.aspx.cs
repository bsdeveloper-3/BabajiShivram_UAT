...
public partial class PCA_PCDDispatch : System.Web.UI.Page
{
    ...
    protected void btnReceive_Click(object sender, EventArgs e)
    {
        ...
        foreach (GridViewRow gvr in gvNonRecievedJobDetail.Rows)
        {
            if (((CheckBox)gvr.FindControl("chk1")).Checked)
            {
                ...
                GetModuleId();
                int Result = BillingOperation.receivedfile(Convert.ToInt32(JobId), LoggedInUser.glUserId, Convert.ToInt16(EnumBilltype.BillDispatch), ModuleId);
                Session["JobRefNo"] = "";
                ModuleId = 0;
