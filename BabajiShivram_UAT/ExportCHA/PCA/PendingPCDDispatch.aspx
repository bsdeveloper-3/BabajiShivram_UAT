<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PendingPCDDispatch.aspx.cs" Inherits="PendingPCDDispatch"
    MasterPageFile="~/MasterPage.master" Title="Pending Dispatch" EnableEventValidation="false" Culture="en-GB" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" ID="content1" runat="server">
    ...
    <asp:UpdatePanel ID="upShipment" runat="server" UpdateMode="Conditional" RenderMode="Inline">
        <ContentTemplate>
            ...
            <div class="clear"></div>
            <fieldset>
                <legend>Pending Dispatch</legend>
                <div class="m clear">
                ...
                <asp:GridView ID="gvJobDetail" runat="server" AutoGenerateColumns="False" CssClass="table"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Port" HeaderText="Port of Discharge" SortExpression="Port" />
