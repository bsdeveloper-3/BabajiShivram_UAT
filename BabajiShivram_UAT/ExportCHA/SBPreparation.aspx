<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="SBPreparation.aspx.cs" Inherits="ExportCHA_SBPreparation" EnableSessionState="True"
    Culture="en-GB" %>
        ...
        <ContentTemplate>
                    ...
                    <div>
                        <asp:GridView ID="gvJobDetail" runat="server" AutoGenerateColumns="False" CssClass="table"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="JobRefNo" HeaderText="Job Ref No" SortExpression="JobRefNo" Visible="false" />
            ...
            <div>
                <asp:SqlDataSource ID="JobDetailSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                    SelectCommand="EX_GetJobDetailForSBPreparation" SelectCommandType="StoredProcedure">
                    <SelectParameters>
