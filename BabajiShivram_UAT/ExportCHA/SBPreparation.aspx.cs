...
public partial class ExportCHA_SBPreparation : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DataFilter1.FilterSessionID = "SBPreparation.aspx";
    ...
    protected void gvJobDetail_RowCommand(Object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName.ToLower() == "select")
        {
            ...
            Response.Redirect("SBPreparationDetail.aspx");
        }
