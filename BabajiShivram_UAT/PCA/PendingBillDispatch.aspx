<%@ Page Title="Pending Bill Dispatch" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeFile="PendingBillDispatch.aspx.cs" Inherits="PCA_PendingBillDispatch" EnableEventValidation="false" Culture="en-GB" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:UpdatePanel ID="upPendingchecklist" runat="server" UpdateMode="Conditional"
        ...
        <legend>Bill Dispatch</legend>
            <div class="fleft">
                <table>
                    <tr>
                        ...
                        <td valign="baseline">
                            <asp:Button ID="btnEBill" runat="server" Text="E-Bill Dispatch" OnClick="btnEBill_Click"  />
                        </td>
                        <td valign="baseline">
                            &nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="btnExportBillDetail" runat="server" Text="Export Bill Detail To Excel" OnClick="btnExportBillDetail_Click"  />
                        </td>
                        <%-- end covering letter--%>
            ...
            <asp:GridView ID="gvRecievedJobDetail" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Hold">
                        <ItemTemplate>
                            ...
                            <asp:ImageButton ID="imgbtnUnholdJob" runat="server" ImageUrl="~/Images/LockImg.png"
                                CommandArgument='<%#Eval("JobId")%>' CommandName="Unhold" Width="18px" Height="18px" ToolTip="Unhold Job."
                                Style="padding-right: 1px; margin-right: 0px; padding-left: 1px"
                                OnClientClick="return confirm('Sure to UnHold Job?');"></asp:ImageButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:BoundField DataField="HoldRemark" HeaderText="Hold Reason"/>
        ...
        <!-- START : MODAL POP-UP FOR HOLD Job  -->
            <div id="divHoldExpense">
                ...
                <asp:Panel ID="pnlHoldExpense" runat="server" CssClass="ModalPopupPanel" Width="600px">
                    <div class="header">
                        <div class="fleft">
                            <asp:Label ID="lblHoldPopupName" runat="server" Text="Hold JOb"></asp:Label>
                        </div>
                        <div class="fright">
        ...
        <div id="divDataSource">
            <asp:SqlDataSource ID="SqlDataSourceCustomer" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                SelectCommand="BL_GetPendngBillDispatch" SelectCommandType="StoredProcedure">
                <SelectParameters>
