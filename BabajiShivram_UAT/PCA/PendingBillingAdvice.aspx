    ...
    <asp:UpdatePanel ID="upShipment" runat="server" UpdateMode="Conditional" RenderMode="Inline">
        <ContentTemplate>
             ...
             <fieldset id="mainfield" runat="server">
                ...
                <asp:GridView ID="gvJobDetail" runat="server" AutoGenerateColumns="False" CssClass="table" Style="white-space: normal"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="LR Pending">
                            <ItemTemplate>
                                <asp:DropDownList ID="ddlLrPending" runat="server" 
                                     >
                            ...
                            <%-- <ItemTemplate >
                                   <asp:Label ID="Label1" runat="server" Text='<%# Bind("BillLRStatus") %>'></asp:Label>
                               </ItemTemplate>--%>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Billing Instruction" Visible="false">
                            <ItemTemplate>
                        ...
                        <asp:BoundField DataField="Instr_status" HeaderText="Instr Status" Visible="false"/>
                        <asp:BoundField DataField="Doc_status" HeaderText="Doc Status" Visible="false"/>
                ...
                <ItemTemplate>
                    <%# (Boolean.Parse(Eval("PCDRequired").ToString())) ? "Yes" : "No"%>
                        ...
                        <asp:BoundField DataField="TransportationBy" HeaderText="Transport By" SortExpression="TransportationBy" />
            ...
            <div id="divContractBillingPrint" runat="server" visible="False">
                <%--<asp:Panel ID="PanelContractBillingPrint" runat="server" CssClass="ModalPopupPanel" Width="99%" Visible="false" ScrollBars="None" Height="100%">--%>
                <%--<table>
                        <tr>
                            <td>
                                <div>--%>
                                    &nbsp;<asp:Button ID="Button4" runat="server" Text="Close" CausesValidation="false" OnClick="btncloseContractBillingprint_Click" />
                ...
                <%--</div>
                        ...
                        <tr>
                            <td>
                                <div id="div5" runat="server" style="width: 98%; height: 30%;">--%>

                <%-- <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" AutoDataBind="true" ToolPanelView="None"
                    HasToggleGroupTreeButton="False" HasToggleParameterPanelButton="False" PageZoomFactor="100" Width="5px"></CR:CrystalReportViewer>--%>
                <%-- </div>
                            </td>
                        </tr>
                    </table>--%>
