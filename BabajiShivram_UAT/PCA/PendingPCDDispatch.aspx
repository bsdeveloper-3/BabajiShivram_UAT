<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PendingPCDDispatch.aspx.cs" Inherits="PendingPCDDispatch"
    MasterPageFile="~/MasterPage.master" Title="Pending Dispatch - Billing" EnableEventValidation="false" Culture="en-GB" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" ID="content1" runat="server">
    ...
    <asp:UpdatePanel ID="upShipment" runat="server" UpdateMode="Conditional" RenderMode="Inline">
        <ContentTemplate>
            ...
            <div class="clear"></div>
            <fieldset>
                <legend>Pending Dispatch - Billing</legend>
                <div class="m clear">
                        ...
                        <asp:Panel ID="pnlHadDeliveryPartTwo" runat="server" Visible="false">
                            <tr>
                               ...
                               <cc1:MaskedEditExtender ID="MEditExtDeliverDate" TargetControlID="txtPCDDeliveryDate" Mask="99/99/9999" MessageValidatorTip="true"
                                ...
                                <td>
                                    <asp:TextBox ID="txtPCDDeliveryDate" runat="server" Width="100px" placeholder="dd/mm/yyyy" CssClass="disable_future_dates" ></asp:TextBox>
            ...
            <div id="divDatasource">
                <asp:SqlDataSource ID="PCDSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                    SelectCommand="GetPendingPCDBillingDispatch" SelectCommandType="StoredProcedure">
                    <SelectParameters>
