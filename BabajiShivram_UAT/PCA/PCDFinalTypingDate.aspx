            ...
            <cc1:TabContainer ID="TabJobDetail" runat="server" CssClass="Tab" AutoPostBack="True" ActiveTabIndex="0" OnActiveTabChanged="TabJobDetail_ActiveTabChanged">
                <%--<cc1:TabPanel ID="TabPCDBilling" runat="server" TabIndex="0" HeaderText="Non Receive" visible="false">
                    <ContentTemplate>
                        ...
                        <%--DataSourceID="PCDSqlDataSource" OnRowDataBound="gvNonRecievedJobDetail_RowDataBound" OnPreRender="gvNonRecievedJobDetail_PreRender" OnPageIndexChanging="gvNonRecievedJobDetail_PageIndexChanging"--%
                        <asp:GridView ID="gvNonRecievedJobDetail" runat="server" AutoGenerateColumns="False"
                            CssClass="table" DataKeyNames="JobId" AllowPaging="True" AllowSorting="True" Width="100%" PageSize="20" 
