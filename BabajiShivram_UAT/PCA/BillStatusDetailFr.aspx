    ...
    <asp:UpdatePanel ID="upJobDetail" runat="server">
        <ContentTemplate>
            ...
            <AjaxToolkit:TabContainer runat="server" ID="Tabs" ActiveTabIndex="0" CssClass="Tab"
                ...
                <AjaxToolkit:TabPanel ID="TabCAN" runat="server" HeaderText="Buy/Sell">
                <ContentTemplate>
                <div>
                    <fieldset>
                        <legend>SELL/CAN</legend>
        ...
        <asp:BoundField DataField="CreatedBy" HeaderText="USER" SortExpression="CreatedBy"
            ReadOnly="true" />
                    ...
                    <fieldset>
                            <legend>BUY/Vendor Payment</legend>
                            <asp:GridView ID="gvVendorBuy" runat="server" AutoGenerateColumns="False"
                            CssClass="table" Width="99%" PagerStyle-CssClass="pgr"
                            DataKeyNames="InvoiceID" DataSourceID="SqlDataSourceVendorBuy" CellPadding="4"
                            AllowPaging="True" AllowSorting="True" PageSize="40">
                            <Columns>
                                <asp:TemplateField HeaderText="Sl">
                                    <ItemTemplate>
                                ...
                                <asp:BoundField HeaderText="Invoice Type" DataField="InvoiceTypeName" />
                                <asp:BoundField HeaderText="Invoice Amt - Rs" DataField="InvoiceCurrencyAmt" />
                                <asp:BoundField HeaderText="Paid Amt" DataField="PaidAmount" />
                                <asp:BoundField HeaderText="JB No" DataField="BJVJBNumber" />
                                ...
                                <asp:Repeater ID="rptBJVDetails" runat="server" OnItemDataBound="rptBJVDetails_ItemDataBound">
                                    ...
                                    <FooterTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lbltotDebitamt" runat="server" Font-Bold="true" Font-Size="Medium"></asp:Label></td>
                ...
                <asp:SqlDataSource ID="SqlDataSourceCanInvoice" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                    ...
                    <asp:SqlDataSource ID="SqlDataSourceVendorBuy" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                        SelectCommand="AC_GetInvoiceByJobID" SelectCommandType="StoredProcedure">
                        <SelectParameters>
                            <asp:SessionParameter Name="JobId" SessionField="JobId" />
                            <asp:Parameter Name="ModuleID" DefaultValue="2" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                </div>
        </ContentTemplate>
