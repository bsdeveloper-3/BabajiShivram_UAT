...
using System.IO;
public partial class PendingPCDScrutiny : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            {
                lblMessage.Text = "No Job Found For Billing Scrutiny!";
        ...
        DataFilter1.FilterSessionID = "PendingPCDScrutiny.aspx";
    ...
    protected void gvJobDetail_RowCommand(Object Sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName.ToLower() == "select")
        {
            ...
            Response.Redirect("PCDScrutiny.aspx");
        }
    }
    ...
    {
        string strFileName = "PendingBillingScrutiny_" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
    ...
    private void ExportFunction(string header, string contentType)
    {
        ...
        gvJobDetail.Caption = "Pending Billing Scrutiny On " + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt");
