    ...
    <asp:UpdatePanel ID="upJobDetail" runat="server">
        ...
        <ContentTemplate>
            ...
            <cc1:tabcontainer id="TabJobDetail" runat="server" autopostback="True" activetabindex="0"
                ...
                <cc1:TabPanel ID="TabPCDBilling" runat="server" TabIndex="0" HeaderText="Non Receive" Visible="false">
                    <ContentTemplate>
                        <div align="center">
                            ...
                            <asp:Label ID="lblMessage1" runat="server" Test="No Contract Is Available In System"></asp:Label>
                        ...
                        <asp:GridView ID="gvNonRecievedJobDetail" runat="server" AutoGenerateColumns="False"
                            ...
                            AllowSorting="True" Width="100%" PageSize="20" PagerSettings-Position="TopAndBottom" OnRowCommand="gvNonRecievedJobDetail_RowCommand"
                           >
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <asp:CheckBox ID="chk11" runat="server" ToolTip="Check"></asp:CheckBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="BS Job No" SortExpression="JobRefNo">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkJobNo" runat="server" Text='<%#Eval("JobRefNo") %>' CommandName="select" CommandArgument='<%#Eval("JobId") +";"+ Eval("JobType")%>' ></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                        ...
                        <asp:Button ID="Button2" ValidationGroup="Required" runat="server" Style="display: none" />
                        <cc1:ModalPopupExtender ID="mpeBillingInstruction" runat="server" TargetControlID="Button2" PopupControlID="pnlBillingInstruction" DynamicServicePath="" Enabled="True"></cc1:ModalPopupExtender>
                        <asp:Panel ID="pnlBillingInstruction" Style="display: none; min-width: 60%" runat="server">
                            <fieldset class="ModalPopupPanel">
                                <div title="Consolidated Details" class="header">
                                    <textbox>Billing Instruction</textbox>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:ImageButton ID="ImageButton2" align="center" ImageUrl="~/Images/delete.gif" runat="server" ToolTip="Close" />
                                </div>
                                <div class="AutoExtenderList">
                                    <table width="100%">
                                <div id="Div3" runat="server" style="max-height: 550px; overflow: auto; text-align: center;">
                                    <div align="center">
                                        <table class="table" border="0" cellpadding="0" cellspacing="0" width="100%" align="center" style="text-align: left;">
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="5">
                                                    <asp:Label ID="lblJobRefNo" runat="server"></asp:Label></td>
                                            </tr>
                                            <tr>
                                                <td><b>Allied Service</b></td>
                                                <td>
                                                    <div style="word-wrap: break-word; width: 200px; white-space:normal;">
                                                    <asp:Label ID="lblAlliedService" runat="server" ></asp:Label>
                                                        </div>
                                                </td>
                                                <td><b>Allied Remark</b></td>
                                                <td>
                                                    <div style="word-wrap: break-word; width: 200px; white-space:normal;">
                                                    <asp:Label ID="lblAlliedRemark" runat="server" ></asp:Label>
                                                        </div>
                                                </td>
                                                <td>
                                                    <asp:Button ID="btnReadAllied" runat="server" Text="Read" OnClick="btnReadAllied_Click" />
                                                </td>
                                                <td>
                                                    <asp:Button ID="btnChargeAllied" runat="server" Text="Charge" Enabled="False" OnClick="btnChargeAllied_Click"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Button ID="btnReadOther" runat="server" Text="Read" OnClick="btnReadOther_Click" />
                                                </td>
                                                <td>
                                                    <asp:Button ID="btnChargeOther" runat="server" Text="Charge" Enabled="False" OnClick="btnChargeOther_Click"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Button ID="btnCharge" runat="server" Text="Charge" Enabled="False" OnClick="btnCharge_Click"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><b>Other Instruction</b></td>
                                                ...
                                                <td>
                                                    <asp:Button ID="btnRead1" runat="server" Text="Read" OnClick="btnRead1_Click" />
                                                </td>
                                                <td>
                                                    <asp:Button ID="btnCharge1" runat="server" Text="Charge" Enabled="False" OnClick="btnCharge1_Click"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><b>Other Instruction</b></td>
                                                ...
                                                <td>
                                                    <asp:Button ID="btnRead2" runat="server" Text="Read" OnClick="btnRead2_Click"/>
                                                </td>
                                                <td>
                                                    <asp:Button ID="btnCharge2" runat="server" Text="Charge" Enabled="False" OnClick="btnCharge2_Click"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><b>Other Instruction</b></td>
                                                ...
                                                <td>
                                                    <asp:Button ID="btnRead3" runat="server" Text="Read" OnClick="btnRead3_Click"/>
                                                </td>
                                                <td>
                                                    <asp:Button ID="btnCharge3" runat="server" Text="Charge" Enabled="False" OnClick="btnCharge3_Click"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><b>User Name</b></td>
                ...
                <cc1:TabPanel ID="TabPCDBilling1" runat="server" TabIndex="1" HeaderText="">
                    <ContentTemplate>
                        <div align="center">
                        ...
                        <asp:GridView ID="gvRecievedJobDetail" runat="server" AutoGenerateColumns="False" CssClass="table"
                            ...
                            PageSize="40" PagerSettings-Position="TopAndBottom"
