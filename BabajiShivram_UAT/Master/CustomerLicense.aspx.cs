...
using System.IO;
public partial class Master_CustomerLicense : System.Web.UI.Page
{
    ...
    protected void FormViewDataSource_Inserted(object sender, SqlDataSourceStatusEventArgs e)
    {
        lberror.Visible = true;
        ...
        if (Result > 0)
        {
            lberror.Text = "Detail Added Successfully !";
            lberror.CssClass = "success";
        }
        else if (Result == 0)
        {
        ...
        {
            lberror.Text = "License Detail Already Exists!";
            lberror.CssClass = "errorMsg";
        }
    }
    ...
    protected void btnReturnLicense_Click(object sender, EventArgs e)
    {
        ...
        int Result = DBOperations.AddLicenseRetrun(LicenseID,dtReturnDate,strReturnAddress, intDispatchMode, strCourierName, LoggedInUser.glUserId);
    ...
    {
        string strFileName = "CustomerLicense" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
    ...
    private void ExportFunction(string header, string contentType)
    {
        ...
        gvCustomerLicense.AllowSorting = false;

        gvCustomerLicense.Columns[1].Visible = false;
        gvCustomerLicense.Columns[2].Visible = true;

        gvCustomerLicense.Columns[5].Visible = false;
        gvCustomerLicense.Columns[6].Visible = true;
