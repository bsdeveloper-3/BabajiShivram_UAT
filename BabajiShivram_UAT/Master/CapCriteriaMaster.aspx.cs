...
public partial class Master_CapCriteriaMaster : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            lblTitle.Text = "Cap Criteria Detail";
        ...
        DataFilter1.DataColumns = gvCap.Columns;
        DataFilter1.FilterSessionID = "CapCriteriaMaster.aspx";
    ...
    protected void gvCap_SelectedIndexChanged(object sender, EventArgs e)
    {
        gvCap.Visible = false;
        DataFilter1.Visible = false;
        fsMainBorder.Visible = false;
        if (gvCap.SelectedIndex == -1)
        {
    ...
    protected void gvCap_PreRender(object sender, EventArgs e)
    {
    ...
    {
        string strFileName = "BabajiDivisionDetail_" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
    ...
    private void ExportFunction(string header, string contentType)
    {
        ...
        gvCap.AllowPaging = false;
        gvCap.AllowSorting = false;
        gvCap.Columns[1].Visible = false;
        gvCap.Columns[2].Visible = true;

        DataFilter1.FilterSessionID = "CapCriteriaMaster.aspx";
        DataFilter1.FilterDataSource();
        gvCap.DataBind();

        gvCap.RenderControl(hw);
