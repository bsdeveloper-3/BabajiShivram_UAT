<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PassingStageMS.aspx.cs" MasterPageFile="~/MasterPage.master"
    Inherits="PassingStageMS" Title="Passing Stage Setup" %>
    ...
    <div>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" RenderMode="Inline">
            <ContentTemplate>
                ...
                <div class="clear"></div>
               <fieldset>
            <legend>Passing Stage Detail</legend> 
                <asp:GridView ID="gvPStageMaster" runat="server" CssClass="table" AutoGenerateColumns="false"
                    AllowPaging="true" OnPageIndexChanging="gvPStageMaster_PageIndexChanging" PageSize="20"
                    PagerSettings-Position="TopAndBottom" OnRowDeleting="gvPStageMaster_RowDeleting"
                    OnRowEditing="gvPStageMaster_RowEditing" OnRowCancelingEdit="gvPStageMaster_RowCancelingEdit"
                    OnRowCommand="gvPStageMaster_RowCommand" OnRowUpdating="gvPStageMaster_RowUpdating"
                    ShowFooter="true">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Passing Stage Name">
                            <ItemTemplate>
                                <asp:Label ID="lblStageName" runat="server" Text='<%# Eval("StageName") %>' />
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:TextBox ID="txteStageName" runat="server" Text='<%# Eval("StageName") %>' MaxLength="50"
                                     />
                                <span style="color: Red;">*</span>
                            </EditItemTemplate>
                            <FooterTemplate>
                                <asp:TextBox ID="txtStageName" runat="server" Text='<%#Eval("StageName") %>' MaxLength="50"
                                     TabIndex="1" />
                                <span style="color: Red;">*</span>
                            </FooterTemplate>
                        </asp:TemplateField>
