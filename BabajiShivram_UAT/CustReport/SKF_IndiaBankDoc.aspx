<%@ Page Title="Bank Doc" Language="C#" MasterPageFile="~/CustomerMaster.master" AutoEventWireup="true"
    CodeFile="SKF_IndiaBankDoc.aspx.cs" Inherits="Reports_SKFIndiaBankDoc"  Culture="en-GB"%>
        ...
        <ContentTemplate>
            ...
            <div class="clear"></div>
                <asp:GridView ID="gvReport" runat="server" AutoGenerateColumns="False" CssClass="table"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="Invoice Dt" DataField="Invoice Dt" />
                        <asp:BoundField HeaderText="Invoice Amt" DataField="Invoice Amt" />
                        <asp:BoundField HeaderText="Currency" DataField="Currency" />
                        <asp:BoundField HeaderText="MBL/MAWBL No" DataField="MBL/MAWBL No" />
                        <asp:BoundField HeaderText="BE No" DataField="BE No" />
                        <asp:BoundField HeaderText="BE Date" DataField="BE Date" />
                        <asp:BoundField HeaderText="Clearance Dt" DataField="Clearance Dt" />
                        <asp:BoundField HeaderText="Document Send Date" DataField="Document Send Date" />
            ...
            <div>
                <asp:SqlDataSource ID="DataSourceReport" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                 SelectCommand="rptSKFIndiaBankDoc" SelectCommandType="StoredProcedure">
                <SelectParameters>
