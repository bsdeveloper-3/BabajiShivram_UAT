...
public partial class CustReport_SKF_IndiaLicense : System.Web.UI.Page
{
    ...
    {
        string strFileName = "SKF_India_License_MIS" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
