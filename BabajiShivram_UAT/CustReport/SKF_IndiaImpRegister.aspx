<%@ Page Title="Import Register" Language="C#" MasterPageFile="~/CustomerMaster.master"  AutoEventWireup="true" CodeFile="SKF_IndiaImpRegister.aspx.cs"
    Inherits="CustReport_SKF_IndiaImpRegister" Culture="en-GB" %>
    ...
    <asp:UpdatePanel ID="upPendingchecklist" runat="server" UpdateMode="Conditional" RenderMode="Inline">
        <ContentTemplate>
            ...
            <Columns>
                        ...
                        <%--
                        <asp:BoundField HeaderText="PO NO" DataField="Payment LoT No" />
                        <asp:BoundField HeaderText="DUTY" DataField="Total Duty Paid" />
                        <asp:BoundField HeaderText="HOUSE WAYBILL DATE" DataField="HBL Date" />
                        <asp:BoundField HeaderText="STAX/ GST AMT" DataField="GST Amount (BSR Invoice)" />
                        <asp:BoundField HeaderText="FCL / LCL" DataField="Type OF delivery (FCL/LCL)" />
                        <asp:BoundField HeaderText="BSR Bill Amount (INR)" DataField="BSR Bill Amount (INR)" />
                        <asp:BoundField HeaderText="BSR Bill Invoice No" DataField="BSR Bill Invoice No" />
                        <asp:BoundField HeaderText="DFT DISPATCH DATE" DataField="DFT DISPATCH DATE" />
                         <%--<asp:BoundField HeaderText="BSR JOB No" DataField="BSR JOB No" />--%>
