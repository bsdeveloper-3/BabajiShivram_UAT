...
public partial class CustReport_SKF_IndiaBCDDSR : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            if (Session["CustId"].ToString() == "703")
            {
                ...
                lblTitle.Text = "SKF Technology BCD DSR";
                lblLegend.Text = "SKF Technology BCD DSR";
            }
            else
            {
                Session["CustId"] = "1322";
                Label lblTitle = (Label)Page.Master.FindControl("lblTitle");
                lblTitle.Text = "SKF India BCD DSR";
                lblLegend.Text = "SKF India BCD DSR";
            }
    ...
    private DataView BindFilter()
    {
        ...
        {
            strFilter = "[BS Job No] = '" + txtJobNo.Text.Trim() + "'";
    ...
    {
        string strFileName = "SKF_India_BCD_DSR" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
    ...
    private void ExportWorkbook(string header, string contentType)
    {
        ...
        {
            string Report = "SKF_India_BCD_DSR" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
            ...
            if (dtReport.Rows.Count > 0)
            {
                ...
                dtReport.TableName = "SKF_India_BCD_DSR";
                string strFileName = "SKF_India_BCD_DSR.xlsx";
