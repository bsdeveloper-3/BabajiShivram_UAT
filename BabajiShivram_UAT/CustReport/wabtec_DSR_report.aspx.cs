...
public partial class Reports_webtec_DSR_report : System.Web.UI.Page
{
    ...
    private void ExportWorkbook(string header, string contentType)
    {
        ...
        DataTable dtReport = DBOperations.WabTecDSR(LoggedInUser.glUserId, LoggedInUser.glFinYearId, Convert.ToInt16(ddClearedStatus.SelectedValue), (ddConsignee.SelectedValue), Convert.ToDateTime(txtFromDate.Text), Convert.ToDateTime(txtToDate.Text));
