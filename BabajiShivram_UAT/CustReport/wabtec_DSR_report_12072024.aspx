<%@ Page Title="" Language="C#" MasterPageFile="~/CustomerMaster.master" AutoEventWireup="true" CodeFile="wabtec_DSR_report.aspx.cs" Inherits="Reports_webtec_DSR_report" 
                ...
                <asp:GridView ID="gvReport" runat="server" AutoGenerateColumns="False" CssClass="table" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Supplier Invoice No">
                            <ItemTemplate>
                                <div style="word-wrap: break-word; width: 400px; white-space: normal;">
                                    <asp:Label ID="lblRemark" runat="server" Text='<%#Bind("[Supplier Invoice No]") %>'></asp:Label>
                                </div>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Supplier Invoice Date">
                            <ItemTemplate>
                                <div style="word-wrap: break-word; width: 400px; white-space: normal;">
                                    <asp:Label ID="Label1" runat="server" Text='<%#Bind("[Supplier Invoice Date]") %>'></asp:Label>
                                </div>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Supplier Invoice Value">
                            <ItemTemplate>
                                <div style="word-wrap: break-word; width: 400px; white-space: normal;">
                                    <asp:Label ID="Label2" runat="server" Text='<%#Bind("[Supplier Invoice Value]") %>'></asp:Label>
                                </div>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField HeaderText="Currency" DataField="Related party Import SVB" />
                        <asp:BoundField HeaderText="Related party Import (SVB)" DataField="Related party Import SVB" />
                        ...
                        <asp:TemplateField HeaderText="Remarks(Day Wise Detail action)">
                            <ItemTemplate>
                                <div style="word-wrap: break-word; width: 400px; white-space: normal;">
                                    <asp:Label ID="Label3" runat="server" Text='<%#Bind("[Remarks Day Wise Detail action]") %>'></asp:Label>
                                </div>
                            </ItemTemplate>
                        </asp:TemplateField>
