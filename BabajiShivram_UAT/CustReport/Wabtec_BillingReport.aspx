<%@ Page Title="" Language="C#" MasterPageFile="~/CustomerMaster.master" AutoEventWireup="true" CodeFile="Wabtec_BillingReport.aspx.cs" Inherits="Reports_Wabtec_BillingReport" 
    EnableSessionState="True" Culture="en-GB" %>
                ...
                <tr>
                    <td>Job Date From
                        <cc1:calendarextender id="CalExtJobFromDate" runat="server" enabled="True" enableviewstate="False"
                            firstdayofweek="Sunday" Format="MM/dd/yyyy" popupbuttonid="imgFromDate" popupposition="BottomRight"
                    ...
                    <td>Job Date To
                        <cc1:calendarextender id="CalExtJobFromTo" runat="server" enabled="True" enableviewstate="False"
                            firstdayofweek="Sunday" Format="MM/dd/yyyy" popupbuttonid="imgToDate" popupposition="BottomRight"
