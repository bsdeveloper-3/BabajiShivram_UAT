<%@ Page Title="Transport Payment Tracking" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
        CodeFile="TransPaymentTracking.aspx.cs" Inherits="AccountTransport_TransPaymentTracking" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <ContentTemplate>
        ...
        <fieldset><legend>Transporter Invoice</legend>
        <div class="clear">
        ...
        <asp:GridView ID="gvDetail" runat="server" AutoGenerateColumns="False" CssClass="table" DataKeyNames="TransReqId"
                 ...
                 <asp:TemplateField HeaderText="Job No" SortExpression="FARefNo">
                    <ItemTemplate>
                        <asp:LinkButton ID="lnkJobRefNo" CommandName="select" runat="server" Text='<%#Eval("JobRefNo") %>'
                            CommandArgument='<%#Eval("TransReqId") %>' />
                    </ItemTemplate>
                </asp:TemplateField>
