...
using System.IO;
public partial class AccountTransport_Bill2 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            lblTitle.Text = "Bill Advice History";
        ...
        DataFilter1.FilterSessionID = "Bill2.aspx";
    ...
    protected void gvJobDetail_RowCommand(Object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName.ToLower() == "select")
        {
            ...
            Response.Redirect("BillSubmissionCustView.aspx");
        }
    }
    ...
    protected void lnkJobExport_Click(object sender, EventArgs e)
    {
        ...
        gvJobDetail.Caption = "Customer Draft Bill_" + DateTime.Now.ToString("dd/MM/yyyy hh:mm");
        DataFilter1.FilterSessionID = "Bill2.aspx";
        DataFilter1.FilterDataSource();
        gvJobDetail.DataBind();
