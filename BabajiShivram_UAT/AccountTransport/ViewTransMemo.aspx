<%@ Page Title="View Memo Detail" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeFile="ViewTransMemo.aspx.cs" Inherits="AccountTransport_ViewTransMemo" %>
    ...
    <fieldset><legend runat="server">Job Detail &nbsp;
        ...
        <asp:GridView ID="gvDetail" runat="server" AutoGenerateColumns="False" CssClass="table" DataKeyNames="MemoId"
            ...
            PageSize="20" AllowPaging="True" AllowSorting="True" PagerSettings-Position="TopAndBottom" Width="100%" >
        <Columns>
...
<%--            <asp:BoundField DataField="ProfitLossPercent" HeaderText="P&L %" SortExpression="ProfitLossPercent" />
    ...
    <div>
        <asp:SqlDataSource ID="InvoiceSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
            ...
            <SelectParameters>
                <asp:SessionParameter Name="MemoId" SessionField="MemoViewId" />
