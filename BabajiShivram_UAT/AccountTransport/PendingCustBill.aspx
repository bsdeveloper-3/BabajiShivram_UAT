<%@ Page Title="Customer Bill" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeFile="PendingCustBill.aspx.cs" Inherits="AccountTransport_PendingCustBill" %>
...
<asp:ScriptManager runat="server" ID="ScriptManager1" />
    ...
    <asp:UpdatePanel ID="upPendingchecklist" runat="server" UpdateMode="Conditional" RenderMode="Inline">
        <ContentTemplate>
            ...
            <fieldset><legend>Customer Billing Advice - NBCPL</legend>
                <div class="m clear">
                ...
                <asp:GridView ID="gvJobDetail" runat="server" AutoGenerateColumns="False" CssClass="table"
                    ...
                    OnRowCommand="gvJobDetail_RowCommand" OnRowDataBound="gvJobDetail_RowDataBound" PagerSettings-Position="TopAndBottom">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Ref No" SortExpression="TRRefNo">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkSelect" CommandName="select" runat="server" Text='<%# Eval("TRRefNo")%>'
                                    ToolTip="Click To Update Bill Detail" CommandArgument='<%# Eval("TransReqID")%>'></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:BoundField HeaderText="Bill Amount" DataField="BillAmount" ReadOnly="true" SortExpression="BillAmount" />
                        <asp:TemplateField HeaderText="FA Posting">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkPost" CommandName="Post" runat="server" Text='Send To Billing Dept' Visible="false"
                                    ToolTip="Send Bill To Billing Dept For Draft Bill Generation" CommandArgument='<%# Eval("TransReqID")%>'
                                    OnClientClick="return confirm('Sure to Post Draft Bill in FA System ?');"></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                ...
                <asp:SqlDataSource ID="DataSourceVehicle" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                    SelectCommand="TRS_GetPendingCustBill" SelectCommandType="StoredProcedure">
                    <SelectParameters>
