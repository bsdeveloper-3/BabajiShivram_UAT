<%@ Page Title="Memo Payment" Language="C#" MasterPageFile="~/MasterPage.master" 
    AutoEventWireup="true" CodeFile="PendingTransMemoPayment.aspx.cs" Inherits="AccountTransport_PendingTransMemoPayment" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div>
        ...
        <asp:UpdatePanel ID="upFillDetails" runat="server" UpdateMode="Conditional">
            ...
            <fieldset><legend>Transport Memo Payment</legend>
            <div class="clear">
            <asp:Panel ID="pnlFilter" runat="server">
                ...
                <div class="fleft" style="margin-left:30px; padding-top:3px;">
                <asp:Button ID="btnPayMemo" runat="server" Text="API - Initiate Payment To Transporter " OnClick="btnPayMemo_Click" OnClientClick="return confirm('Sure to Pay Memo Amount To Transporter?');" />
                &nbsp;&nbsp;
                <asp:Button ID="btnRejectMemo" runat="server" Text="Reject Memo" OnClick="btnRejectMemo_Click" OnClientClick="return confirm('Sure to Pay Reject Memo?');" />
                </div>
            </asp:Panel>
            </div>
        ...
        <div>
            <asp:SqlDataSource ID="InvoiceSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                SelectCommand="TRS_GetPendingMemoForPayment" SelectCommandType="StoredProcedure">
            </asp:SqlDataSource>
        </div>
    </ContentTemplate>
    </asp:UpdatePanel>
