...
public partial class AccountTransport_TransPaymentReport : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DataFilter1.FilterSessionID = "TransPaymentReport.aspx";
    ...
    {
        string strFileName = "Transport_Payment_" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
