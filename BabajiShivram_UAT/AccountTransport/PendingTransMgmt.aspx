<%@ Page Title="NBCPL Mgmt Approval" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PendingTransMgmt.aspx.cs" 
   Inherits="AccountTransport_PendingTransMgmt" EnableEventValidation="false" Culture="en-GB" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:UpdatePanel ID="upFillDetails" runat="server" UpdateMode="Conditional">
        ...
        <fieldset><legend>NBCPL - Transporter Payment Approval</legend>
        <div class="clear">
