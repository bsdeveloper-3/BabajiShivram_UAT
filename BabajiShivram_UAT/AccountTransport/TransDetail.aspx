<%@ Page Title="Transport Payment Tracking" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
        CodeFile="TransDetail.aspx.cs" Inherits="AccountTransport_TransDetail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <ContentTemplate>
        <div>
            ...
            <fieldset>
                <legend>Transporter Payment Request Detail</legend>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="white">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="lblPaidAmount" runat="server" Font-Bold="true" Font-Size="12"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <asp:Label ID="lblJBNo" runat="server" Font-Bold="true"></asp:Label>
                            </td>
                            <td>
                                Request By
                            </td>
                ...
                <legend>Previous Payment Request</legend>   
                    <asp:GridView ID="grdJobHistory" runat="server" CssClass="table" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="TRRefNo" HeaderText="Ref No" />
                            ...
                            <asp:BoundField DataField="TDSTotalAmount" HeaderText="TDS" />
                            <asp:BoundField DataField="PaidAmount" HeaderText="Paid Amt" />
                            <asp:BoundField DataField="VendorName" HeaderText="Paid To" />
                            <asp:BoundField DataField="RequestBy" HeaderText="Created By" />
        ...
        <div id="divDatasourc"> 
            <asp:SqlDataSource ID="DataSourceRate" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                ...
                <SelectParameters>
                    <asp:SessionParameter Name="PayRequestId" SessionField="TransPayIdTrack" />
                    </SelectParameters>
            </asp:SqlDataSource>
            ...
            <asp:SqlDataSource ID="InvoiceDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                ...
                <SelectParameters>
                    <asp:SessionParameter Name="RequestId" SessionField="TransPayIdTrack" />
                </SelectParameters>
            </asp:SqlDataSource>
            <asp:SqlDataSource ID="DataSourcePaymentHistory" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                SelectCommand="TRS_GetPaymentDetail" SelectCommandType="StoredProcedure">
                <SelectParameters>
                    <asp:SessionParameter Name="RequestId" SessionField="TransPayIdTrack" />
                </SelectParameters>
            </asp:SqlDataSource>
