...
using System.IO;
public partial class AccountTransport_TransBillPendingHOD : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            lblTitle.Text = "Pending HoD Approval";
        }

        DataFilter1.DataSource = DataSourceBill;
        DataFilter1.DataColumns = gvReceiveBill.Columns;
        DataFilter1.FilterSessionID = "TransBillPendingHOD.aspx";
    ...
    protected void lnkExport_Click(object sender, EventArgs e)
    {
        ...
        string strFileName = "Bill_HoD_" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
