<%@ Page Title="SEZ Report" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SEZReport.aspx.cs"
     Inherits="SEZ_SEZReport" Culture="en-GB" %>
            ...
            <div class="clear">
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="white">
                    <tr>
                        <td>
                            ...
                            <asp:TextBox ID="txtReportName" runat="server" MaxLength="300" TabIndex="1"></asp:TextBox>
                        </td>
                      <%--  <td>
                            Report Type &nbsp;
                        ...
                        <td>
                            <asp:Button ID="btnSave" runat="server" Text="Save Report" 
                                ValidationGroup="Required" TabIndex="4" OnClick="btnSave_Click"/>
                            <%----%>
                            <asp:Button ID="btnUpdate" runat="server" Text="Update Report" Visible="false" OnClick="btnUpdate_Click"/>
                ...
                <div id="divReportField">
                    ...
                    <div style="float: left;">
                        <br /><br /><br /><br />
                        <asp:ImageButton ID="btnInsert" runat="server" ImageUrl="~/Images/right-arrow-key.png" 
                            Width="30px" Height="30px" ToolTip="Add Report Field" TabIndex="6" OnClick="btnInsert_Click"/>
                        
                        <br /><br /><br /><br />
                        <asp:ImageButton ID="btnRemove" runat="server"  ImageUrl="~/Images/left-arrow-key.png" Width="30px" 
                            Height="30px" ToolTip="Remove Report Field" TabIndex="7" OnClick="btnRemove_Click"/>
