<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NFormLogin.aspx.cs" Inherits="NForm_NFormLogin" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>NForm Login - Babaji Shivram</title>
                                    ...
                                    <td>
                                        <div>
                                            ...
                                            <div style="margin-bottom: 15px;">
                                                <asp:TextBox ID="txtTempUser" runat="server" required="" class="form-control" placeholder="Email"
                                                    ToolTip="Enter Email ID." TabIndex="1"></asp:TextBox>
                                            </div>
                                            <!-- Password -->
                                            <div class="form-group">
                                                <asp:TextBox ID="txtTempPasscode" runat="server" class="form-control" placeholder="Password"
