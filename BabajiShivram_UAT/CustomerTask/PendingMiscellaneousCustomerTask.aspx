<%@ Page Title="Pending Customer Task" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PendingMiscellaneousCustomerTask.aspx.cs" Inherits="PendingMiscellaneousCustomerTask" %>
...
<asp:ScriptManager runat="server" ID="ScriptManager1" />
    <fieldset>
        <legend>Pending Miscellaneous Customer Task</legend>
        ...
        <asp:GridView ID="GridExelCustomerTask" PagerStyle-CssClass="pgr" CssClass="table" runat="server"
        ...
        <asp:GridView ID="GridMiscellaneousCustomerTask" runat="server" AutoGenerateColumns="False"
            Width="100%" PagerStyle-CssClass="pgr" DataSourceID="PendingMiscellaneousCustomerTaskDataSorce"
            CssClass="table" CellPadding="4" DataKeyNames="LID" OnRowDataBound="GridMiscellaneousCustomerTask_RowDataBound"
            AllowPaging="True" AllowSorting="True" PageSize="20" OnRowCommand="GridMiscellaneousCustomerTask_RowCommand">
            <Columns>
                <asp:TemplateField HeaderText="Sl">
                    <ItemTemplate>
                        <%#Container.DataItemIndex +1 %>
    ...
    <div>
        <asp:SqlDataSource ID="PendingCustomerTaskDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
            SelectCommand="BS_GetCustomerTaskDeatilEXLFile" SelectCommandType="StoredProcedure">
            <SelectParameters>
        ...
        <asp:SqlDataSource ID="PendingMiscellaneousCustomerTaskDataSorce" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
            SelectCommand="GetEmployeeAssignedMiscellaneousCustomerTask" SelectCommandType="StoredProcedure">
            <SelectParameters>
                <asp:SessionParameter Name="UserId" SessionField="UserId" />
