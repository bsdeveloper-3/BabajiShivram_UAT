...
public partial class PendingMiscellaneousCustomerTask : System.Web.UI.Page
{
    LoginClass LoggedInUser = new LoginClass();
    protected void Page_Load(object sender, EventArgs e)
    {
        Label lblTitle = (Label)Page.Master.FindControl("lblTitle");
        lblTitle.Text = "Pending Miscellaneous Customer Task";
        ...
        DataFilter1.DataColumns = GridMiscellaneousCustomerTask.Columns;
        // DataFilter1.FilterSessionID = "StockHistory.aspx";
        DataFilter1.OnDataBound += new DynamicData_Content_DataFilter.BindDataGridView(DataFilter1_OnDataBound);

    }

    protected void GridMiscellaneousCustomerTask_PreRender(object sender, EventArgs e)
    {
    ...
    protected void GridMiscellaneousCustomerTask_RowCommand(Object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName.ToLower() == "download")
        {
            ...
            GridMiscellaneousCustomerTask.DataBind();
    ...
    protected void GridMiscellaneousCustomerTask_RowDataBound(object sender, GridViewRowEventArgs e)
    {
    ...
    private void ExcelExport(string header, string contentType)
    {
        ...
        GridExelCustomerTask.Visible = true;
        GridExelCustomerTask.AllowPaging = false;
        GridExelCustomerTask.AllowSorting = false;

        GridExelCustomerTask.DataSourceID = "PendingCustomerTaskDataSource"; //"PendingCustomerTaskDataSource";
        GridExelCustomerTask.DataBind();

        //Remove Controls
        this.RemoveControls(GridExelCustomerTask);


        GridExelCustomerTask.RenderControl(hw);
