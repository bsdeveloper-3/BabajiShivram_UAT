<%@ Page Title="Eway Bills By Date" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeFile="EWayGenByDate.aspx.cs" Inherits="EWayBill_EWayGenByDate" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="clear"></div>
    <fieldset>
        <legend>EWay Bill By Date</legend>
    ...
    <asp:Image ID="Image2" runat="server" ImageUrl="../images/Excel.jpg" ToolTip="Export To Excel" ImageAlign="AbsMiddle" />
    </asp:LinkButton>
