<%@ Page Title="Extend Validity EWayBill" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeFile="ExtendValidityEWayBill.aspx.cs" Inherits="EWayBill_ExtendValidityEWayBill" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <fieldset><legend>Search & Extend E-Way Bill Validity</legend>
    ...
    <asp:Label ID="lblMessage" runat="server" ForeColor="Red" Text="Note *** Bill Extend Facility is allowed only 8 hours before expiry of validity time of EWB..!!" Font-Size="Large"></asp:Label>
