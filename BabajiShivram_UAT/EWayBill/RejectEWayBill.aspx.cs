...
public partial class EWayBill_RejectEWayBill : System.Web.UI.Page
{
    ...
    protected void btnGetewayBill_Click(object sender, EventArgs e)
    {
        ...
        Session["EwayReject"] = EwbNo;
        Session["userGSTIN"] = ddTrasnporter.SelectedValue;
        Response.Redirect("ConfirmRejectEwayBill.aspx");
