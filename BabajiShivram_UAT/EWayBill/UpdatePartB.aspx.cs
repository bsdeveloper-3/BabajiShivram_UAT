...
public partial class EWayBill_UpdatePartB : System.Web.UI.Page
{ LoginClass loggedInUser = new LoginClass();
    protected void Page_Load(object sender, EventArgs e)
    {
        Label lblTitle = (Label)Page.Master.FindControl("lblTitle");

        lblTitle.Text = "E-Way Bill Part B";
       ...
       if (Session["userGSTIN"] != null && Session["EwayPartB"] != null)
        {
            ...
            reqVehicleNo.FromState = Convert.ToInt32(ddState.SelectedValue);
            ...
            reqVehicleNo.vehicleType = rblVehicleType.SelectedValue;

            System.Web.Script.Serialization.JavaScriptSerializer serializer = new System.Web.Script.Serialization.JavaScriptSerializer();
            var json = serializer.Serialize(reqVehicleNo);
            TxnRespWithObj<RespVehicleNoUpdtPl> resVehicleNoUpdt = EWBAPI.UpdateVehicleNosync(EwbSession, json);
            ...
            if (resVehicleNoUpdt.IsSuccess)
            {
                ...
                Session["EwayMessage"] ="EWay Bill No:"+ strEWayBillNo + " is Valid Upto: "+resVehicleNoUpdt.RespObj.validUpto;
