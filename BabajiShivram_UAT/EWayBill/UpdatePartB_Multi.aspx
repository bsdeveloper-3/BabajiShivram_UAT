<%@ Page Title="Part B Multi Vehicle" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
        CodeFile="UpdatePartB_Multi.aspx.cs" Inherits="EWayBill_UpdatePartB_Multi" Culture="en-GB" %>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <table id="tbl_part_b" class="table table-bordered table-hover table-responsive" style="margin-bottom: 0; width: 100%;">
                                                <tbody>
                                                    <tr>
                                                        <td colspan="2" class="table table-bordered " style="background-color: steelblue;"><span id="ctl00_ContentPlaceHolder1_Label3" style="color: White; font-weight: bold;">Update Part-B for Multiple Vehicle</span></td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <asp:RadioButtonList ID="rblMode" runat="server" CssClass="rdn_trans space" RepeatDirection="Horizontal" RepeatLayout="Table" Enabled="false">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <span style="font-weight: bold;">Quantity In Vehicle</span>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td align="center" colspan="2">
                                                            <asp:Button ID="btnSubmit" Text="Multi Vehicle - Add Part B" runat="server" OnClick="btnSubmit_Click" ValidationGroup="Required1" 
                                                                OnClientClick="return validateAndConfirm('Sure to Add Vehicle for Muli Transport?');"/>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
