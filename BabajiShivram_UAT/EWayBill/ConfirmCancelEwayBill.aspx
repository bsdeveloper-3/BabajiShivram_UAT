<%@ Page Title="Cancel EWay Bill" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeFile="ConfirmCancelEwayBill.aspx.cs" Inherits="EWayBill_ConfirmCancelEwayBill" Culture="en-GB" %>
            ...
            <div class="pagelayout">
                <table id="table_details" class="table_css table borderless " border="0">
                    <tbody>
                        ...
                        <tr style="border-top: 2px solid Gray">
                            <td class="bg-primary" colspan="3" style="height: 30px; font-weight: bold">
                                <span style="margin-right: 5px">6.</span> Cancellation Detail </td>
                        </tr>
                        <tr>
                            <td>
                                Cancellation Reason &nbsp;&nbsp;
                                <asp:RequiredFieldValidator ID="rfvReason" runat="server" ControlToValidate="ddCancelReason" InitialValue="0"
                                ...
                                <asp:DropDownList ID="ddCancelReason" runat="server">
			                        ...
			                        <asp:ListItem value="3">Data Entry mistake </asp:ListItem>
			                        <asp:ListItem value="4">Others </asp:ListItem>
		                        </asp:DropDownList>
                            </td>
                            <td>
                                <span style="vertical-align:text-top;"> Cancel Remark </span>
                                <asp:RequiredFieldValidator ID="RFVRemark" runat="server" ControlToValidate="txtCancelRemark" InitialValue="" Display="Dynamic"
                                  Text="Required" ErrorMessage="Remark Requird" ValidationGroup="ValRequired"></asp:RequiredFieldValidator>
                            </td>
                            <td>
                                <asp:TextBox ID="txtCancelRemark" runat="server" TextMode="MultiLine" Width="40%" MaxLength="45"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="3">
                                <asp:Button ID="btnCancelBill" runat="server" Text="Cancel Eway Bill" OnClick="btnCancelBill_Click" 
                                    ValidationGroup="ValRequired"  OnClientClick="return validateAndConfirm('Sure to Cancel Eway Bill?');" />
                                &nbsp;&nbsp;&nbsp;&nbsp;
