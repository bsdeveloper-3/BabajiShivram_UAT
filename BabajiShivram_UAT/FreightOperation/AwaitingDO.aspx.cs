...
public partial class FreightOperation_AwaitingDO : System.Web.UI.Page
{
    ...
    {
        string strFileName = "Awaiting_DeliveryOrder" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
