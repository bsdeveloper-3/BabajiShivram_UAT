<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="OperationTrack.aspx.cs" 
    Inherits="FreightOperation_OperationTrack" Title="Freight Operation Tracking" Culture="en-GB" %>
...
<asp:ScriptManager runat="server" ID="ScriptManager1"></asp:ScriptManager>
    ...
    <asp:UpdatePanel ID="updateOperation" runat="server" UpdateMode="Conditional" RenderMode="Inline">
        <ContentTemplate>
    <fieldset>
        <legend>Operation Tracking</legend>
        <div class="m clear">
        <div class="fleft">
    ...
    <div>
        <asp:GridView ID="gvFreight" runat="server" DataSourceID="GridViewSqlDataSource" DataKeyNames="EnqId" Width="100%" 
            ...
            CssClass="table" AutoGenerateColumns="False" OnRowCommand="gvFreight_RowCommand">
            <Columns>
		        ...
		        <asp:BoundField DataField="MBLNo" HeaderText="MBL" SortExpression="MBLNo"/>
                ...
                <asp:BoundField DataField="IGMDate" HeaderText="IGM Date" SortExpression="IGMDate" DataFormatString="{0:dd/MM/yyyy}"/>
                <asp:BoundField DataField="PONumber" HeaderText="PO No" SortExpression="PONumber"/>
                <asp:BoundField DataField="Shipper" HeaderText="Shipper" SortExpression="Shipper"/>
                <asp:BoundField DataField="PortOfDischargedName" HeaderText="Port Of Discharge" SortExpression="PortOfDischargedName"/>
		        ...
		        <asp:TemplateField SortExpression="BillingKPI">
                    <HeaderTemplate>
                        <asp:Label ID="lblHdrKPI" Text="Billing KPI" ToolTip="DO Date To Billing Date" runat="server"></asp:Label>
                    </HeaderTemplate>
                    <ItemTemplate>
                        <asp:Label ID="lblViewKPI" runat="Server" Text='<%#Eval("BillingKPI") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="ENQDate" HeaderText="Enquiry Date" SortExpression="ENQDate" DataFormatString="{0:dd/MM/yyyy}"/>
        ...
        <asp:SqlDataSource ID="GridViewSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>" 
            SelectCommand="FOP_GetOperationTracking" SelectCommandType="StoredProcedure" >
            <SelectParameters>
