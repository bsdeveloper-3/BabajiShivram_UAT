...
public partial class FreightOperation_AwaitingAgentInvoice : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DataFilter1.FilterSessionID = "AwaitingAgentInvoice.aspx";
    ...
    {
        string strFileName  =   "Awaiting_AgentInvoice" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
	...
	DataFilter1.FilterSessionID = "AgentInvoice.aspx";
        DataFilter1.FilterDataSource();
        gvFreight.DataBind();
