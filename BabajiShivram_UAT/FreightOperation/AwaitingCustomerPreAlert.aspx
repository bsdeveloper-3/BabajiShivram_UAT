<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AwaitingCustomerPreAlert.aspx.cs" 
    Inherits="FreightOperation_AwaitingCustomerPreAlert" Title="Awaiting Customer PreAlert" Culture="en-GB" %>
...
<asp:ScriptManager runat="server" ID="ScriptManager1"></asp:ScriptManager>
    ...
    <asp:UpdatePanel ID="updateOperation" runat="server" UpdateMode="Conditional" RenderMode="Inline">
        <ContentTemplate>
            <fieldset><legend>Customer Pre-Alert</legend>
            <div class="m clear">
        <div class="fleft">
        ...
        <div class="fleft">
            ...
            <asp:SqlDataSource ID="GridViewSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                SelectCommand="FOP_GetAwaitingCustPreAlert" SelectCommandType="StoredProcedure">
            <SelectParameters>
