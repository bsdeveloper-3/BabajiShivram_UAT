<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AwaitingArrival.aspx.cs" 
    Inherits="FreightOperation_AwaitingArrival" Title="Awaiting Shipment Arrival" Culture="en-GB" %>
...
<asp:ScriptManager runat="server" ID="ScriptManager1"></asp:ScriptManager>
    ...
    <asp:UpdatePanel ID="updateOperation" runat="server" UpdateMode="Conditional" RenderMode="Inline">
        <ContentTemplate>
    <fieldset>
        <legend>Awaiting Cargo Arrival</legend>
        <div class="m clear">
        <div class="fleft">
        ...
        <div class="fleft">
            &nbsp;&nbsp;<span style="color:Teal;">** Aging: ETA Date to Today</span>
        </div>
    </div>
    <div class="clear">
    ...
    <div>
        ...
        <asp:SqlDataSource ID="GridViewSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
            SelectCommand="FOP_GetAwaitingCAN" SelectCommandType="StoredProcedure">
            <SelectParameters>
