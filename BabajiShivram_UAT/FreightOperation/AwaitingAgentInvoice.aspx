<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AwaitingAgentInvoice.aspx.cs" 
    Inherits="FreightOperation_AwaitingAgentInvoice" Title="Awaiting Agent invoice" Culture="en-GB" %>
...
<asp:ScriptManager runat="server" ID="ScriptManager1"></asp:ScriptManager>
    ...
    <asp:UpdatePanel ID="updateOperation" runat="server" UpdateMode="Conditional" RenderMode="Inline">
        <ContentTemplate>
            <fieldset><legend>Awaiting Agent Invoice / Billing</legend>
            <div class="m clear">
        <div class="fleft">
        ...
        <div class="fleft">
            ...
            <Columns>
                ...
                <%--<asp:BoundField DataField="ENQRefNo" HeaderText="Enquiry No"/>--%>
                ...
                <asp:TemplateField SortExpression="Age">
                    <HeaderTemplate>
                        <asp:Label ID="lblHdrAge" Text="Aging" ToolTip="ATA Date To Today" runat="server"></asp:Label>
                    </HeaderTemplate>
                    <ItemTemplate>
                        <asp:Label ID="lblViewAge" runat="Server" Text='<%#Eval("Age") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
		...
		<asp:BoundField DataField="ATADate" HeaderText="ATA" DataFormatString="{0:dd/MM/yyyy}" SortExpression="ATADate"/>
            ...
            <asp:SqlDataSource ID="GridViewSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                SelectCommand="FOP_GetAwaitingAgentInvoice" SelectCommandType="StoredProcedure">
                <SelectParameters>
