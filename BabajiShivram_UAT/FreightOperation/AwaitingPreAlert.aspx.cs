...
using System.IO;
public partial class FreightOperation_AwaitingPreAlert : System.Web.UI.Page
{
    ...
    protected void gvFreight_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName.ToLower() == "navigate")
        {
            ...
            Response.Redirect("AgentPreAlert.aspx");
        }
    }
    ...
    {
        string strFileName = "Awaiting_AgentPreAlert_" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
