...
public partial class FreightOperation_AwaitingArrival : System.Web.UI.Page
{
    ...
    protected void gvFreight_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName.ToLower() == "navigate")
        {
            ...
            Response.Redirect("ArrivalNotice.aspx");
        }
    }
    ...
    {
        string strFileName = "Awaiting_Arrival_Notice" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
