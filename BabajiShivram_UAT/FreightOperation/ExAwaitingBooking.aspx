<%@ Page Title="Awaiting Booking/Shipment Awarded" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeFile="ExAwaitingBooking.aspx.cs" Inherits="FreightOperation_ExAwaitingBooking" Culture="en-GB" %>
...
<asp:ScriptManager runat="server" ID="ScriptManager1"></asp:ScriptManager>
    ...
    <asp:UpdatePanel ID="updateOperation" runat="server" UpdateMode="Conditional" RenderMode="Inline">
        <ContentTemplate>
            <fieldset><legend>Awaiting Booking</legend>
            <div class="m clear">
                <div class="fleft">
            ...
            <div>
                ...
                <Columns>
                    ...
                    <ItemTemplate>
                        <asp:LinkButton ID="lnkViewFreight" runat="Server" Text='<%#Eval("ENQRefNo") %>' CommandName="navigate"
                         CommandArgument='<%#Eval("EnqId")+","+ Eval("lType") %>' CausesValidation="false" ></asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
                    ...
                    <asp:BoundField DataField="FreightType" HeaderText="Type" SortExpression="FreightType"/>
                ...
                <asp:SqlDataSource ID="GridViewSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                    SelectCommand="FOP_GetAwaitingBookingExport" SelectCommandType="StoredProcedure">
                    <SelectParameters>
