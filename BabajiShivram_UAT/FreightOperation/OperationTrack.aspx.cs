...
public partial class FreightOperation_OperationTrack : System.Web.UI.Page
{
    ...
    {
        string strFileName = "Freight_Operation" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
