...
public partial class FreightOperation_AgentPending : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //if(Request.QueryString["Msg"].ToString()!=null)
        //{
        //    string Name = Request.QueryString["Msg"].ToString();
        //    Response.Write(Name);
        //}
        ...
        DataFilter1.FilterSessionID = "AwaitingAgent.aspx";
    ...
    protected void gvFreight_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName.ToLower() == "navigate")
        {
            ...
            Response.Redirect("AgentDetail.aspx");
        }
    }
