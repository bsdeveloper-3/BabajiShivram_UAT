<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AwaitingDO.aspx.cs" 
    Inherits="FreightOperation_AwaitingDO" Title="Awaiting Delivery Order" Culture="en-GB" %>
...
<asp:ScriptManager runat="server" ID="ScriptManager1"></asp:ScriptManager>
    ...
    <ContentTemplate>
        <fieldset><legend>Awaiting Delivery Order</legend>
        <div class="m clear">
        <div class="fleft">
        ...
        <asp:SqlDataSource ID="GridViewSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
            SelectCommand="FOP_GetAwaitingDO" SelectCommandType="StoredProcedure">
            <SelectParameters>
