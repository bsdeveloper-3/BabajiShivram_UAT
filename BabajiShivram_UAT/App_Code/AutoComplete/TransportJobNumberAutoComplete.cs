...
/// <summary>
/// Summary description for TransportJobNumberAutoComplete
/// </summary>
[WebService(Namespace = "http://tempuri.org/")]
[WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1)]
// To allow this Web Service to be called from script, using ASP.NET AJAX, uncomment the following line. 
 [System.Web.Script.Services.ScriptService]
public class TransportJobNumberAutoComplete : System.Web.Services.WebService
{

    public TransportJobNumberAutoComplete()
    {
    ...
    public string[] GetCompletionList(string prefixText, int count, int contextKey)
    {
        ...
        cmd.CommandText = "TR_GetJobDetailByUserId";
