...
/// <summary>
/// Summary description for AccountCodeAutoComplete
/// </summary>
[WebService(Namespace = "http://tempuri.org/")]
[WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1)]
// To allow this Web Service to be called from script, using ASP.NET AJAX, uncomment the following line. 
[System.Web.Script.Services.ScriptService]
public class AccountCodeAutoComplete : System.Web.Services.WebService
{

    public AccountCodeAutoComplete()
    {
    ...
    public string[] GetCompletionList(string prefixText, int count)
    {
        ...
        cmd.CommandText = "SELECT lId,sCode FROM AC_AccountCodeMS WHERE sCode like @myParameter AND bDel=0 ORDER BY sCode";
        ...
        foreach (DataRow row in dt.Rows)
        {
            ...
            ACCodeList.AcCodeName = row["sCode"].ToString();
        ...
        {
            items.Add(AutoCompleteExtender.CreateAutoCompleteItem(c.AcCodeName, serializer.Serialize(c)));
        }
