...
public class LRJobDetailsAutoComplete : System.Web.Services.WebService
{

    public LRJobDetailsAutoComplete()
    {
    ...
    [WebMethod]
    public string[] GetJobRefNoList(string prefixText, int count, int contextKey)
    {
        ...
        cmd.CommandText = "BS_LRGetJobRefNoDetail";
