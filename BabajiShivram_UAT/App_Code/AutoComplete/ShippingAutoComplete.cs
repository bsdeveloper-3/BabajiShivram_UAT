...
/// <summary>
/// Summary description for ShippingAutoComplete
/// </summary>
[WebService(Namespace = "http://tempuri.org/")]
[WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1)]
// To allow this Web Service to be called from script, using ASP.NET AJAX, uncomment the following line. 
 [System.Web.Script.Services.ScriptService]
public class ShippingAutoComplete : System.Web.Services.WebService
{
    public ShippingAutoComplete()
    {
    ...
    public string[] GetCompletionList(string prefixText, int count, int contextKey)
    {
        ...
        cmd.CommandText = "SearchAutoShippingCompany";
        ...
        foreach (DataRow row in dt.Rows)
        {
            ...
            ClientList.ClientId = Convert.ToInt32(row["lid"].ToString());
            ClientList.ClientName = row["CompName"].ToString();
