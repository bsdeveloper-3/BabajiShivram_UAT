...
/// <summary>
/// Summary description for FreightConsigneeAutoComplete
/// </summary>
[WebService(Namespace = "http://tempuri.org/")]
[WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1)]
// To allow this Web Service to be called from script, using ASP.NET AJAX, uncomment the following line. 
 [System.Web.Script.Services.ScriptService]
public class FreightConsigneeAutoComplete : System.Web.Services.WebService {

    public FreightConsigneeAutoComplete () {
    ...
    public string[] GetCompletionList(string prefixText, int count)
    {
        ...
        cmd.CommandText = "select Distinct(Consignee) from FR_EnquiryDetail WHERE Consignee like @myParameter ORDER BY Consignee";
        ...
        foreach (DataRow row in dt.Rows)
        {
            ...
            dbValues = row["Consignee"].ToString();
