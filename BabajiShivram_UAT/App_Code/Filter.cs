...
namespace BSImport.CustomControls
{
            ...
            else
            {
                for (int ii = 0; ii < columnValues.Length; ii++)
                {
                    ...
                    else if (r.IsMatch(columnValues[ii].Trim()))
                    {
                        ...
                        System.Globalization.CultureInfo crrr = System.Globalization.CultureInfo.CreateSpecificCulture("en-US");

                        dt = DateTime.ParseExact(ds, "MM/dd/yyyy", crrr); // Use This For Current Culture "en-GB"
                        columnValue = "#" + dt.ToString("MM/dd/yyyy") + "#";

                        //  dt = DateTime.Parse(ds); // Use This For Current Culture "en-US"
                        //  columnValue = "#" + dt.ToString() + "#";

                        // If Selected Column Operation is "Like" for Date Field, change this to "= Equal Sign"
