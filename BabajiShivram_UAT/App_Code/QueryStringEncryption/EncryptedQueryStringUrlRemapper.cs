...
namespace QueryStringEncryption
{
    ...
    /// </summary>
    public class EncryptedQueryStringUrlRemapper : IHttpModule
    {
        ...
        public void application_AcquireRequestState(object sender, EventArgs e)
        {
            ...
            {
                #region Commented by Sudhir
                //// Decrypt query strings
                //string cryptoKey = WebConfigurationManager.AppSettings["CryptoKey"];
                //string decryptedQueryString = EncryptDecryptQueryString.DecryptQueryStrings(encryptedQueryString, cryptoKey);
                //context.Server.Transfer(context.Request.AppRelativeCurrentExecutionFilePath + "?" + decryptedQueryString); 
                #endregion

                // Decrypt query strings					
                string decryptedQueryString = EncryptDecryptQueryString.DecryptQueryStrings(encryptedQueryString);
                context.Server.Transfer(context.Request.AppRelativeCurrentExecutionFilePath + "?" + decryptedQueryString);
            }
        }
    }
