...
{
  public static class ErrCodeDict
  {
        public static Dictionary<string, string> EwbErrCodes = new Dictionary<string, string>()
    {
      {
        "100",
        "Invalid Json"
      ...
      {
        "366",
        "You will not get the ewaybills generated today, however you can access the ewaybills of yester days"
      },
      {
        "367",
      ...
      {
        "379",
        "Eway Bill cannot be extended.. Already Cancelled"
      },
      {
        "380",
        "Eway Bill Cannot be Extended. Not in Active State"
      },
      {
        "381",
        "There is No PART-B/Vehicle Entry.. So Please Update Vehicle"
      },
      {
        "382",
      ...
      {
        "385",
        "For Rail/Ship/Air transDocNo and transDocDate is mandatory"
      },
      {
        "386",
      ...
      {
        "390",
        "Remaining Distance cannot be greater than Actual Distance"
      },
      {
        "391",
