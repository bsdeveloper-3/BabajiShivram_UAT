...
public class QuotationOperations
{
    ...
    public static void FillBranchByUser(DropDownList DropDown, int UserId)
    {
        ...
        CDatabase.BindControls(DropDown, "CRM_GetBranchByUser", command, "BranchName", "lId");
    }
    ...
    public static int AddDraftQuotation(int BranchId, int EnquiryId, int ServiceId, int CustomerId, string CustomerName, string AddressLine1, string AddressLine2, string AddressLine3, string AttendedPerson, string Subject, Boolean Includebody,
        ...
        int KamId, int SalesPersonId, string SalesPersonName)
    {
        SqlCommand command = new SqlCommand();
        string SPresult = "";
    ...
    public static int UpdateDraftQuotation(int lid, int BranchId, int ServiceId, int CustomerId, string CustomerName, string AddressLine1, string AddressLine2, string AddressLine3, string AttendedPerson, string Subject, Boolean Includebody,
        string PaymentTerms, string BodyContent, Boolean IsValidDraft, string OtherNotes, int UserId, int TermConditionId, int KamId, int SalesPersonId, string SalesPersonName)
    {
        SqlCommand command = new SqlCommand();
        string SPresult = "";
        command.Parameters.Add("@lid", SqlDbType.Int).Value = lid;
    ...
    public static int UpdateQuoteStatus(int QuotationId, int StatusId, string Remarks, DateTime TargetDt, int UserId)
    {
        SqlCommand command = new SqlCommand();
        string SPresult = "";
        command.Parameters.Add("@QuotationId", SqlDbType.Int).Value = QuotationId;
    ...
    public static int UpdateQuotationContractDates(int QuotationId, DateTime ContractStartDt, DateTime ContractEndDt, string ContractCopy, int UserId)
    {
        SqlCommand command = new SqlCommand();
        string SPresult = "";
        command.Parameters.Add("@QuotationId", SqlDbType.Int).Value = QuotationId;
        ...
        if (ContractCopy != "")
            command.Parameters.Add("@ContractCopy", SqlDbType.NVarChar).Value = ContractCopy;
    ...
    public static int AddQuotationTemplate(int BranchId, int ServiceId, int CustomerId, string CustomerName, string AddressLine1, string AddressLine2, string AddressLine3, string AttendedPerson, string Subject, Boolean Includebody,
   string PaymentTerms, string BodyContent, Boolean IsValidDraft, Boolean IsTenderQuote, Boolean IsLumpSumCode, string OtherNotes, int UserId, int TermConditionId, string TemplateFor)
    {
        SqlCommand command = new SqlCommand();
        string SPresult = "";
        command.Parameters.Add("@BranchId", SqlDbType.Int).Value = BranchId;
        ...
        command.Parameters.Add("@IsLumpSumCode", SqlDbType.Bit).Value = IsLumpSumCode;
        command.Parameters.Add("@TermConditionId", SqlDbType.Int).Value = TermConditionId;
        command.Parameters.Add("@TemplateFor", SqlDbType.NVarChar).Value = TemplateFor;
        command.Parameters.Add("@lUser", SqlDbType.Int).Value = UserId;
        command.Parameters.Add("@OutPut", SqlDbType.Int).Direction = ParameterDirection.Output;

        SPresult = CDatabase.GetSPOutPut("BS_insQuotationTemplate", command, "@OutPut");
        return Convert.ToInt32(SPresult);
    }

    /******************* Added ON : 13-02-2018 *****************************************************************************************/
    public static DataSet GetLeadAsPerLid(int Lid)
    {
        SqlCommand command = new SqlCommand();
        command.Parameters.Add("@lid", SqlDbType.Int).Value = Lid;
    ...
    public static int MailQuoteForApproval(int QuotationId)
    {
        SqlCommand command = new SqlCommand();
        string SPresult = "";
        command.Parameters.Add("@QuotationId", SqlDbType.Int).Value = QuotationId;
        ...
        SPresult = CDatabase.GetSPOutPut("CRM_mailQuoteForApproval", command, "@OutPut");
        return Convert.ToInt32(SPresult);
    }
