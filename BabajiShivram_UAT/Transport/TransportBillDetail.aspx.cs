...
public partial class Transport_TransportBillDetail : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("ViewTransporterBill.aspx");
        }
        ...
        if (hdnTransBillId.Value != "" && hdnTransBillId.Value != "0")
        {
            ...
            if (BillId > 0)
            {
                ...
                if (result == 0)
                {
                    ...
                    if (ddlStatus.SelectedValue == "5") // bill on hold
                    {
                        bool Success = SendMail(BillId, txtHoldReason.Text.Trim());
                        if (Success == true)
                        {
                            lblError.Text = "Successfully holded bill! Mail has been sent to transport dept for the same.";
                            lblError.CssClass = "success";
                        }
                        else
                        {
