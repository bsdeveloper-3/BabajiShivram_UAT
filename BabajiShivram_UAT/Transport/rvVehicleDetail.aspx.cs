...
public partial class Transport_rvVehicleDetail : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        int result = -123, JobId = 0, ExpenseTypeId = 11, BranchId = 0, PaymentTypeId = 0, count = 1, Isready = 0;
    ...
    //                        if (dcFreightRate > 0)
    //                        {
    //                            dcFreightRate = dcFreightRate + Convert.ToDecimal(row.Cells[14].Text.Trim());
    //                        }
    //                        else
    //                        {
    //                            dcFreightRate = Convert.ToDecimal(row.Cells[14].Text.Trim());
    //                        }

    //                        if (dcAmount > 0)
    //                        {
    //                            dcAmount = dcAmount + Convert.ToDecimal(row.Cells[16].Text.Trim());
    //                        }
    //                        else
    //                        {
    //                            dcAmount = Convert.ToDecimal(row.Cells[16].Text.Trim());
    //                        }
