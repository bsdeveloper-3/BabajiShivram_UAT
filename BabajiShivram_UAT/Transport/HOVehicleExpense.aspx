<%@ Page Title="HO Vehicle Expense" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeFile="HOVehicleExpense.aspx.cs" Inherits="Transport_HOVehicleExpense" EnableEventValidation="false" Culture="en-GB" %>
            ...
            <ContentTemplate>
                ...
                <div>
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="ExpenseDesc" HeaderText="Description To" ReadOnly="true" Visible="false" />
                        <asp:TemplateField HeaderText="Description" SortExpression="ExpenseDesc">
                            <ItemTemplate>
                                <asp:Label ID="lblExpenseDesc" Text='<%#BIND("ShortExpenseDesc") %>' runat="server" ></asp:Label>
                        ...
                        <asp:TemplateField HeaderText="Paid To" SortExpression="PaidTo">
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="txtPaidTo" Text='<%#BIND("PaidTo") %>' runat="server" Width="100px"></asp:TextBox>
                            </EditItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Support Bill Paid To" SortExpression="SupportBillPaidTo">
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="txtSupportBillPaidTo" Text='<%#BIND("SupportBillPaidTo") %>' runat="server" Width="100px"></asp:TextBox>
                            </EditItemTemplate>
                        </asp:TemplateField>
