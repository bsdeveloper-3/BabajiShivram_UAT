<%@ Page Title="Delivery Detail" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
        CodeFile="TransDeliveryDetail.aspx.cs" Inherits="Transport_TransDeliveryDetail" %>
        ...
        <ContentTemplate>
            ...
            <cc1:TabContainer ID="TabJobDetail" runat="server" ActiveTabIndex="0" CssClass="Tab"
                ...
                <cc1:TabPanel ID="Tab1" runat="server" HeaderText="Job Detail">
                    <ContentTemplate>
                        <div>
                            <cc1:CalendarExtender ID="CalExamineDate" runat="server" Enabled="false" EnableViewState="False"
                            ...
                            <cc1:CalendarExtender ID="CalOutOfChargeDate" runat="server" Enabled="false" EnableViewState="False"
                                FirstDayOfWeek="Sunday" Format="dd/MM/yyyy" PopupButtonID="imgOutOfChargeDt"
                                PopupPosition="BottomRight" TargetControlID="txtOutOfChargeDate">
                            </cc1:CalendarExtender>
                        </div>
                        <fieldset>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="white">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="lblDeliveryInstruction" runat="server"></asp:Label>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="lblTranportBy" runat="server"></asp:Label>
                                    </td>
                                </tr>
                                ...
                                <div class="m clear">
                                    <asp:Button ID="btnSaveOutOfCharge" Text="Save Out of Charge / Examine" runat="server" OnClick="btnSaveOutOfCharge_Click" Enabled="false" />
                                    &nbsp;&nbsp;<asp:Button ID="btnCancel2" Text="Cancel" CausesValidation="false" OnClick="btnCancel_OnClick"
    runat="server" TabIndex="16" />
                                </div>
                                <tr>
                                    <td>Examine Date
                                        <asp:CompareValidator ID="ComValExamineDate" runat="server" ControlToValidate="txtExamineDate"
                                            Display="Dynamic" Text="Invalid Date" ErrorMessage="Invalid Examine Date" SetFocusOnError="true"
                                            Type="Date" CultureInvariantValues="false" Operator="DataTypeCheck" ValidationGroup="Required"></asp:CompareValidator>
                                        <asp:RequiredFieldValidator ID="RFVExamineDate" runat="server" ControlToValidate="txtExamineDate"
                                            SetFocusOnError="true" Text="*" ErrorMessage="Please Enter Examine Date" ValidationGroup="Required"></asp:RequiredFieldValidator>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtExamineDate" runat="server" Width="100px" TabIndex="14" AutoPostBack="true"
                                        ...
                                        <cc1:MaskedEditExtender ID="MEditExtExaminDate" TargetControlID="txtExamineDate"
                                            Mask="99/99/9999" MessageValidatorTip="true" MaskType="Date" AutoComplete="false"
                                            runat="server">
                                        </cc1:MaskedEditExtender>
                                        <cc1:MaskedEditValidator ID="MEditValExaminDate" ControlExtender="MEditExtExaminDate"
                                            ControlToValidate="txtExamineDate" IsValidEmpty="false" InvalidValueMessage="Examine Date is invalid"
                                            SetFocusOnError="true" MinimumValueMessage="Invalid Date" MaximumValueMessage="Invalid Date"
                                            MinimumValue="01/01/2016" MaximumValue="31/12/2025" runat="Server" ValidationGroup="Required"></cc1:MaskedEditValidator>
                                    </td>
                                    <td>Out Of Charge Date
                                        <asp:CompareValidator ID="ComValOutOfCharge" runat="server" ControlToValidate="txtOutOfChargeDate"
                                            Display="Dynamic" ErrorMessage="Invalid Out Of Charge Date." Text="Invalid Date"
                                            SetFocusOnError="false" Type="Date" CultureInvariantValues="false" Operator="DataTypeCheck"
                                            ValidationGroup="Required"></asp:CompareValidator>
                                        <asp:RequiredFieldValidator ID="RFVOutOfCharge" runat="server" ControlToValidate="txtOutOfChargeDate"
                                            SetFocusOnError="true" Text="*" ErrorMessage="Please Enter Out Of Charge Date"
                                            ValidationGroup="Required"></asp:RequiredFieldValidator>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtOutOfChargeDate" runat="server" Width="100px" Enabled="false" placeholder="dd/mm/yyyy"></asp:TextBox>
                                        <asp:Image ID="imgOutOfChargeDt" ImageAlign="Top" ImageUrl="../Images/btn_calendar.gif"
                                            Enabled="false" runat="server" />
                                        <cc1:MaskedEditExtender ID="MEditExtOutDate" TargetControlID="txtOutOfChargeDate"
                                            Mask="99/99/9999" MessageValidatorTip="true" MaskType="Date" AutoComplete="false"
                                            runat="server">
                                        </cc1:MaskedEditExtender>
                                        <cc1:MaskedEditValidator ID="MEditValOutDate" ControlExtender="MEditExtOutDate" ControlToValidate="txtOutOfChargeDate"
                                            IsValidEmpty="false" InvalidValueMessage="Out Of Charge Date is invalid" SetFocusOnError="true"
                                            MinimumValueMessage="Invalid Date" MaximumValueMessage="Invalid Date" MinimumValue="01/01/2016"
                                            MaximumValue="31/12/2025" runat="Server" ValidationGroup="Required"></cc1:MaskedEditValidator>
                                    </td>
                                </tr>
                            </table>
                        </fieldset>
                        ...
                        <fieldset>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="white">
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddTransitType" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddTransitType_SelectedIndexChanged"
                                            TabIndex="1">
                                        ...
                                        <asp:DropDownList ID="ddWarehouse" runat="server" Visible="false" TabIndex="2">
                                        </asp:DropDownList>
                                ...
                                <tr>
                                    <td>Vehicle No & Type
                                        <%--<asp:RegularExpressionValidator ID="RegExVehicleNo" runat="server" ControlToValidate="txtVehicleNo"
                                            ValidationGroup="Required" Text="Invalid No" Display="Dynamic" SetFocusOnError="true"
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtVehicleNo" runat="server" MaxLength="13" Width="100px" TabIndex="4" style="text-transform: uppercase"></asp:TextBox>&nbsp;
