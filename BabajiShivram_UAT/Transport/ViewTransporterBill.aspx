<%@ Page Title="View Transport Bill" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ViewTransporterBill.aspx.cs" Inherits="Transport_ViewTransporterBill"
    Culture="en-GB" %>
                    ...
                    <ContentTemplate>
                        <div style="overflow: auto;">
                            ...
                            <div class="m clear">
                                ...
                                <asp:LinkButton ID="lnkExport" runat="server" OnClick="lnkExport_Click"><asp:Image ID="Image2" runat="server" ImageUrl="../images/Excel.jpg" ToolTip="Export To Excel" /></asp:LinkButton>
                            </div>
                            <div class="clear"></div>
                            <asp:GridView ID="gvNonReceiveBill" runat="server" AutoGenerateColumns="False" CssClass="table"
                                Width="100%" DataKeyNames="TransBillId"
                                DataSourceID="DataSourceBillNonReceive" CellPadding="4" AllowPaging="True" AllowSorting="True" PageSize="20">
