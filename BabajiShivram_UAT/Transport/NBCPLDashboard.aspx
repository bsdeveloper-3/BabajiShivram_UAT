<%@ Page Title="NBCPL Transport" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeFile="NBCPLDashboard.aspx.cs" Inherits="Transport_NBCPLDashboard" EnableEventValidation="false" Culture="en-GB"%>
...
<asp:ScriptManager runat="server" ID="ScriptManager1" />
   <div style="float:left; width:70%;">
       ...
       <div id="divCategory">
           <fieldset><legend>Maintenance Category Summary</legend>
           <div>
               ...
               <asp:GridView ID="gvCategoryMonth" runat="server" CssClass="table" DataSourceID="DataSourceCategory" 
       ...
       <div id="div1">
       <fieldset><legend>Maintenance Vehicle Summary</legend>
       ...
       <div style="overflow:scroll; height:400px;">
           <asp:GridView ID="gvVehicleMonth" runat="server" CssClass="table" DataSourceID="DataSourceVehicle" 
               Width="99%" AutoGenerateColumns="true">
               <Columns>
                   <asp:TemplateField HeaderText="Sl">
                       <ItemTemplate>
