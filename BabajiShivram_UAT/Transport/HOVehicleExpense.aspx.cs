...
public partial class Transport_HOVehicleExpense : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DataFilter1.FilterSessionID = "HOVehicleExpense.aspx";
        DataFilter1.OnDataBound += new DynamicData_Content_DataFilter.BindDataGridView(DataFilter1_OnDataBound);
    }

    protected void btnNewWork_Click(object sender, EventArgs e)
    {
        Response.Redirect("HOVehicleMaintenance.aspx");
    }
    ...
    protected void gvMaintenance_RowCommand(Object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName.ToLower() == "select")
        {
            ...
            Response.Redirect("HOEditMaintenance.aspx");
        }
    }
    ...
    protected void btnPrintVoucher_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                MaintenanceId = Convert.ToInt32(txtRefNo.Text.Replace("MT", ""));
                GenerateVoucherPDF(MaintenanceId);
            }
            else
            {
    ...
    private void GenerateVoucherPDF(int MaintenanceId)
    {
        ...
        if (dsApprovedExpense.Tables[0].Rows.Count > 0)
        {
            ...
            try
            {
                ...
                float[] widths = new float[] { 0.08f, 0.3f, 0.7f, 0.2f };
                ...
                /************* Vehicle Daily Status Detail ******************************************/

                // Get Vehicle Vehicle Status
    ...
    private void ExportFunction(string header, string contentType)
    {
        ...
        // Description
        gvMaintenance.Columns[13].Visible = true;
        gvMaintenance.Columns[14].Visible = false;
