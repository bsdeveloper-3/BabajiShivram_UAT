<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RequestReceived.aspx.cs" Inherits="Transport_RequestReceived"
    ...
    <asp:UpdatePanel ID="upnlRequestRecd" runat="server">
        <ContentTemplate>
                    ...
                    <ContentTemplate>
                        <div style="overflow: auto;">
                            ...
                            <div class="m clear">
                                ...
                                <asp:Button ID="btnVehiclePlace" runat="server" Text="Vehicle Placed" OnClick="btnVehiclePlace_Click" />
                            ...
                            <asp:GridView ID="gvJobDetail" runat="server" AutoGenerateColumns="False" CssClass="table" DataKeyNames="lId"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Ref No" SortExpression="JobRefNo">
                                        <ItemTemplate>
                                          <asp:HiddenField ID="hdnContainerNo" runat="server" Value='<%#Eval("ContainerNo") %>' />
                                          <asp:LinkButton ID="lnkRefNo" CommandName="select" runat="server" Text='<%#Eval("TRRefNo") %>'
                                                CommandArgument='<%#Eval("lId") + ";" + Eval("JobTypeId")%>' Font-Bold="true" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:BoundField DataField="VehiclePlaced" HeaderText="Vehicle Placed"/>
                                    ...
                                    <asp:BoundField DataField="BOETYPE" HeaderText="BOE TYPE" SortExpression="BOETYPE" />
                                    ...
                                    <asp:BoundField DataField="DeliveryType" HeaderText="Type" SortExpression="DeliveryType" />
                                     <asp:BoundField DataField="PickupPincode" HeaderText="PickUp Pincode" SortExpression="PickupPincode" />
                                    <asp:BoundField DataField="PickupCity" HeaderText="PickUp City" SortExpression="PickupCity" />
                                    <asp:BoundField DataField="PickupState" HeaderText="PickUp State" SortExpression="PickupState" />
                                    <asp:BoundField DataField="DropPincode" HeaderText="Drop Pincode" SortExpression="DropPincode" />
                                    <asp:BoundField DataField="DropCity" HeaderText="Drop City" SortExpression="DropCity" />
                                    <asp:BoundField DataField="DropState" HeaderText="Drop State" SortExpression="DropState" />
                                    <asp:BoundField HeaderText="Delivery planning" />
                                    <%--<asp:BoundField DataField="RequestDate" HeaderText="Request Date" SortExpression="RequestDate" DataFormatString="{0:dd/MM/yyyy}" />--%>
                                    <asp:BoundField DataField="dtDate" HeaderText="Request Date" SortExpression="dtDate" DataFormatString="{0:dd/MM/yyyy hh:mm tt}" />
                    ...
                    <ContentTemplate>
                        <div style="overflow: auto;">
                            ...
                            <asp:GridView ID="gvConsolidateJobDetail" runat="server" AutoGenerateColumns="False" CssClass="table"
                                ...
                                CellPadding="4" AllowPaging="True" AllowSorting="True" PageSize="20" DataSourceID="DataSourceConsolidateVehicle"
            ...
            <div>
                ...
                <asp:SqlDataSource ID="TruckRequestSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>" EnableCaching="true" CacheDuration="600"
                    SelectCommand="TR_GetTruckRequestPending" SelectCommandType="StoredProcedure">
                    <SelectParameters>
                        <asp:SessionParameter Name="UserId" SessionField="UserId" />
                        <asp:SessionParameter Name="FinYearId" SessionField="FinYearId" />
                        <asp:SessionParameter Name="ModuleID" SessionField="MID" DefaultValue="0" />
                    </SelectParameters>
                </asp:SqlDataSource>
                <asp:SqlDataSource ID="DataSourceConsolidateVehicle" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                    ...
                    SelectCommand="TR_GetConsolidateRequestPending" SelectCommandType="StoredProcedure">
                    <SelectParameters>
                        <asp:SessionParameter Name="UserId" SessionField="UserId" />
                        <asp:SessionParameter Name="FinYearId" SessionField="FinYearId" />
                        <asp:SessionParameter Name="ModuleID" SessionField="MID" DefaultValue="0" />
            ...
            <%--MODAL POPUP FOR CONSOLIDATE JOBS--%>
             ...
             <%--MODAL POPUP FOR VEHICLE PLACED--%>
            <div>
                <asp:HiddenField ID="hdnVehiclePlaced" runat="server" />
                <ajaxtoolkit:modalpopupextender id="mpeVehiclePlaced" runat="server" targetcontrolid="hdnVehiclePlaced" backgroundcssclass="modalBackground"
                    popupcontrolid="pnlhdnVehiclePlaced" dropshadow="true">
                </ajaxtoolkit:modalpopupextender>
                <asp:Panel ID="pnlhdnVehiclePlaced" runat="server" CssClass="modalPopup1" BackColor="#F5F5DC" Width="400px" Height="165px" Style="border: 1px solid #cccc; border-radius: 5px">
                    <div id="div1" runat="server">
                        <table width="100%">
                            ...
                            <tr>
                                <td align="center">
                                    <b><u>Vehicle Placed</u></b>
                                    <span style="float: right">
                                        <asp:ImageButton ID="ImageButton1" ImageUrl="~/Images/delete.gif" runat="server" OnClick="imgbtnClose_Click" ToolTip="Close" />
                                    </span>
                                </td>
                            </tr>
                            <tr>
                        ...
                        <asp:Panel ID="Panel2" runat="server" Width="400px" Height="165px" Style="padding: 3px">
                            <table border="0" cellpadding="0" cellspacing="0" width="99%" bgcolor="white">
                                <tr>
                                    <td>No Of vehicle
                                        &nbsp;&nbsp;&nbsp;
                                        <asp:TextBox ID="txtNoOfVehicle" runat="server"></asp:TextBox>
                                        &nbsp;&nbsp;&nbsp;
                                    </td>
                                </tr>
                                <tr>
                                    <td>Transporter
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                         <asp:DropDownList ID="ddtransporterName" runat="server" AppendDataBoundItems="true" Width="200px">
                                            <asp:ListItem Text="-Select transporter name" Value="0" Selected="True"></asp:ListItem>
                                        </asp:DropDownList>
                                        &nbsp;&nbsp;&nbsp;
                                    </td>
                                ...
                                <tr>
                                    <td>
                                         <asp:Button ID="btnAddVehiclePlaced" runat="server" Text="Save" OnClick="btnAddVehiclePlaced_Click" />
                                    </td>
                                </tr>
                            </table>
                            <asp:GridView ID="GridView1" runat="server" CssClass="table" AutoGenerateColumns="false" Width="99%" Style="white-space: normal; border: 1px solid #cccc; border-radius: 3px">
                                <Columns>
                                    <asp:TemplateField HeaderText="Sl">
                                        <ItemTemplate>
                                            <asp:Label ID="lblRowNumber" runat="server"></asp:Label>
