<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="VehiclePlaced.aspx.cs" Inherits="Transport_VehiclePlaced"
        ...
        <ContentTemplate>
                        ...
                        <div style="overflow: auto;">
                            ...
                            <asp:GridView ID="gvJobDetail" runat="server" AutoGenerateColumns="False" CssClass="table" DataKeyNames="lId"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="PickupCity" HeaderText="PickUp City" SortExpression="PickupCity" />                <%-- Pickup And Drop City and State--%>
                ...
                <AjaxToolkit:TabPanel ID="TabPanelConsolidateJob" runat="server" TabIndex="1" HeaderText="Consolidate Job Detail">
                    <ContentTemplate>
                        <div style="overflow: auto;">
                            ...
                            <div class="m clear"></div> <%--DataSourceID="DataSourceConsolidateVehicle"--%>
            ...
            <div>
                ...
                <asp:SqlDataSource ID="TruckRequestSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                    SelectCommand="TR_GetVehiclePlaced" SelectCommandType="StoredProcedure">
                    <SelectParameters>
                        <asp:SessionParameter Name="UserId" SessionField="UserId" />
                        <asp:SessionParameter Name="FinYearId" SessionField="FinYearId" />
                    </SelectParameters>
                ...
                <asp:SqlDataSource ID="DataSourceConsolidateVehicle" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                    ...
                    SelectCommand="TR_GetConsolidateVehiclePlaced" SelectCommandType="StoredProcedure">
                    <SelectParameters>
                        <asp:SessionParameter Name="UserId" SessionField="UserId" />
                        <asp:SessionParameter Name="FinYearId" SessionField="FinYearId" />
                    </SelectParameters>
