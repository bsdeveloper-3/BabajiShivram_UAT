...
using System.IO;
using System.Text;
public partial class Transport_EditMaintenance : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            DBOperations.FillTransportVehicle(ddVehicleNo);
            DBOperations.FillMaintenanceCategory(ddCategory, 1); // Transport Maintenance
        }
    }
    ...
    protected void btnSaveVehicle_Click(object sender, EventArgs e)
    {
        ...
        {
            int MaintainId  = Convert.ToInt32(Session["TrMaintainId"]);
            int VehicleID   = Convert.ToInt32(ddVehicleNo.SelectedValue);
            ...
            {
                gvCategory.DataBind();
                lblError.Text        = "Vehicle/Category Details Added Successfully";
                lblError.CssClass    = "success";
            }
            else if (result == 1)
            {
            ...
            {
                lblError.Text = "Vehicle/Category Details Aleardy Added";
                lblError.CssClass = "errorMsg";
            }
