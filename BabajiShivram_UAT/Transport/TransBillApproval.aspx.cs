...
public partial class Transport_TransBillApproval : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            DataFilter1.DataSource = DataSourceBillApprovalPending;
            DataFilter1.DataColumns = gvTransportBillApproval.Columns;
            DataFilter1.FilterSessionID = "TransBillApproval.aspx";
            DataFilter1.OnDataBound += new DynamicData_Content_DataFilter.BindDataGridView(DataFilter1_OnDataBound);

            DataFilter2.DataSource = DataSourceConsolidateBillApprovalPending;
    ...
    protected void gvTransportBillApproval_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName.ToLower().Trim() == "select")
        {
            ...
            Response.Redirect("ApproveBill.aspx");
        }
    }
