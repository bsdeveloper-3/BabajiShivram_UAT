<%@ Page Title="Bill Rejected" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="TransBillRejected.aspx.cs"
    Inherits="Transport_TransBillRejected" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="upnlBillApprvl" runat="server" UpdateMode="Conditional" RenderMode="Inline">
        <ContentTemplate>
                    ...
                    <ContentTemplate>
                        <div style="overflow: auto;">
                            ...
                            <asp:GridView ID="gvTransportBillApproval" runat="server" AutoGenerateColumns="False" CssClass="table"
                                ...
                                DataSourceID="DataSourceBillRejectedPending" CellPadding="4" AllowPaging="True" AllowSorting="True" PageSize="20"
                    ...
                    <ContentTemplate>
                        <div style="overflow: auto;">
                            ...
                            <asp:GridView ID="gvConsolidateBillApproval" runat="server" AutoGenerateColumns="False" CssClass="table"
                                Width="1500px" AlternatingRowStyle-CssClass="alt" PagerStyle-CssClass="pgr" DataKeyNames="lid"
                                DataSourceID="DataSourceConsolidateBillRejectedPending" CellPadding="4" AllowPaging="True" AllowSorting="True" PageSize="20"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Ref No" SortExpression="TRRefNo" ItemStyle-Width="80px">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkSelect" CommandName="select" runat="server" Text='<%# Bind("TRRefNo")%>' CommandArgument='<%#Eval("lid") + ";" + Eval("TransReqId") + ";" + Eval("TransBillId")%>'
                                                ToolTip="Click To Update Bill Detail"></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:BoundField HeaderText="Ref No" DataField="TRRefNo" Visible="false" />
            ...
            <div>
                <asp:SqlDataSource ID="DataSourceBillRejectedPending" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                    SelectCommand="TR_GetBillRejected" SelectCommandType="StoredProcedure">
                    <SelectParameters>
                        <asp:SessionParameter Name="UserId" SessionField="UserId" />
                        <asp:SessionParameter Name="FinYearId" SessionField="FinYearId" />
                    </SelectParameters>
                </asp:SqlDataSource>
                <asp:SqlDataSource ID="DataSourceConsolidateBillRejectedPending" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                    SelectCommand="TR_GetConsolidateBillRejected" SelectCommandType="StoredProcedure">
                    <SelectParameters>
                        <asp:SessionParameter Name="UserId" SessionField="UserId" />
                        <asp:SessionParameter Name="FinYearId" SessionField="FinYearId" />
                    </SelectParameters>
