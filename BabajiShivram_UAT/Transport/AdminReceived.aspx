<%@ Page Title="Transport Request Received" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AdminReceived.aspx.cs"
    Inherits="Transport_AdminReceived" %>
        ...
        <ContentTemplate>
                    ...
                    <ContentTemplate>
                        <div style="overflow: auto;">
                            ...
                            <div class="m clear">
                                ...
                                <asp:Button ID="btnRemoveJobs" runat="server" OnClick="btnRemoveJobs_Click" Text="Remove Jobs" />
                            ...
                            <asp:GridView ID="gvJobDetail" runat="server" AutoGenerateColumns="False" CssClass="table" DataKeyNames="lId"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Remove">
                                        <ItemTemplate>
                                            <asp:CheckBox ID="chkRemove" runat="server" CausesValidation="false" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                            ...
                            <div class="m clear">
                                <asp:Panel ID="pnlFilter2" runat="server">
                                    ...
                                    <div class="fleft" style="margin-left: 30px; padding-top: 3px;">
                                        <asp:Button ID="btnRemoveConsolidate" runat="server" OnClick="btnRemoveConsolidate_Click" Text="Remove Jobs" />
            ...
            <div>
                ...
                <asp:SqlDataSource ID="TruckRequestSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                    SelectCommand="TR_GetTruckRequest" SelectCommandType="StoredProcedure">
                    <SelectParameters>
                        <asp:SessionParameter Name="UserId" SessionField="UserId" />
                        <asp:SessionParameter Name="FinYearId" SessionField="FinYearId" />
                    </SelectParameters>
