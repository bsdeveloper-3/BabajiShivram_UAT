...
public partial class Transport_VesselExpense : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblTitle.Text = "Vessel Maintenance Expense";
        //
        if (!IsPostBack)
        {
        ...
        DataFilter1.FilterSessionID = "VesselExpense.aspx";
    ...
    protected void gvMaintenance_RowCommand(Object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName.ToLower() == "select")
        {
            ...
            Response.Redirect("EditVesselMaintenance.aspx");
        }
    }
    ...
    private void GenerateVoucherPDFSingle(int MaintenanceId, DataSet dsApprovedExpense)
    {
        ...
        if (dsApprovedExpense.Tables[0].Rows.Count > 0)
        {
            ...
            try
            {
                ...
                string contents = "";
                contents = File.ReadAllText(Server.MapPath("PrintVoucherVessel.htm"));
                ...
                contents = contents.Replace("[VesselNo]", VehicleNo);
                ...
                #region Add Vessel Expense History
    ...
    protected void SqlDataSourceExp_Updated(object sender, SqlDataSourceStatusEventArgs e)
    {
        ...
        else
        {
            ...
            {
                lblError.Text = "Maintenance Category Already Exists For Vessel!";
                lblError.CssClass = "errorMsg";
            }
            else if (Result == 3)
            {
    ...
    {
        string strFileName = "Vessel_Expense_" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
    ...
    private void ExportFunction(string header, string contentType)
    {
        ...
        gvMaintenance.Caption = "Vessel Expense Details - " + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt");
