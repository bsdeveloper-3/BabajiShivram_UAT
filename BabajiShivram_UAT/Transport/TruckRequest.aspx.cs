...
public partial class Transport_TruckRequest : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        if (hdnJobId.Value != "" && hdnJobId.Value != "0")
        {
            ...
            result = DBOperations.AddJobTransportRequest(Convert.ToInt32(hdnJobId.Value), Convert.ToInt32(hdnCustId.Value), txtJobNumber.Text.Trim(), DateTime.Now, 1, lblPort.Text.Trim(), txtDeliveryDestination.Text.Trim(),
                                ...
                                dtVehiclePlaceRequireDate, VehicleRequired, loggedInUser.glUserId);

            results = DBOperations.AddTransAddDetails(Convert.ToInt32(hdnJobId.Value), result, FileName, EmptyDocPath + "\\", 122, PickupAdd, Pincode1, PickState, PickupCity, DropAdd, Pincode2, DropState, DropCity, EmptyLetter,DeliveryType, loggedInUser.glUserId);
    ...
    //protected void txtPincode1_TextChanged(object sender, EventArgs e)
    //{                                                                                   //STATE AND CITY GETING FROM DATABASE BY USING PINCODE
    ...
    //protected void txtPincode2_TextChanged(object sender, EventArgs e)    //STATE AND CITY FROM DATABASE BY USING PINCODE
    //{
