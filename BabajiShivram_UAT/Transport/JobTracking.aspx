<%@ Page Title="Transport Job Tracking" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="JobTracking.aspx.cs"
    Inherits="Transport_JobTracking" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="upnlJobTracking" runat="server" UpdateMode="Conditional" RenderMode="Inline">
        <ContentTemplate>
            ...
            <fieldset>
                <legend>Transport Job Tracking</legend>
                <div class="m clear">
                ...
                <asp:GridView ID="gvJobDetail" runat="server" AutoGenerateColumns="False" CssClass="table"
                    ...
                    DataSourceID="DataSourceJobTracking" CellPadding="4" AllowPaging="True" AllowSorting="True" PageSize="20"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Ref No" SortExpression="TRRefNo" ItemStyle-Width="80px">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkSelect" CommandName="select" runat="server" Text='<%# Bind("TRRefNo")%>' CommandArgument='<%#Eval("lid") %>'
            ...
            <div>
                <asp:SqlDataSource ID="DataSourceJobTracking" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                    SelectCommand="TR_GetJobDetailForNewTransport" SelectCommandType="StoredProcedure">
                    <SelectParameters>
