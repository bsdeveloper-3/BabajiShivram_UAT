<%@ Page Title="Consolidate Transport Request" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ConsolidateRequest.aspx.cs"
    Inherits="Transport_ConsolidateRequest" %>
                    ...
                    <asp:GridView ID="gvRateDetail" runat="server" AutoGenerateColumns="False" Width="100%" PagerStyle-CssClass="pgr"
                        ...
                        <Columns>
                           ...
                           <%--<asp:TemplateField ShowHeader="False" Visible="false">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lnkEdit1" CommandName="Edit" runat="server" Text="Edit1" CommandArgument='<%#Bind("lid") %>'
                                        ToolTip="Click To Update Rate Detail."></asp:LinkButton>
                                    <asp:LinkButton ID="lnkDelete1" CommandName="DeleteRow" runat="server" Text="Delete1" CommandArgument='<%#Bind("lid") %>'
                                        ToolTip="Click To Delete Rate Detail."></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>--%>
