<%@ Page Title="Transport Bill Detail" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="TransportBillDetail.aspx.cs"
    Inherits="Transport_TransportBillDetail" MaintainScrollPositionOnPostback="true" Culture="en-GB" %>
        ...
        <div>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="99%" bgcolor="white">
                ...
                <tr>
                    <td>Cheque Date
                        ...
                        <cc1:MaskedEditValidator ID="mevChequeDate" ControlExtender="meeChequeDate" ControlToValidate="txtChequeDate" IsValidEmpty="true"
                            ...
                            MaximumValueMessage="Invalid Date" MinimumValue="01/01/2015" runat="Server" ValidationGroup="ReqStatus"></cc1:MaskedEditValidator>
                    </td>
                    <td>
                    ...
                    <td>Release Date
                        <cc1:CalendarExtender ID="calReleaseDate" runat="server" FirstDayOfWeek="Sunday" PopupButtonID="imgReleaseDate"
                            Format="dd/MM/yyyy" PopupPosition="BottomRight" TargetControlID="txtReleaseDate">
                        </cc1:CalendarExtender>
                        <cc1:MaskedEditExtender ID="meeReleaseDate" TargetControlID="txtReleaseDate" Mask="99/99/9999" MessageValidatorTip="true"
                            MaskType="Date" AutoComplete="false" runat="server">
                        </cc1:MaskedEditExtender>
                        <cc1:MaskedEditValidator ID="mevReleaseDate" ControlExtender="meeReleaseDate" ControlToValidate="txtReleaseDate" IsValidEmpty="true"
                            ...
                            MaximumValueMessage="Invalid Date" runat="Server" ValidationGroup="ReqStatus"></cc1:MaskedEditValidator>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <asp:TextBox ID="txtHoldReason" runat="server" TabIndex="4" Width="900px" TextMode="MultiLine" Rows="2"></asp:TextBox>
                    </td>
                </tr>
            </table>
        </div>
