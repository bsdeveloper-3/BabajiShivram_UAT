<%@ Page Title="Vehicle Detail" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ViewVehicle.aspx.cs" Inherits="Transport_ViewVehicle" %>
        ...
        <ContentTemplate>
            ...
            <div>
                <fieldset>
                    ...
                    <asp:Button ID="btnFundRequest" Visible="false" runat="server" Text="Send Fund Request" OnClick="btnFundRequest_Click" />
                ...
                <fieldset style="visibility: hidden">
                    ...
                    <div class="m clear">
                        ...
                        <asp:Button ID="btnSaveRate" runat="server" Text="Save" OnClick="btnSaveRate_Click" ValidationGroup="vgRequired" TabIndex="15" />
                        <asp:Button ID="btnCancelRate" runat="server" Text="Cancel" OnClick="btnCancelRate_Click" CausesValidation="false" TabIndex="16" />
                    ...
                    <table class="table" border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="white">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:FileUpload ID="fuMemoDocument" runat="server" TabIndex="7" Width="160px" />
                            </td>
                        </tr>
                        <tr>
                            <td>Freight Rate
                            ...
                            <td>
                                <asp:TextBox ID="txtRate" runat="server" TabIndex="4" Width="160px" AutoPostBack="true" OnTextChanged="txtRate_TextChanged"></asp:TextBox>
                            </td>
                            <td>Advance (%)
                            ...
                            <td>
                                <asp:TextBox ID="txtAdvance" runat="server" TabIndex="5" Width="160px" AutoPostBack="true" OnTextChanged="txtAdvance_TextChanged"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>Advance Amount</td>
                            <td>
                                <asp:TextBox ID="txtAdvanceAmount" runat="server" TabIndex="6" Enabled="false" Width="160px"></asp:TextBox>
                            </td>
                            <td>Market Billing Rate
                            ...
                            <td>
                                <asp:TextBox ID="txtMarketBillingRate" runat="server" TabIndex="7" Width="160px"></asp:TextBox>
                            </td>
                        </tr>
                        <%-- <tr>
                            <td>LR No
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtDetentionAmount" runat="server" Width="160px" TabIndex="12"></asp:TextBox>
                            </td>
                            <td>Varai Expense
                            ...
                            <td>
                                <asp:TextBox ID="txtVaraiExp" runat="server" Width="160px" TabIndex="13"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtEmptyContCharges" runat="server" Width="160px" TabIndex="14"></asp:TextBox>
                            </td>
                            <td></td>
                            <td></td>
                        </tr>
