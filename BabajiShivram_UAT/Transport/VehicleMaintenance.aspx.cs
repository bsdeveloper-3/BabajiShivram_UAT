...
using System.Data;
using System.IO;
public partial class Transport_VehicleMaintenance : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            DBOperations.FillTransportVehicle(ddVehicle); // Fill HO CAR
            DBOperations.FillBabajiUserByDeptID(lbEmployee, 5);// Transport Department Emp
            DBOperations.FillMaintenanceCategory(lbCategory,1); // Maintenance Category
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        if (strEmpList != "")
        {
            ...
            {
                lblError.Text = "Please Select Work Employee Name!";
                lblError.CssClass = "errorMsg";
            }
        ...
        {
            lblError.Text = "Please Check Maintenance Employee Name!";
            lblError.CssClass = "errorMsg";
        }
    }
