<%@ Page Title="Maintenance Detail" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
        CodeFile="EditVesselMaintenance.aspx.cs" Inherits="Transport_EditVesselMaintenance" Culture="en-GB"%>
...
<asp:ScriptManager runat="server" ID="ScriptManager1" ScriptMode="Release"/>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="white">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="white">
        <th style="color:#FFFFFF;background-color:#5A7FA5;" colspan="2">Vessel/Expense Category</th><th style="color:#FFFFFF;background-color:#5A7FA5">Document</th>
        <tr>
            <td class="label" colspan="2">
                <asp:GridView ID="gvCategory" runat="server" AutoGenerateColumns="false" DataSourceID="DSCategory">
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="Vessel No" DataField="VehicleNo" />
    ...
    <fieldset><legend>Add Vessel/Category</legend>
