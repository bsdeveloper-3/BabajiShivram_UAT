<%@ Page Title="HO Vehicle Maintenance" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeFile="HOVehicleMaintenance.aspx.cs" Inherits="Transport_HOVehicleMaintenance" Culture="en-GB" %>
...
<script type="text/javascript">
    ...
    <div class="clear"></div>
    <fieldset><legend id="legRefNo" runat="server">Maintenance Work Detail</legend>
    <div class="m clear">
