...
public partial class Clearance : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("PendingDelivery.aspx");
        }
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        if (Session["CommonCustomer"] != null)
        {
            ...
            for (int i = 1; i < StepCount.Length; i++)
            {
                ...
                Label lblRMSNonRms = (Label)ucDelivery.FindControl("lblRMSNonRms");
                Label lblConReExamine = (Label)ucDelivery.FindControl("lblConReExamine");
                Label lblCFSName = (Label)ucDelivery.FindControl("lblCFSName");
                ...
                if (dsGetDetail != null && dsGetDetail.Tables.Count > 0 && dsGetDetail.Tables[0].Rows.Count > 0)
                {
                    ...
                    lblRMSNonRms.Text = dsGetDetail.Tables[0].Rows[0]["RMSNonRms"].ToString();
                    lblConReExamine.Text = dsGetDetail.Tables[0].Rows[0]["ContReExamine"].ToString();
                    lblCFSName.Text = dsGetDetail.Tables[0].Rows[0]["CFSName"].ToString();
                }
    ...
    protected void wzDelivery_NextButtonClick(object sender, WizardNavigationEventArgs e)
    {
        ...
        else if (IndexId > 0)
        {
            ...
            if (ucControl != null)
            {
                ...
                // N-Form, S-FOrm, Octroi and Road Permit Panel
