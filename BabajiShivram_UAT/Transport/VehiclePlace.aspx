<%@ Page Title="Vehicle Placement" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeFile="VehiclePlace.aspx.cs" Inherits="Transport_VehiclePlace" Culture="en-GB" EnableEventValidation="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function ClientValidate(source, arguments) {
            var sellPrice = document.getElementById('ctl00_ContentPlaceHolder1_rdlRequestReceive_0')
            var abc = document.getElementById('rdlRequestReceive').che;
            alert(abc)
    ...
    <asp:UpdatePanel ID="upnlVehicleDetail" runat="server">
        <ContentTemplate>
            <div align="center">
                ...
                <asp:HiddenField ID="hdnJobRefNo" runat="server" Value="0"/>
            </div>
            <div>
                <fieldset>
            ...
            <div>
                <fieldset>
                            ...
                            <asp:GridView ID="GridViewDocument" runat="server" AutoGenerateColumns="False" CssClass="table"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Check">
                                        <ItemTemplate>
                                            <asp:CheckBox ID="chkDocument" runat="server" ToolTip="Select Document" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Document Type">
                                        <ItemTemplate>
                                            <asp:Label ID="lblDocType" runat="server" Text='<%#Eval("DocName") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                            ...
                            <%--<asp:CompareValidator ID="CompareValidator1" runat="server" Operator="DataTypeCheck" Type="" 
                                ControlToValidate="txtMobNo" ErrorMessage="Value must be a number" ></asp:CompareValidator>--%>
                            <%--<asp:RangeValidator ID="RangeValidator1" runat="server" ControlToValidate="txtMobNo"
                                 ErrorMessage="Invalid Mobile Number" MaximumValue="10" MinimumValue="0" Type="Integer"></asp:RangeValidator>--%>
                        </fieldset>
                        <div>
                            <asp:SqlDataSource ID="DocumentSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                                SelectCommand="Get_UploadedDocument" SelectCommandType="StoredProcedure">
                                <SelectParameters>
                                    <asp:ControlParameter Name="JobRefNo" DbType="String" ControlID="hdnJobRefNo" />
                                </SelectParameters>
                            </asp:SqlDataSource>
                        </div>
            </div>
            <div>
                ...
                <fieldset>
                    ...
                    <div style="width: 1340px; overflow-x: scroll">
                        ...
                        <Columns>
                            <asp:TemplateField ShowHeader="False">
                             ...
                             <%--<asp:BoundField DataField="TransporterId" HeaderText="TransporterId" SortExpression="TransporterName" ReadOnly="true" Visible="false" />--%>
                            ...
                            <asp:TemplateField HeaderText="Email">
                                <ItemTemplate>
                                    <asp:ImageButton ID="imgbtnEmailCopy" runat="server" ImageUrl="~/Images/file.gif" Height="18" Width="20" ToolTip="Download email approval copy."
                                        CommandName="EmailCopy" CommandArgument='<%#Eval("EmailAttachment")%>' Visible='<%# DecideHere((string)Eval("EmailAttachment")) %>'/>
                                </ItemTemplate>
                            </asp:TemplateField>
                                ...
                                <fieldset>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="white">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="txtPlanningDate" runat="server"></asp:Label>
                                            </td>
                                            <td>Type of Payment
