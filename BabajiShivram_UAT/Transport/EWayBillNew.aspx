<%@ Page Title="Json File For EWay Bill" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeFile="EWayBillNew.aspx.cs" Inherits="Transport_EWayBillNew" Culture="en-GB" %>
    ...
    <asp:UpdatePanel ID="upJobDetail" runat="server">
        ...
        <fieldset><legend> Transaction Detail </legend>
            ...
            <tr>
                ...
                <td>
                    Transporter GSTIN
                    <asp:RequiredFieldValidator ID="RFVTransporterGSTIN" runat="server" InitialValue="" ControlToValidate="txtTransporterGSTIN" 
        ...
        <fieldset><legend>Bill From / Supplier</legend>
            <table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="white">
                ...
                <tr style="text-align:center;">
                    <td>
                        <asp:TextBox ID="txtBillFromName" runat="server" placeholder="Supplier Name"></asp:TextBox>
                    </td>
                    <td>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="white">
            ...
            <tr style="text-align:center;">
                <td>
                    <asp:TextBox ID="txtBillToName" runat="server" placeholder="Consignee Name"></asp:TextBox>
                </td>
                <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" InitialValue="" ControlToValidate="txtBillToGSTIN" 
