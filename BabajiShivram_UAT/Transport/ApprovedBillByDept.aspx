<%@ Page Title="Approved Bill By Dept" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ApprovedBillByDept.aspx.cs" Inherits="Transport_ApprovedBillByDept"
    Culture="en-GB" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="upnlTPBill" runat="server" UpdateMode="Conditional" RenderMode="Inline">
        <ContentTemplate>
            ...
            <fieldset id="fsDeliveryDetails" runat="server">
                <legend>Approved Transporter Bill</legend>
                ...
                <asp:GridView ID="gvVendorJobDetail" runat="server" AutoGenerateColumns="False" CssClass="table"
                    ...
                    OnPreRender="gvVendorJobDetail_PreRender" DataSourceID="DataSourceVendorJobs"
                    OnRowCommand="gvVendorJobDetail_RowCommand" OnRowDataBound="gvVendorJobDetail_RowDataBound">
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="Transporter" DataField="TransporterName" ReadOnly="true"
                            ItemStyle-Width="15%" />
                        <asp:TemplateField HeaderText="No of Vehicles" SortExpression="NoOfVehicle"
                ...
                <asp:SqlDataSource ID="DataSourceVendorJobs" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                    SelectCommand="TR_GetBillApprovedByDept" SelectCommandType="StoredProcedure">
                </asp:SqlDataSource>
            </fieldset>
        </ContentTemplate>
    </asp:UpdatePanel>
