<%@ Page Title="Vehicle Closing Report" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ReportVehicleClosing.aspx.cs" 
    Inherits="Transport_ReportVehicleClosing" Culture="en-GB" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" ID="content2" runat="server">
    ...
    <fieldset><legend>Vehicle Status Report</legend>
        <asp:UpdatePanel ID="upExpense" runat="server" UpdateMode="Conditional" RenderMode="Inline">
            <ContentTemplate>
                ...
                <div>
                    ...
                    <b>Closing Month</b> &nbsp;<asp:TextBox ID="txtReportDate" AutoPostBack="true" runat="server" MaxLength="100" Width="100px"></asp:TextBox>
                ...
                <asp:GridView ID="GridViewVehicle" runat="server" AutoGenerateColumns="true" CssClass="table" 
                     DataSourceID="SqlDataSourceExp" AllowSorting="true" OnRowDataBound="GridViewVehicle_RowDataBound">
                    <Columns>
                ...
                <div>
                    <asp:SqlDataSource ID="SqlDataSourceExp" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                        SelectCommand="TR_rptVehicleClosingStatus" SelectCommandType="StoredProcedure">
                        <SelectParameters>
