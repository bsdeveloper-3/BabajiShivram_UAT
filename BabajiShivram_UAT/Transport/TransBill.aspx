<%@ Page Title="Transport Bill" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="TransBill.aspx.cs" Inherits="Transport_TransBill" Culture="en-GB" EnableEventValidation="false" %>
    ...
    <asp:UpdatePanel ID="upPendingchecklist" runat="server" UpdateMode="Conditional" RenderMode="Inline">
        <ContentTemplate>
            ...
            <ajaxtoolkit:tabcontainer runat="server" id="TabBilling" activetabindex="0" cssclass="Tab"
                ...
                <AjaxToolkit:TabPanel ID="TabPanelConsolidateJob" runat="server" TabIndex="1" HeaderText="Consolidate Job Detail" Visible="false" >
                    <ContentTemplate>
                        <div style="overflow: auto;">
                            <div class="m clear">
                                <div align="center">
            ...
            <div>
                <asp:SqlDataSource ID="DataSourceVehicle" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                    SelectCommand="TR_GetTransBill_TST" SelectCommandType="StoredProcedure"
