...
public partial class CustomerExport_ViewReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DataFilter1.FilterSessionID = "ViewReport.aspx";
    ...
    protected void gvReportMS_RowCommand(Object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName.ToLower() == "generatereport")
        {
            ...
            Response.Redirect("~/CustomerExport/ViewCustAdHocReport.aspx");
        }
        if (e.CommandName.ToLower() == "edit")
        {
            ...
            Session["Lid"] = Id.Text;
            Response.Redirect("~/CustomerExport/AddReport.aspx");
        }
