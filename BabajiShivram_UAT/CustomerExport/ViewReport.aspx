<%@ Page Title="View Report" Language="C#" MasterPageFile="~/ExportCustomerMaster.master" AutoEventWireup="true" CodeFile="ViewReport.aspx.cs"
    Inherits="CustomerExport_ViewReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div>
        <asp:UpdateProgress ID="updProgress" runat="server" AssociatedUpdatePanelID="upnlExpReport">
            <ProgressTemplate>
    ...
    <asp:UpdatePanel ID="upnlExpReport" runat="server" UpdateMode="Conditional" RenderMode="Inline">
        <ContentTemplate>
            <div align="center">
            ...
            <fieldset>
                ...
                <div>
                    ...
                    <div class="fleft" style="margin-left: 40px;">
                        <asp:CheckBox ID="chkCustomer" runat="server" AutoPostBack="true" Text="Show Customer Report" />
                    </div>
                </div>
                <div class="clear"></div>
            ...
            <div>
                <asp:SqlDataSource ID="ViewReportSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                    SelectCommand="EX_CustGetAdhocReport" SelectCommandType="StoredProcedure" DeleteCommand="DelAdHocReport"
