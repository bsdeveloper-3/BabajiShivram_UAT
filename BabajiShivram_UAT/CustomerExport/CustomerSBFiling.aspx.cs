...
public partial class ExportCustomer_CustomerSBFiling : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            {
                lblMessage.Text = "No Job Found For SB Filing!";
        ...
        DataFilter1.FilterSessionID = "CustomerSBFiling.aspx";
