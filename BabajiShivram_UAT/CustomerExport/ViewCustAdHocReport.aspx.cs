...
public partial class CustomerExport_ViewCustAdHocReport : System.Web.UI.Page
{
    ...
    private void GenerateExcelMultiTab()
    {
        ...
        if (strDeliveryStatus == "")
        {
            ...
            dvReport = DBOperations.EX_rptCustAdHocReport(ReportId, DateFrom, DateTo, strDeliveryStatus, strReportFilter, FinYear, LoggedInUser.glCustUserId);
            ...
            //dvReport.RowFilter = "BackOfficeStatus =1";

            //dvReportAll.RowFilter = "BackOfficeStatus =0";

            //dvReportAll.RowFilter = "CONVERT(Isnull(BackOfficeStatus,''), System.String) = ''";
        ...
        else
        {
            ...
            dvReport = DBOperations.EX_rptCustAdHocReport(ReportId, DateFrom, DateTo, strDeliveryStatus, strReportFilter, FinYear, LoggedInUser.glUserId);
    ...
    private void ExportFunctionMultiTab(string header, string contentType, DataView dvReport, DataView dvReportAll)
    {
        using (XLWorkbook wb = new XLWorkbook())
        {
            ...
            if (dvReport.Count > 0)
            {
                ...
                dtCloned.Columns.Remove("BackOfficeStatus");
            ...
            if (dvReportAll.Count > 0)
            {
                ...
                dtClonedAll.Columns.Remove("BackOfficeStatus");
