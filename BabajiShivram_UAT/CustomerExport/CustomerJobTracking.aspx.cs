...
public partial class CustomerExport_CustomerJobTracking : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ScriptManager1.RegisterPostBackControl(lnkexport);
        Label lblTitle = (Label)Page.Master.FindControl("lblTitle");
        lblTitle.Text = "Export Shipment Tracking";
        if (!IsPostBack)
        {
            Session["JobId"] = null;
        ...
        DataFilter1.FilterSessionID = "CustomerJobTracking.aspx";
    ...
    {
        string strFileName = "Export_JobDetail_" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
