...
public partial class CustomerExport_CustomerShipmentGetIn : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DataFilter1.FilterSessionID = "CustomerShipmentGetIn.aspx";
    ...
    {
        string strFileName = "PendingShipmentGettedIn_" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
    ...
    private void ExportFunction(string header, string contentType)
    {
        ...
        gvJobDetail.Caption = "Shipment Getted In On " + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt");
