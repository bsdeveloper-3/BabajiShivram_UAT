                    ...
                    <asp:GridView ID="gvVendordetails" runat="server" AutoGenerateColumns="False" DataKeyNames="lId" EnableViewState="false" 
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Action">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkEdit" Text="View" runat="server" CommandArgument='<%# Bind("lId") %>' OnClick="lnkEdit_Click" ToolTip="Click to View Vendor Tracking details"></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
