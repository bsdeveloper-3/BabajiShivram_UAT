<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Approval.aspx.cs" Inherits="Forms_Approval" %>
...
<body>
    <form id="frmApproval" runat="server" class="formApproval">
        ...
        <span>
            ...
            <br />
            <span style="float: left; padding-top: 5px; padding-right: 25px" id="span1" runat="server">
        ...
        <div class="Space" style="padding-left: 5px">
            ...
            <asp:Button ID="btnNo" runat="server" OnClick="btnNo_OnClick" Text="NO" CssClass="btn" BackColor="lightcoral" />
        </div>
