<%@ Page Title="Lead Detail" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="LeadDetail.aspx.cs"
    Inherits="CRM_LeadDetail" MaintainScrollPositionOnPostback="true" Culture="en-GB" %>
    ...
    <asp:UpdatePanel ID="upJobDetail" runat="server">
        <ContentTemplate>
            ...
            <AjaxToolkit:TabContainer runat="server" ID="Tabs" ActiveTabIndex="0" CssClass="Tab"
                    ...
                    <ContentTemplate>
                        <fieldset>
                            ...
                            <asp:FormView ID="FormViewLead" runat="server" Width="100%" DataSourceID="DataSourceLead" DataKeyNames="lid" OnItemUpdating="FormViewLead_ItemUpdating"
                                ...
                                <ItemTemplate>
                                    <div class="m clear">
                                        <asp:Button ID="btnEditLead" runat="server" OnClick="btnEditLead_Click" Text="Edit" Visible="false" />
                                ...
                                <EditItemTemplate>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="white">
                                        ...
                                        <tr>
                                            <td>Address
                                                <asp:RequiredFieldValidator ID="rfvAddress" runat="server" ControlToValidate="txtAddress" Display="Dynamic" SetFocusOnError="true"
                                                    ErrorMessage="Please Enter Address" Text="*" ValidationGroup="Required" ForeColor="Red"></asp:RequiredFieldValidator>
                                            </td>
                                            <td colspan="3">
                                                <asp:TextBox ID="txtAddress" runat="server" TabIndex="13" Rows="2" TextMode="MultiLine" Width="1020px" Text='<%#Bind("Address") %>'></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Description</td>
                ...
                <AjaxToolkit:TabPanel runat="server" ID="TabPanelStatusHistory" TabIndex="2" HeaderText="Status">
                    <ContentTemplate>
                        <fieldset>
                ...
                <AjaxToolkit:TabPanel runat="server" ID="TabPanelService" TabIndex="5" HeaderText="Product">
                    <ContentTemplate>
                        <fieldset>
                        ...
                        <fieldset>
                            ...
                            <div>
                                <asp:GridView ID="gvMOMs" runat="server" ShowFooter="false" AutoGenerateColumns="False" Width="80%" TabIndex="21" class="table"
                                    ...
                                    PageSize="20" PagerSettings-Position="Bottom" OnRowCommand="gvMOMs_RowCommand" EmptyDataText="No MOM Found">
                                    <Columns>
                                        <asp:TemplateField HeaderText="" ItemStyle-Width="5%">
                                            <ItemTemplate>
                ...
                <AjaxToolkit:TabPanel runat="server" ID="TabPanelDocuments" TabIndex="10" HeaderText="Documents">
                    <ContentTemplate>
                        <fieldset>
