<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QuoteApproval.aspx.cs" Inherits="CRM_QuoteApproval" Culture="en-GB" %>
...
<body>
    <form id="frmApproval" runat="server" class="formApproval">
        ...
        <div class="Space" style="padding-left: 5px; text-align: center">
            ...
            &nbsp;&nbsp;
            <asp:Button ID="btnYes" runat="server" OnClick="btnYes_OnClick" CausesValidation="false" Text="APPROVE" ForeColor="White" Font-Bold="true" CssClass="btn" BackColor="#3e7cd8" />
            <asp:Button ID="btnNo" runat="server" OnClick="btnNo_Click" Text="REJECT" ForeColor="White" Font-Bold="true" ValidationGroup="vgRequired" CssClass="btn" BackColor="#3e7cd8" />
        </div>
                ...
                <ItemTemplate>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="white">
                        ...
                        <tr>
                            ...
                            <td colspan="2"><b>Additional Remark : </b>
                                <asp:Label ID="lblAdditionalRemark" runat="server" Text='<%#Eval("StageRemark") %>'></asp:Label>
                            </td>
                        </tr>
                    </table>
                </ItemTemplate>
        ...
        <div class="Space"></div>
        <asp:Button ID="lblServicesOffered" runat="server" Text="PRODUCT OFFERED" Enabled="false" ForeColor="White" Font-Bold="true" CssClass="btn" BackColor="#80cc3b" />
        <hr style="border-bottom: 1px solid black" />
        <asp:GridView ID="gvServicesOffered" runat="server" AutoGenerateColumns="False" Style="background-color: white" BorderWidth="2px"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="ServiceName" HeaderText="Product Offered" ItemStyle-HorizontalAlign="Center" ItemStyle-BorderStyle="Solid" ItemStyle-BorderWidth="1px" />
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="white">
                        ...
                        <tr>
                            <td><b>Payment Terms : </b>
                                ...
                                <asp:TextBox ID="txtPaymentTerms" runat="server" Text='<%#Eval("PaymentTerms") %>'></asp:TextBox>
                            </td>
