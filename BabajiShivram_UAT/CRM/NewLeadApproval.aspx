<%@ Page Title="Lead Approval" Language="C#" AutoEventWireup="true" CodeFile="NewLeadApproval.aspx.cs"
    Inherits="CRM_NewLeadApproval" Culture="en-GB" %>
...
<body>
    <form id="frmApproval" runat="server" class="formApproval">
        ...
        <div class="Space"></div>
        <asp:Label ID="txtApprovedBy" runat="server" Width="250px" Enabled="false" Font-Bold="true"></asp:Label>
    </form>
</body>
</html>
