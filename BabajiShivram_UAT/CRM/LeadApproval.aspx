<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LeadApproval.aspx.cs" Inherits="CRM_LeadApproval" Culture="en-GB" %>
    ...
    <script type="text/javascript">
        function ConfirmMessage() {
            if (Page_ClientValidate()) {
                if (confirm('KYC mail will be forwarded once approved. Are you sure to sent KYC to customer?')) {
                    return true;
                }
            }
        }
...
<body>
    <form id="frmApproval" runat="server" class="formApproval">
        ...
        <div class="Space" style="padding-left: 5px">
            <asp:Button ID="btnYes" runat="server" OnClientClick="return ConfirmMessage();" OnClick="btnYes_OnClick" Text="APPROVE" ForeColor="White" Font-Bold="true" CssClass="btn" BackColor="#80cc3b" />
            <asp:Button ID="btnNo" runat="server" OnClick="btnNo_Click" Text="REJECT" ForeColor="White" Font-Bold="true" CssClass="btn" BackColor="#80cc3b" />
        </div>
