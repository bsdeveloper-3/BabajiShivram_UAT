...
public partial class CRM_CustQuote : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            GetCompanyDetail(Convert.ToInt32(Session["EnquiryId"]));
    ...
    protected void GetCompanyDetail(int EnquiryId)
    {
        DataSet dsGetLeadDetail = DBOperations.CRM_GetRfqEnquiryByLid(EnquiryId);
        if (dsGetLeadDetail.Tables[0].Rows.Count > 0)
        {
            ...
            hdnEnquiryId.Value = EnquiryId.ToString();
            ...
            if (chkRFQQuote.Checked == true)
            {
                ...
                if (SavedDraft > 0)
                {
                    ...
                    if (dsGetQuoteRefNo != null)
                    {
                        ...
                        Response.Redirect("QuoteSuccess.aspx?id=" + SavedDraft.ToString() + "&op=5");
                    }
                }
                else
                {
    ...
    protected void chkRFQQuote_CheckedChanged(object sender, EventArgs e)
    {
        if (chkRFQQuote.Checked == true)
        {
            fsRfqQuote.Visible = true;
            fsNormalQuote.Visible = false;
        }
        else
        {
            fsNormalQuote.Visible = true;
            fsRfqQuote.Visible = false;
        }
    }
}