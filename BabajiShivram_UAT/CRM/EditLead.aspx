    ...
    <asp:UpdatePanel ID="upJobDetail" runat="server">
        <ContentTemplate>
            ...
            <div align="center">
                ...
                <asp:ValidationSummary ID="vsShareUser" runat="server" ShowMessageBox="True"
                    ShowSummary="False" ValidationGroup="vgShareUser" CssClass="errorMsg" EnableViewState="false" />
                <asp:ValidationSummary ID="vsFileUpload" runat="server" ShowMessageBox="True"
                    ShowSummary="False" ValidationGroup="vgFileUpload" CssClass="errorMsg" EnableViewState="false" />

                <asp:HiddenField ID="hdnQuotationId" runat="server" Value="0" />
            </div>
            <div class="clear"></div>
            <AjaxToolkit:TabContainer runat="server" ID="Tabs" ActiveTabIndex="9" CssClass="Tab"
                ...
                <AjaxToolkit:TabPanel runat="server" ID="TabPanelContract" TabIndex="4" HeaderText="Contract">
                    <ContentTemplate>
                        <br />
                        <div class="m clear">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="white">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvCFileUpload" runat="server" ControlToValidate="fuUploadContractCopy" Display="Dynamic" SetFocusOnError="true"
                                            ErrorMessage="Please Add Contract Copy" Text="*" ValidationGroup="ContractReq" ForeColor="Red"></asp:RequiredFieldValidator>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <asp:Button ID="btnAddContractCopy" runat="server" OnClick="btnAddContractCopy_OnClick" ValidationGroup="ContractReq"
                                            Text="Save" OnClientClick="return confirm('Are you sure to send contract for approval?')" /><%--ContractReq--%>
                                    </td>
                                </tr>
                            </table>
                        </fieldset>
                ...
                <AjaxToolkit:TabPanel runat="server" ID="TabPanelService" TabIndex="6" HeaderText="Product">
                    <ContentTemplate>
                        <fieldset>
                ...
                <AjaxToolkit:TabPanel runat="server" ID="TabPanelActivity" TabIndex="9" HeaderText="Activity">
                    <ContentTemplate>
                        ...
                        <fieldset>
                            ...
                            <asp:GridView ID="gvActivity" runat="server" AutoGenerateColumns="False" Width="80%" class="table"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="StatusName" HeaderText="Current Status" ReadOnly="True" >
                                    <HeaderStyle Width="10%" />
                                    <ItemStyle Width="10%" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="ActiveStatus" HeaderText="Active Status" ReadOnly="True" >
                                    <HeaderStyle Width="10%" />
                                    <ItemStyle Width="10%" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="CreatedBy" HeaderText="Created By" ReadOnly="True"  >
                                    ...
                                    <asp:BoundField DataField="CreatedDate" HeaderText="CreatedDate" ReadOnly="True" DataFormatString="{0:dd/MM/yyyy HH:mm:ss tt}"  >
                                    <HeaderStyle Width="10%" />
                                    <ItemStyle Width="10%" />
                                    </asp:BoundField>
                                </Columns>
                ...
                <AjaxToolkit:TabPanel runat="server" ID="TabPanelCustEnquiry" TabIndex="11" HeaderText="Enquiry/Quote">
                    <ContentTemplate>
                        <fieldset>
                            <legend>Enquiry/Quote</legend>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Quote Copy" SortExpression="">
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="lblQuoteText" runat="server" Text="Kindly Quote" Visible="false"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Document Copy" SortExpression="">
                                        <ItemTemplate>
                                            <asp:ImageButton ID="imgbtnContract" runat="server" CausesValidation="false" CommandName="Contract"
                                                ImageAlign="AbsMiddle" ImageUrl="~/Images/file.gif" Width="16" Height="16" ToolTip="Download Document."
                            ...
                            <asp:SqlDataSource ID="DataSourceEnquiry" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                                SelectCommand="CRM_GetQuoteByLeadId" SelectCommandType="StoredProcedure"><%--CRM_GetEnquiryByLeadID--%>
                                <SelectParameters>
                                    <asp:SessionParameter Name="LeadId" SessionField="LeadId" />
                                </SelectParameters>
                            </asp:SqlDataSource>
                ...
                <AjaxToolkit:TabPanel runat="server" ID="TabPanelKYC" TabIndex="12" HeaderText="KYC">
                    <ContentTemplate>
                        <fieldset>
                            ...
                            <asp:LinkButton ID="lnkKYCEmail" Text="Send KYC Email" runat="server" OnClick="lnkKYCEmail_Click" Visible="true"></asp:LinkButton>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:LinkButton ID="lnkStampCopyEmail" Text="Stamp Copy Email" runat="server" OnClick="lnkStampCopyEmail_Click" Visible="false"></asp:LinkButton>
                            ...
                            <asp:GridView ID="gvKYCCopys" runat="server" DataKeyNames="lid" Width="99%" AllowPaging="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="DocPath" HeaderText="Description" SortExpression="CatgName" />
                ...
                <AjaxToolkit:TabPanel runat="server" ID="TabPanelShare" TabIndex="13" HeaderText="Transfer">
                    <ContentTemplate>
                        <br />
                        <fieldset style="margin: 0px">
                            <legend>Transfer</legend>
                            <div class="clear">
                                <asp:Button ID="btnSaveShare" runat="server" ValidationGroup="vgShareUser" Text="Save" CausesValidation="true" OnClick="btnSaveShare_Click" />
                                <asp:Button ID="btnCancelShare" runat="server" Text="Cancel" OnClick="btnCancelShare_Click"/>
                            </div>
                            <br />
                            <table border="0" cellpadding="0" cellspacing="0" width="80%" bgcolor="white" runat="server">
                                <tr runat="server">
                                    <td runat="server">Assign To User
                                        <asp:RequiredFieldValidator ID="rfvShare" runat="server" ControlToValidate="ddlShareUser" SetFocusOnError="True" CausesValidation="true"
                                            Display="Dynamic" ErrorMessage="Please Select User." Text="*" ForeColor="Red" ValidationGroup="vgShareUser" InitialValue="0"></asp:RequiredFieldValidator>
                                    </td>
                                    <td runat="server">
                                        <asp:DropDownList ID="ddlShareUser" runat="server" Width="310px" DataSourceID="DataSourceShareUser" DataTextField="sName" DataValueField="lid"
                                            AppendDataBoundItems="True" OnSelectedIndexChanged="ddlShareUser_SelectedIndexChanged" AutoPostBack="true" >
                                            <asp:ListItem Text="--Select--" Value="0" Selected="False"></asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                <tr runat="server">
                                    <td runat="server">Remark
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtShareRemark" SetFocusOnError="True" CausesValidation="true"
                                            Display="Dynamic" ErrorMessage="Please Enter Remark." Text="*" ForeColor="Red" ValidationGroup="vgShareUser"></asp:RequiredFieldValidator>
                                    </td>
                                    <td runat="server">
                                        <asp:TextBox ID="txtShareRemark" runat="server" TextMode="MultiLine"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </fieldset>
                        <fieldset>
                            <legend>TranSfer Info</legend>
                                ...
                                <asp:GridView ID="gvShareLead" runat="server" AutoGenerateColumns="False" Width="80%" class="table"
                                DataSourceID="DataSourceGetShareUser" EmptyDataText="No activity found!" Style="border-collapse: initial; border: 1px solid #5D7B9D;">
                                <Columns>
                                    <asp:TemplateField HeaderText="Sl">
                                        <ItemTemplate>
                                            <%#Container.DataItemIndex +1 %>
                                    ...
                                    <asp:BoundField HeaderText="Compony Name" DataField="ComponyName" />
                                    <asp:BoundField HeaderText="Assign To User" DataField="sName" />
                                    <asp:BoundField HeaderText="Created User" DataField="CreatedBy" />
                                    <asp:BoundField HeaderText="Create Date" DataField="dtDate" />
                                </Columns>
                            </asp:GridView>
                            <div>
                                <asp:SqlDataSource ID="DataSourceGetShareUser" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>" 
                                    SelectCommand="CRM_GetShareLead" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
                                        <asp:SessionParameter Name="LeadId" SessionField="LeadId" />
            ...
            <div id="divDataSource">
                ...
                <asp:SqlDataSource ID="DataSourceShareUser" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>" 
                    SelectCommand="CRM_GetUser" SelectCommandType="StoredProcedure" >
                    <SelectParameters>
                        <asp:SessionParameter Name="UserId" SessionField="UserId" />
                        <asp:SessionParameter Name="FinYearId" SessionField="FinYearId" />
                    </SelectParameters>
