<%@ Page Title="Lead Tracking" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="LeadTracking.aspx.cs"
    Inherits="CRM_LeadTracking" Culture="en-GB" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" %>
        ...
        <ContentTemplate>
            ...
            <fieldset class="fieldset-AutoWidth">
                ...
                <asp:GridView ID="gvLeads" runat="server" AutoGenerateColumns="False" Width="100%" PagerStyle-CssClass="pgr" DataSourceID="DataSourceLeads"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="QuotationStatus" HeaderText="Quote Status" ReadOnly="true" SortExpression="QuotationStatus" />
            ...
            <div>
                <asp:SqlDataSource ID="DataSourceLeads" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                    SelectCommand="CRM_GetLeadTracking" SelectCommandType="StoredProcedure"> <%--CRM_GetUserForLead--%>
                    <SelectParameters>
