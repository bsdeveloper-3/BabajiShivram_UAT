...
public partial class CRM_ApprovedLead : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        ScriptManager1.RegisterPostBackControl(btnSaveMOM);
        ScriptManager1.RegisterPostBackControl(btnSendMail);
        ScriptManager1.RegisterPostBackControl(gvAgenda);
        ...
        calMeetingDate.StartDate = DateTime.Today.AddDays(-10);
        calMeetingDate.EndDate = DateTime.Now;
        ...
        mevMeetingDate.MinimumValue = DateTime.Now.AddDays(-10).ToString("dd/MM/yyyy");
        mevMeetingDate.MaximumValue = DateTime.Now.ToString("dd/MM/yyyy");
    }

    #region Status History
    //protected void btnSaveStatus_Click(object sender, EventArgs e)
    //{
    //    //if (Convert.ToInt32(ddlStatus.SelectedValue) == 7) // quote
    //    //{
    //    //    if(txt)
    //    //}

    //    int result = DBOperations.CRM_AddLeadStageHistory(Convert.ToInt32(Session["LeadId"]), Convert.ToInt32(ddlStatus.SelectedValue),
    //                                                    txtRemark.Text.Trim(), LoggedInUser.glUserId);
    //    if (result == 0)
    //    {
    ...
    protected void ShowPopup(int MomId)
    {
        ...
        if (MomId > 0)
        {
            ...
            // Email Format
            strCustomerEmail = lblCustomerEmail.Text.Trim(); // strAttendeeEmail.ToString();  // strAttendeeEmail.ToString();  
