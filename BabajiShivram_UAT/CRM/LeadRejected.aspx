<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LeadRejected.aspx.cs" Inherits="CRM_LeadRejected" Culture="en-GB" %>
    ...
    <form id="frmApproval" runat="server" class="formApproval">
        ...
        <span>
            ...
            <span style="float: left; padding-top: 5px; padding-right: 25px" id="span_ProceedAhead" runat="server">
                <asp:TextBox ID="txtRemark" runat="server" TabIndex="1" required placeholder=" Enter reason..." Rows="2" Width="900px" TextMode="MultiLine" Style="border: 0.5px solid black; border-radius: 4px"></asp:TextBox>
            </span>
        </span>
        <div class="Space" style="padding-left: 5px">
            <asp:Button ID="btnYes" runat="server" OnClick="btnYes_OnClick" Text="REJECT" ForeColor="White" Font-Bold="true" CssClass="btn" BackColor="#80cc3b" />
        </div>
