...
public partial class CRM_LeadTracking : System.Web.UI.Page
{
    ...
    protected void lnkExport_Click(object sender, EventArgs e)
    {
        ...
        string strFileName = "AllLeads_" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
    ...
    private void ExportFunction(string header, string contentType)
    {
        ...
        gvLeads.Columns[2].Visible = true;
