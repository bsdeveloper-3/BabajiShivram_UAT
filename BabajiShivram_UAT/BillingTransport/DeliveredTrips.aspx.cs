...
public partial class BillingTransport_DeliveredTrips : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            if (Convert.ToString(Session["UserId"]) != null)
            {
                ...
                lblTitle.Text = "Delivered Trips Details";
            }
            else
            {
                Session.Abandon();
        ...
        DataFilter1.FilterSessionID = "DeliveredTrips.aspx";
