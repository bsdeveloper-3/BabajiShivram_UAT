<%@ Page Title="Transport Bill Scrutiny" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeFile="TransBillReceivedDetail.aspx.cs" Inherits="BillingTransport_TransBillReceivedDetail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    function ConfirmMessage() {
        if (Page_ClientValidate()) {
            if (confirm('Sure To Submit Bill?')) {
                return true;
            }
        }
    }
    ...
    <div style="width: 1360px; overflow-x: auto">
        <asp:GridView ID="GridViewVehicle" runat="server" AutoGenerateColumns="False" CssClass="table"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="OtherCharges" HeaderText="Other" SortExpression="OtherCharges" ReadOnly="true" />
                ...
                <asp:TemplateField HeaderText="LR Doc">
                <ItemTemplate>
                    <asp:LinkButton ID="lnkDownload" CommandName="LRDownload" runat="server" Text="Download"
                         CommandArgument='<%#Eval("LRCopyPath")%>' CausesValidation="false"
                        ></asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
    ...
    <fieldset>
        <legend>Bill Approve / Rejct</legend>
        <div>
            ...
            <div class="m clear">
                ...
                <asp:Button ID="btnApproveBill" runat="server" OnClick="btnApproveBill_Click" Text="Approve Bill Detail" 
                   OnClientClick="return ConfirmMessage();" CausesValidation="true" ValidationGroup="ReqStatus" />
                <asp:Button ID="btnRejectBill" runat="server" OnClick="btnRejectBill_Click" Text="Reject Bill Detail" 
                   OnClientClick="return ConfirmMessage();" CausesValidation="true" ValidationGroup="ReqStatus" />
            </div>
                ...
                <tr>
                    <td>Remark
                        <asp:RequiredFieldValidator ID="rfvHoldReason" runat="server" ControlToValidate="txtRemark" SetFocusOnError="true"
                            Display="Dynamic" ErrorMessage="Please Enter Remark." ValidationGroup="ReqStatus"></asp:RequiredFieldValidator>
                    </td>
                    <td colspan="3">
        ...
        <div>
            <asp:GridView ID="gvBillStatusHistory" runat="server" AutoGenerateColumns="False" CssClass="table"
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="Cheque / UTR No" DataField="ChequeNo" />
                    <asp:BoundField HeaderText="Cheque / UTR Date" DataField="ChequeDate" DataFormatString="{0:dd/MM/yyyy}" />
    ...
    <fieldset>
        ...
        <div>
            <asp:GridView ID="gvBillReceived" runat="server" AutoGenerateColumns="False" CssClass="table"
                Width="100%" AlternatingRowStyle-CssClass="alt" PagerStyle-CssClass="pgr" DataKeyNames="lId"
                DataSourceID="DataSourceBillReceived" CellPadding="4" AllowPaging="True" AllowSorting="True" ShowFooter="true"
                PageSize="20" FooterStyle-ForeColor="Black" FooterStyle-CssClass="table" Font-Bold="False" Font-Italic="False" FooterStyle-BackColor="#CCCCFF">
                <Columns>
                    <asp:TemplateField HeaderText="Sl">
                        <ItemTemplate>
    ...
    <fieldset id="fsRejectHistory" runat="server">
        ...
        <div style="width: 1355px; overflow-x: scroll">
    ...
    <div id="divDataSource">
        ...
        <asp:SqlDataSource ID="DataSourceRate" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
            SelectCommand="TRS_GetTransRateByTransporterForBill" SelectCommandType="StoredProcedure">
            <SelectParameters>
                <asp:SessionParameter Name="TransReqID" SessionField="TRId" />
