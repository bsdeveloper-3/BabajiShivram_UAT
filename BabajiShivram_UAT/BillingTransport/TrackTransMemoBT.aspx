<%@ Page Title="Transport Memo - BSCCPL" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="TrackTransMemoBT.aspx.cs" Inherits="BillingTransport_TrackTransMemoBT" %>
    ...
    <asp:UpdatePanel ID="upFillDetails" runat="server" UpdateMode="Conditional">
        ...
        <div>
            <asp:SqlDataSource ID="InvoiceSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                SelectCommand="TRS_GetTransMemoBT" SelectCommandType="StoredProcedure">
            </asp:SqlDataSource>
        </div>
    </ContentTemplate>
    </asp:UpdatePanel>
