<%@ Page Title="Memo Audit - BSCCPL" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeFile="PendingTransMemoAuditBT.aspx.cs" Inherits="BillingTransport_PendingTransMemoAuditBT" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div>
        ...
        <asp:UpdatePanel ID="upFillDetails" runat="server" UpdateMode="Conditional">
            ...
            <fieldset><legend>Transport Memo Audit</legend>
            <div class="clear">
            <asp:Panel ID="pnlFilter" runat="server">
                ...
                <div class="fleft" style="margin-left:30px; padding-top:3px;">
                <asp:Button ID="btnAuditMemo" runat="server" Text="Audit Transport Memo For Payment" OnClick="btnAuditMemo_Click" OnClientClick="return confirm('Sure to Complete Audit ?');" />
                </div>
            </asp:Panel>
            </div>
        ...
        <div>
            <asp:SqlDataSource ID="InvoiceSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                SelectCommand="TRS_GetPendingMemoForAuditBT" SelectCommandType="StoredProcedure">
            </asp:SqlDataSource>
        </div>
    </ContentTemplate>
    </asp:UpdatePanel>
