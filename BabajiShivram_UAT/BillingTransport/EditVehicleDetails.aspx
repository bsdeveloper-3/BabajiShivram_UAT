<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/TransportMaster.master"
    CodeFile="EditVehicleDetails.aspx.cs" Inherits="BillingTransport_EditVehicleDetails"
    Culture="en-GB" %>
    ...
    <fieldset style="min-height: 380px; margin-top: 0px">
        <fieldset id="fsAllVehicles" runat="server" style="min-height: 100px">
            ...
            <div>
                ...
                <asp:SqlDataSource ID="DataSourceDelivery" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                    SelectCommand="GetVehicleDetailForTransVendor" SelectCommandType="StoredProcedure">
                    <SelectParameters>
                        <asp:SessionParameter Name="VehicleNo" SessionField="VehicleNo" Type="String" />
                        <asp:SessionParameter Name="DispatchDate" SessionField="DispatchDate" Type="DateTime" />
        ...
        <fieldset id="fsVehicleDetail" runat="server" style="margin-bottom: 0px">
            ...
            <asp:SqlDataSource ID="DataSourceJobDetail" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                ...
                <SelectParameters>
                    <%--  <asp:ControlParameter ControlID="hdnVehicleNo" PropertyName="Value" Name="VehicleNo"
                        Type="String" />--%>
