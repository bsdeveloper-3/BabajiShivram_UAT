<%@ Page Title="Pending Bill Submission" Language="C#" MasterPageFile="~/TransportMaster.master" AutoEventWireup="true" 
    CodeFile="PendingVendorBill.aspx.cs" Inherits="BillingTransport_PendingVendorBill" EnableEventValidation="false" Culture="en-GB" %>
                ...
                <div>
                    <asp:GridView ID="gvVendorJobDetail" runat="server" AutoGenerateColumns="False" CssClass="table"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Total Vehicle" DataField="TotalVehiclePlaced" SortExpression="TotalVehiclePlaced" />
...
<%--                            <asp:BoundField HeaderText="Destination" DataField="DeliveryDestination" ReadOnly="true"
                    ...
                    <asp:SqlDataSource ID="DataSourceVendorJobs" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                        SelectCommand="TRS_GetPendingBillByVendorId" SelectCommandType="StoredProcedure">
                        <SelectParameters>
