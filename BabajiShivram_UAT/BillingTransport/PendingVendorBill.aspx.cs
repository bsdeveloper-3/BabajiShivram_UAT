...
using System.IO;
public partial class BillingTransport_PendingVendorBill : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DataFilter1.FilterSessionID = "PendingVendorBill.aspx";
    ...
    {
        string strFileName = "PendingBill_" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
