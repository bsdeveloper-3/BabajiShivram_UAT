...
public partial class Reports_SKFIndiaDSRMIS : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (Pagename == "Tech")
            {
                ...
                lblTitle.Text = "SKF Technology MIS";
                lblLegend.Text = "SKF Technology MIS";
            }
            else
            {
                Session["CustId"] = "1322";
                Label lblTitle = (Label)Page.Master.FindControl("lblTitle");
                lblTitle.Text = "SKF India MIS";
                lblLegend.Text = "SKF India MIS";
            }
            Session["FinYearId"] = LoggedInCustomer.glFinYearId;
            ddClearedStatus.SelectedValue = "0";
            Session["Status"] = ddClearedStatus.SelectedValue;
        }
    }
    ...
    {
        string strFileName = "SKF_India_MIS" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
    ...
    private void ExportWorkbook(string header, string contentType)
    {
        ...
        {
            string Report = "SKF_India_MIS" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
            ...
            if (dtReport.Rows.Count > 0)
            {
                ...
                dtReport.TableName = "SKF_India_MIS";
                string strFileName = "SKF_India_MIS.xlsx";
