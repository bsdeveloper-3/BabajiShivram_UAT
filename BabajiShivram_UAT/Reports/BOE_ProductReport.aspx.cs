...
public partial class Reports_BOE_ProductReport : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            lblTitle.Text = "BOE Product Report";
        }

        //
        DataFilter1.DataSource = SqlDataSourceProduct;
        DataFilter1.DataColumns = gvCustomerWiseJob.Columns;
        DataFilter1.FilterSessionID = "BOE_ProductReport.aspx";
    ...
    {
        string strFileName = "BOE_ProductReport_" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
    ...
    private void ExcelExport(string header, string contentType)
    {
       ...
       // gvCustomerWiseJob.Columns[1].Visible = false;
        ...
        gvCustomerWiseJob.DataSourceID = "SqlDataSourceProduct";
        gvCustomerWiseJob.DataBind();
