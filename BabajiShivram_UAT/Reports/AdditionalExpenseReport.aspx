    ...
    <asp:UpdatePanel ID="upPendingPost" runat="server" UpdateMode="Conditional" RenderMode="Inline">
        <ContentTemplate>
            ...
            <asp:GridView ID="gvJobDetail" runat="server" AutoGenerateColumns="False" CssClass="table"
                ...
                <asp:BoundField DataField="HODAging" HeaderText="HOD Aging" SortExpression="HODAging" />
                <asp:BoundField DataField="MgmtAging" HeaderText="Mgmt Aging" SortExpression="MgmtAging" />
