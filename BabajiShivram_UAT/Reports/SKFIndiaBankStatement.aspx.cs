...
public partial class Reports_SKFIndiaBankStatement : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            lblTitle.Text = "SKF India Bank Statement ";
        }
    ...
    {
        string strFileName = "SKF_India_Bank_Statement" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
    ...
    private void ExportWorkbook(string header, string contentType)
    {
        ...
        {
            string Report = "SKF_India_Bank_Statement" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
            ...
            if (dtReport.Rows.Count > 0)
            {
                ...
                dtReport.TableName = "SKF_India_Bank_Statement";
                string strFileName = "SKF_India_Bank_Statement.xlsx";
