...
public partial class Reports_SKFIndiaLicense : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["PageName"] != null && Request.QueryString["Tech"] != string.Empty)
            ...
            if (Pagename == "Tech")
            {
                ...
                lblTitle.Text = "SKF Technology License MIS";
                lblLegend.Text = "SKF Technology License MIS";
            }
            else
            {
                Session["CustId"] = "1322";
                Label lblTitle = (Label)Page.Master.FindControl("lblTitle");
                lblTitle.Text = "SKF India License MIS";
                lblLegend.Text = "SKF India License MIS";
            }
    ...
    {
        string strFileName = "SKF_India_" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
    ...
    private void ExportWorkbook(string header, string contentType)
    {
        ...
        {
            string Report = "SKF_India_License_MIS" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
            ...
            if (dtReport.Rows.Count > 0)
            {
                ...
                dtReport.TableName = "SKF_India_License_MIS";
                string strFileName = "SKF_India_License_MIS.xlsx";
