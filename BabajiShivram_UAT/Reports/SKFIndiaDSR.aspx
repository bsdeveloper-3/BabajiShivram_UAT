<%@ Page Title="SKF India DSR" Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master"
    CodeFile="SKFIndiaDSR.aspx.cs" Inherits="Reports_SKFDSR" Culture="en-GB" %>
        ...
        <ContentTemplate>
            ...
            <div class="clear"></div>
                <asp:GridView ID="gvReport" runat="server" AutoGenerateColumns="False" CssClass="table"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="Shipment clearance date" DataField="Shipment clearance date" />
                        <asp:BoundField HeaderText="Progress Report / Remark" DataField="Progress Report / Remark" />
            ...
            <div>
                <asp:SqlDataSource ID="DataSourceReport" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                 SelectCommand="rptSKFDSR" SelectCommandType="StoredProcedure">
                <SelectParameters>
                  <asp:Parameter Name="UserId" DefaultValue="1" />
                    <%--<asp:Parameter Name ="FinYearId" DefaultValue="7" />--%>
