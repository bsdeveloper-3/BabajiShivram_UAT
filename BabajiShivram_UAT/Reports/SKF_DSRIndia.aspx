<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="SKF_DSRIndia.aspx.cs" Inherits="Reports_SKF_DSRIndia" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="upPendingchecklist" runat="server" UpdateMode="Conditional" RenderMode="Inline">
        <ContentTemplate>
            ...
            <div class="clear"></div>
            <div class="clear"></div>
            <fieldset><legend>SKF DSR India</legend>
            <div>
                <asp:LinkButton ID="lnkReportXls" runat="server" >
            ...
            <div>
                <asp:SqlDataSource ID="DataSourceReport" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                 SelectCommand="rptSKFDSRIndia" SelectCommandType="StoredProcedure">
                <SelectParameters>
