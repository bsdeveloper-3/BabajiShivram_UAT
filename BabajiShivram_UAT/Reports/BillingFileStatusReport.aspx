<%@ Page Title="Billing File Status" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="BillingFileStatusReport.aspx.cs" Inherits="Reports_BillingFileStatusReport"  Culture="en-GB"%>
    ...
    <div>
     ...
     <asp:UpdatePanel ID="upBillPendingReport" runat="server" UpdateMode="Conditional" RenderMode="Inline">
        <ContentTemplate>
            ...
            <fieldset style="width:80%"><legend>File Status Report</legend>    
             <div class="fright">
             ...
             <table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="white">                   
                <th colspan="4" class="heading">File Status Report</th>
                <tr>
                    <td>Date From
            ...
            <div>
                <asp:GridView ID="gvFileStatusReport" runat="server" AutoGenerateColumns="false" CssClass="gridview" AllowPaging="true">
                    <Columns>
                        ...
                        <asp:BoundField DataField="Correct Files"  HeaderText="Correct Files" SortExpression="Correct Files"/>
                        <asp:TemplateField HeaderText="InCorrect Files">
                        <ItemTemplate>
                        <asp:LinkButton ID="lnkInCorrectFiles" runat="server"  OnClick="lnkInCorrectFiles_Click" CommandArgument='<%#Eval("stage")%>' ><%#Eval("InCorrect Files") %></asp:LinkButton>
                        </ItemTemplate>
                        </asp:TemplateField>
...
<asp:panel id="Panel1" style="display: none" runat="server"  >
  ...
  <div title="Followup History" id="divincorrectFiles" runat="server" style="display:none;border: 1px solid #C0C0C0;width: 584px; height: 500px; overflow: scroll; position: relative;">           
 <table>
 <tr>
 <td class="header" style="color:White"  align="left"><b>InCorrect File Details</b></td>
 <td><asp:ImageButton ID="imgClose" ImageUrl="~/Images/delete.gif"  runat="server" OnClick="btnCancelPopup_Click" ToolTip="Close"  /></td>
 </tr>
 <tr><td colspan="2">
    <asp:GridView ID="gvIncorrectfiledetails"  runat="server" DataSourceID="DsInCorrectFileDetails"  CssClass="gridview"  AutoGenerateColumns="false"  AllowPaging="false">
                    <Columns>
                        <asp:TemplateField HeaderText="Sl">
                            <ItemTemplate>
                                <%#Container.DataItemIndex +1 %>
       ...
       SelectCommandType="StoredProcedure" SelectCommand="rptBillingFileStatusReports">
       <SelectParameters>
      ...
      <asp:ControlParameter Name="Customer"  ControlID="DrpCustomer" PropertyName="SelectedValue" Type="int16"/>
       ...
       <asp:SqlDataSource ID="DsInCorrectFileDetails" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>" 
       SelectCommandType="StoredProcedure" SelectCommand="rptInCorrectFileReports">       
       <SelectParameters>
       <asp:Parameter Name="ReceivedBy" Type="int16" />
      <asp:ControlParameter Name="FromDate"  ControlID="txtDateFrom" PropertyName="Text" Type="DateTime" />
      <asp:ControlParameter Name="ToDate"    ControlID="txtDateTo" PropertyName="Text" Type="DateTime"/>          
      <asp:ControlParameter Name="Branch"    ControlID="Drpbranch" PropertyName="SelectedValue" Type="int16"/>    
      <asp:ControlParameter Name="Customer"  ControlID="DrpCustomer" PropertyName="SelectedValue" Type="int16"/>
