<%@ Page Title="Checklist KPI" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="KPIChecklist.aspx.cs" 
    Inherits="Reports_KPIChecklist" EnableEventValidation="false" Culture="en-GB" %>
    ...
    <div>
     ...
     <asp:UpdatePanel ID="upPendingchecklist" runat="server" UpdateMode="Conditional"
        ...
        <ContentTemplate>
            ...
            <div class="clear"></div>
            <fieldset><legend>Checklist Preparation KPI</legend>    
            <div>
                <div class="fleft">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="white">
                <tr>
                    <td> Checklist Request Date From
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddPort" runat="server">
                            ...
                            <asp:ListItem Text="Chennai Air Cargo" Value="6"></asp:ListItem>
                            <asp:ListItem Text="Chennai Sea" Value="7"></asp:ListItem>
                            <asp:ListItem Text="Jaipur ICD" Value="10"></asp:ListItem>
                            <asp:ListItem Text="Nagpur ICD" Value="46"></asp:ListItem>
                            <asp:ListItem Text="Nagpur" Value="52"></asp:ListItem>
                            <asp:ListItem Text="Hyderabad Air Cargo" Value="50"></asp:ListItem>
                            <asp:ListItem Text="Hyderabad ICD" Value="51"></asp:ListItem>
                            <asp:ListItem Text="Mulund ICD" Value="35"></asp:ListItem>
                            <asp:ListItem Text="Pune ICD" Value="53"></asp:ListItem>
                        </asp:DropDownList>
                    </td>
                    <td></td>
                    <td></td>
                ...
                <cc1:TabPanel ID="TabPanelChart" runat="server" HeaderText="Chart Report">
                    ...
                    <div id="divPIE">
                        <asp:Chart ID="BOEKPIChartPIE" Height="300px" Width="800px" runat="server" BorderlineWidth="2" BorderlineColor="ActiveBorder" BorderlineDashStyle="DashDot" 
	                        ...
	                        <Series>
		                        <asp:Series Name="BOEKPI" YValueType="Int32" ChartArea="ChecklistKPIArea" ChartType="Pie" Color="211, 223, 240"></asp:Series>
	                        </Series>
                            <Titles>
                                <asp:Title Text="Total No of Product" font="Arial, 12pt, style=Bold, Italic" Name="Sector"></asp:Title>
                            </Titles>
	                        <ChartAreas>
		                        <asp:ChartArea Name="ChecklistKPIArea">
                                </asp:ChartArea>
                            </ChartAreas>
                            <Legends>
                                <asp:Legend Name="ChecklistKPILegends" BorderColor="Green" BorderDashStyle="Solid"></asp:Legend>
                            </Legends>
                        </asp:Chart>
                    </div>
        ...
        <asp:SqlDataSource ID="DataSourceBOEKPI" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
            SelectCommandType="StoredProcedure" SelectCommand="rptkpiChecklist" DataSourceMode="DataSet">
            <SelectParameters>
