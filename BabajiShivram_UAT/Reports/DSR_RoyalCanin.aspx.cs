...
public partial class Reports_DSR_RoyalCanin : System.Web.UI.Page
{
    ...
    {
        string strFileName = "DSR_ROYAL_CANIN" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
    ...
    private void ExportWorkbook(string header, string contentType)
    {
        ...
        {
            string Report = "DSR_ROYAL_CANIN" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
            ...
            if (dtReport.Rows.Count > 0)
            {
                ...
                dtReport.TableName = "DSR_ROYAL_CANIN";
                string strFileName = "DSR_ROYAL_CANIN.xlsx";
