<%@ Page Title="Expense Provision" Language="C#" MasterPageFile="~/MasterPage.master" 
    AutoEventWireup="true" CodeFile="SKFImportExpenseProvision.aspx.cs" Inherits="Reports_SKFImportExpenseProvision"  Culture="en-GB"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="upPendingchecklist" runat="server" UpdateMode="Conditional" RenderMode="Inline">
        <ContentTemplate>
            ...
            <div class="clear"></div>
            <div class="clear"></div>
            <fieldset><legend>SKF India Import Expense Provision</legend>
            <div>
            ...
            <div class="clear"></div>
                <asp:GridView ID="gvReport" runat="server" AutoGenerateColumns="False" CssClass="table"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="Recoverable Duty Amount (IGST)" DataField="Recoverable Duty Amount (IGST)" />
                        <asp:BoundField HeaderText="Not- Recoverable Duty Amount" DataField="Not- Recoverable Duty Amount" />
                        <asp:BoundField HeaderText="International Freight Total Amount" DataField="International Freight Total Amount -Mention on Forwarder" />
                        <asp:BoundField HeaderText="Domestic Fright Amount (INR)" DataField="Domestic Fright Amount (INR)" />
                        <asp:BoundField HeaderText="Import Other Expense" DataField="Import Other Expense-Mention of Forwarder Invoice" />
                        <asp:BoundField HeaderText="Total" DataField="Total" />
                        <asp:BoundField HeaderText="% of Non-Recoverable Duty" DataField="% of Non-Recoverable Duty" />
            ...
            <div>
                <asp:SqlDataSource ID="DataSourceReport" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                 SelectCommand="SKFImportExpenseProvision" SelectCommandType="StoredProcedure">
                <SelectParameters>
