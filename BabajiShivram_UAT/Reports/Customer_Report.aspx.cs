...
public partial class Reports_Customer_Report : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            lblCustomer.Text = LoggedInUser.glCustName;
            ...
            //{
                ...
                //ddCustomer.SelectedValue = Convert.ToString(LoggedInUser.glCustId);
                //    Fill_ReportTree(2);
                //    Fill_ConditionalTree(2);
                // }
                //else
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            int Result = DBOperations.AddAdhocReport(strReportName, strReportFieldId, strConditionColumnId, ReportType, CustomerId, 1, LoggedInUser.glCustUserId);
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        if (strReportType == "2") // Babaji Customer Report
        {
            ReportType = Convert.ToInt32(strReportType);
            CustomerId = Convert.ToInt32(LoggedInUser.glCustId);

        }
        else if (strReportType == "0") // No Report Type Selected
        {
        ...
        else
        {
            ...
            int Result = DBOperations.UpdateAdhocReport(Lid, ReportName, ReportFieldId, ReportType, CustomerId, ConditionColumnId, LoggedInUser.glCustUserId);
    ...
    void Fill_ReportTree(int ReportType)
    {
        ...
        CustomerId = Convert.ToInt32(LoggedInUser.glCustId);//Fill TreeView for Customer 
        ...
        ******END Test Comment**************/
        ...
        DataSet dsFieldGroupName = DBOperations.CustGetAdhocReportFieldGroupTest();
        ...
        for (int loop = 0; loop < count; loop++)
        {
             ...
             *******END Test Comment**************/
            /****** New Test Code **************/
            DataSet dsChildNode = DBOperations.GetCustomerReportChildNode(ParentNode[loop, 0]);
    ...
    ***************************************************************/
    ...
    //    if (ReportType == 2) // Customer Report
    //    {
    ...
    //        int IsCustomer = 1;
    //        int Result = DBOperations.AddAdhocReport(strReportName, strReportFieldId, strConditionColumnId, ReportType, CustomerId, IsCustomer, LoggedInUser.glCustUserId);
