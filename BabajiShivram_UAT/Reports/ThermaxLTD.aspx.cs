...
public partial class Reports_ThermaxLTD : System.Web.UI.Page
{
    ...
    private void ExportWorkbook(string header, string contentType)
    {
        ...
        {
            string Report = "Thermax_Report" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
            ...
            if (dtReport.Rows.Count > 0)
            {
                ...
                dtReport.TableName = "Thermax_Report";
                string strFileName = "Thermax_Report.xlsx";
