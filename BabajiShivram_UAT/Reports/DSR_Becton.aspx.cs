...
public partial class Reports_DSR_Becton : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            lblTitle.Text = "DSR BECTON DICKINSON";
        }
    }
    ...
    {
        string strFileName = "DSR_BECTON_DICKINSON_" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
    ...
    private void ExportWorkbook(string header, string contentType)
    {
        ...
        {
            string Report = "DSR_BECTON_DICKINSON" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
            ...
            if (dtReport.Rows.Count > 0)
            {
                ...
                dtReport.TableName = "DSR_BECTON_DICKINSON";
                string strFileName = "DSR_BECTON_DICKINSON.xlsx";
