...
public partial class Reports_ViewAdHocReport : System.Web.UI.Page
{
	...
	string strDeliveryStatus = ddShipmentType.SelectedValue;
        ...
        DataView dvReport = DBOperations.GetAdhocReport(ReportId, DateFrom, DateTo, strDeliveryStatus,strReportFilter, FinYear, LoggedInUser.glUserId);
