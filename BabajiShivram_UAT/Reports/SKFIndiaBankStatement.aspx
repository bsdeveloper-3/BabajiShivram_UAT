<%@ Page Title="Bank Statement" Language="C#" MasterPageFile="~/MasterPage.master" 
    AutoEventWireup="true" CodeFile="SKFIndiaBankStatement.aspx.cs" Inherits="Reports_SKFIndiaBankStatement" Culture="en-GB" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="upPendingchecklist" runat="server" UpdateMode="Conditional" RenderMode="Inline">
        <ContentTemplate>
            ...
            <div class="clear"></div>
            <div class="clear"></div>
            <fieldset><legend>SKF India Bank Statement</legend>
            <div>
            ...
            <div class="clear"></div>
                <asp:GridView ID="gvReport" runat="server" AutoGenerateColumns="False" CssClass="table"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="Opening Date" DataField="Opening Date" />
                        <asp:BoundField HeaderText="Control No" DataField="Control No" />
                        <asp:BoundField HeaderText="Duty Amount" DataField="Duty Amount" />
                        <asp:BoundField HeaderText="Closing Balance" DataField="Closing Balance" />
                        <asp:BoundField HeaderText="Late Filling Penalty Amount" DataField="Late Filling Penalty Amount" />
            ...
            <div>
                <asp:SqlDataSource ID="DataSourceReport" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                 SelectCommand="rptSKFIndiaBankStatement" SelectCommandType="StoredProcedure">
                <SelectParameters>
