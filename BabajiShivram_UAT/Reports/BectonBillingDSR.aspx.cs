...
public partial class Reports_BectonBillingDSR : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            lblTitle.Text = "Becton Billing DSR";
        }
    }
    ...
    {
        string strFileName = "Becton_Billing_DSR" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
    ...
    private void ExportWorkbook(string header, string contentType)
    {
        ...
        {
            string Report = "Becton_Billing_DSR" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
            ...
            if (dtReport.Rows.Count > 0)
            {
                ...
                dtReport.TableName = "Becton_Billing_DSR";
                string strFileName = "Becton_Billing_DSR.xlsx";
