<%@ Page Title="KPI - KAM" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="KPIKAM.aspx.cs" 
    Inherits="Reports_KPIKAM" Culture="en-GB" %>
    ...
    <div>
     ...
     <asp:UpdatePanel ID="upPendingchecklist" runat="server" UpdateMode="Conditional"
        ...
        <ContentTemplate>
            ...
            <div class="clear"></div>
            <fieldset><legend>KAM KPI</legend>    
            <div>
                <div class="fleft">
            ...
            <cc1:TabContainer runat="server" ID="Tabs" ActiveTabIndex="0" CssClass="Tab" Width="100%" AutoPostBack="false">
                ...
                <ContentTemplate>
                <div>
                <asp:GridView ID="gvKAMKPIReport" runat="server" AutoGenerateColumns="True" AllowSorting="true" CssClass="table">
                    <Columns>
                ...
                <cc1:TabPanel ID="TabPanelChart" runat="server" HeaderText="KAM">
                    <ContentTemplate>
                    <div id="divPIE">
                        <asp:Chart ID="KAMKPIChartPIE" Height="300px" Width="800px" runat="server" BorderlineWidth="2" BorderlineColor="ActiveBorder" BorderlineDashStyle="DashDot" 
                            BackSecondaryColor="White" BackGradientStyle="TopBottom" BorderWidth="2px" backcolor="211, 223, 240" BorderColor="#1A3B69">
	                        <Series>
		                        <asp:Series Name="KAMKPI" YValueType="Int32" ChartArea="KAMKPIArea" ChartType="Pie" Color="211, 223, 240"></asp:Series>
	                        </Series>
                            <Titles>
                                <asp:Title Text="Total No of Importer" font="Arial, 12pt, style=Bold, Italic" Name="Sector"></asp:Title>
                            </Titles>
	                        <ChartAreas>
		                        <asp:ChartArea Name="KAMKPIArea">
                                </asp:ChartArea>
                            </ChartAreas>
                            <Legends>
                                <asp:Legend Name="KAMKPILegends" BorderColor="Green" BorderDashStyle="Solid"></asp:Legend>
                            </Legends>
                        </asp:Chart>
                    </div>
                    
                    <div style="overflow:scroll;">
                    <cc1:BarChart ID="BarChart1" runat="server" ChartHeight="300" ChartWidth="3500"
                        ChartType="Column" ChartTitleColor="#0E426C"  
                        CategoryAxisLineColor="#D08AD9" ValueAxisLineColor="#D08AD9" BaseLineColor="#A156AB">
                    </cc1:BarChart>
                    </div>
                    <div style="overflow:scroll;">
                    <cc1:BarChart ID="BarChart2" runat="server" ChartHeight="300" ChartWidth = "1500"
        ...
        <asp:SqlDataSource ID="DataSourceKAMKPI" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
            SelectCommandType="StoredProcedure" SelectCommand="rptkpiKAM" DataSourceMode="DataSet">
            <SelectParameters>
