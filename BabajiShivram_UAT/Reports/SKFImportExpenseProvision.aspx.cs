...
public partial class Reports_SKFImportExpenseProvision : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            lblTitle.Text = "SKF India Import Expense Provision";
        }
    ...
    {
        string strFileName = "SKF_India_Import_Expense_Provision" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
    ...
    private void ExportWorkbook(string header, string contentType)
    {
        ...
        {
            string Report = "SKF_India_Import_Expense_Provision" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
            ...
            if (dtReport.Rows.Count > 0)
            {
                ...
                dtReport.TableName = "SKF_India_Import_Expense_Provision";
                string strFileName = "SKF_India_Import_Expense_Provision.xlsx";
