<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="MISPortPending.aspx.cs" 
        Inherits="Reports_MISPortPending" Title="Port - Clearance Pending" EnableEventValidation="false" Culture="en-GB"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <asp:UpdatePanel ID="upPendingchecklist" runat="server" UpdateMode="Conditional" RenderMode="Inline">
    ...
    <div class="clear"></div>
        <fieldset>
        <legend>Port - Under Clearance</legend>    
    ...
    <asp:GridView ID="gvPortJobDetail" runat="server" AutoGenerateColumns="False" CssClass="table" AllowSorting="true" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="JobUser" HeaderText="Job User" SortExpression="JobUser"/>
            <asp:BoundField DataField="CreatedDate" HeaderText="Job Date" SortExpression="CreatedDate" DataFormatString="{0:dd/MM/yyyy}"/>
        </Columns>
        <PagerTemplate>
    ...
    <div>
        <asp:SqlDataSource ID="PortJobDetailSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
             SelectCommand="ds_PortwisePendingDetail" SelectCommandType="StoredProcedure">
            <SelectParameters>
