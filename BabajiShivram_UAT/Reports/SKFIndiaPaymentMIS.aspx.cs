...
public partial class Reports_SKFIndiaPaymentMIS_ : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            lblTitle.Text = "SKF India Payment LOT MIS ";
        }
    ...
    {
        string strFileName = "SKF_India_Payment_LOT_MIS" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
    ...
    private void ExportWorkbook(string header, string contentType)
    {
        ...
        {
            string Report = "SKF_India_Payment_LOT_MIS" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
            ...
            if (dtReport.Rows.Count > 0)
            {
                ...
                dtReport.TableName = "SKF_India_Payment_LOT_MIS";
                string strFileName = "SKF_India_Payment_LOT_MIS.xlsx";
