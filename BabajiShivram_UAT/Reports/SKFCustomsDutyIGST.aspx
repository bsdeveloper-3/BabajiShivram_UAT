<%@ Page Title="Duty IGST" Language="C#" MasterPageFile ="~/MasterPage.master"
    AutoEventWireup="true" CodeFile="SKFCustomsDutyIGST.aspx.cs" Inherits="Reports_SKFCustomsDutyIGST"  Culture="en-GB"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="upPendingchecklist" runat="server" UpdateMode="Conditional" RenderMode="Inline">
        <ContentTemplate>
            ...
            <div class="clear"></div>
            <div class="clear"></div>
            <fieldset><legend>SKF India Customs Duty IGST</legend>
            <div>
            ...
            <div class="clear"></div>
                <asp:GridView ID="gvReport" runat="server" AutoGenerateColumns="False" CssClass="table"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="HSN Code" DataField="HSN Code" />
                        <asp:BoundField HeaderText="Assessable Value" DataField="Assessable Value" />
                        <asp:BoundField HeaderText="Duty rate" DataField="Duty rate" />
            ...
            <div>
                <asp:SqlDataSource ID="DataSourceReport" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                 SelectCommand="rptSKFIndiaIGST" SelectCommandType="StoredProcedure">
                <SelectParameters>
