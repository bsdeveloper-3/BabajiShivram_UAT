...
public partial class Reports_SKFIndiaBankDoc : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (Pagename == "Tech")
            {
                ...
                lblTitle.Text = "SKF Technology Bank Doc";
                lblLegend.Text = "SKF Technology Bank Doc";
            }
            else
            {
                Session["CustId"] = "1322";
                Label lblTitle = (Label)Page.Master.FindControl("lblTitle");
                lblTitle.Text = "SKF India Bank Doc";
                lblLegend.Text = "SKF India Bank Doc";
            }
    ...
    {
        string strFileName = "SKF_India_Bank_Doc" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
    ...
    private void ExportWorkbook(string header, string contentType)
    {
        ...
        {
            string Report = "SKF_India_Bank_Doc" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
            ...
            if (dtReport.Rows.Count > 0)
            {
                ...
                dtReport.TableName = "SKF_India_Bank_Doc";
                string strFileName = "SKF_India_Bank_Doc.xlsx";
