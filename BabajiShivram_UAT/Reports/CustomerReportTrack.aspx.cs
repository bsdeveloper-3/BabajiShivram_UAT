...
public partial class Reports_CustomerReportTrack : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DataFilter1.FilterSessionID = "CustomerReportTrack.aspx";
    ...
    protected void gvReportMS_RowCommand(Object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName.ToLower() == "generatereport")
        {
            ...
            Response.Redirect("ViewAdHocCustomerReport.aspx");
        }
        if (e.CommandName.ToLower() == "edit")
        {
            ...
            Session["Lid"] = Id.Text;
            Response.Redirect("AdHocCustomerReport.aspx");
        }
