...
public partial class Reports_SKFDSR : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (Pagename == "Tech")
            {
                ...
                lblTitle.Text = "SKF Technology DSR";
                lblLegend.Text = "SKF Technology DSR";
            }
            else
            {
                Session["CustId"] = "1322";
                Label lblTitle = (Label)Page.Master.FindControl("lblTitle");
                lblTitle.Text = "SKF India DSR";
                lblLegend.Text = "SKF India DSR";
            }
    ...
    {
        string strFileName = "SKF_India_DSR" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
    ...
    private void ExportWorkbook(string header, string contentType)
    {
        ...
        {
            string Report = "SKF_India_DSR" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
            ...
            if (dtReport.Rows.Count > 0)
            {
                ...
                dtReport.TableName = "SKF_India_DSR";
                string strFileName = "SKF_India_DSR.xlsx";
