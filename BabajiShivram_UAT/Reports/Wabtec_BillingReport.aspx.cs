...
public partial class Reports_Wabtec_BillingReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            //int startMonthOfCurrentQuarter = currentMonth;
            //if (currentMonth <= 3)
            //{
            //    startMonthOfCurrentQuarter = 1;
            //}
            //else if (currentMonth <= 6)
            //{
            //    startMonthOfCurrentQuarter = 4;
            //}
            //else if (currentMonth <= 9)
            //{
            //    startMonthOfCurrentQuarter = 7;
            //}
            //else
            //{
            //    startMonthOfCurrentQuarter = 10;
            //}

            //DateTime currentQuarterStartDate = new DateTime(currentDate.Year, startMonthOfCurrentQuarter, 1);
            //string formattedDate = currentQuarterStartDate.ToString("dd-MMM-yyyy");
            //txtFromDate.Text = DateTime.Now.ToString("dd-MMM-yyyy"); //formattedDate;// "01-APR-2023";//DateTime.Now.ToString("dd/MM/yyyy");
            //txtToDate.Text = DateTime.Now.ToString("dd-MMM-yyyy");

            //txtFromDate.Text = "01-APR-2025";//DateTime.Now.ToString("dd/MM/yyyy");
            //txtToDate.Text = DateTime.Now.ToString("dd-MMM-yyyy");
