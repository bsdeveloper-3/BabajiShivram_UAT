...
public partial class Service_CancelledJob : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ScriptManager1.RegisterPostBackControl(lnkexport);
        Label lblTitle = (Label)Page.Master.FindControl("lblTitle");
        lblTitle.Text = "Cancelled Job";
        if (!IsPostBack)
        {
        ...
        DataFilter1.DataSource = CancelledJobDataSource;
        DataFilter1.DataColumns = gvJobDetail.Columns;
        DataFilter1.FilterSessionID = "MiscCancelledJob.aspx";
    ...
    protected void gvJobDetail_RowCommand(Object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName.ToLower() == "select")
        {
            ...
            Response.Redirect("MiscCancelledJobDetail.aspx");
    ...
    void DataFilter1_OnDataBound()
    {
        try
        {
            DataFilter1.FilterSessionID = "MiscCancelledJobDetail.aspx";
    ...
    {
        string strFileName = "Misc_CancelledJobDetail_" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
