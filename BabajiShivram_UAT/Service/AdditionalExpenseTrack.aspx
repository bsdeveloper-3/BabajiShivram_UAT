<%@ Page Title="Additional Expense Track" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
        CodeFile="AdditionalExpenseTrack.aspx.cs" Inherits="Service_AdditionalExpenseTrack" EnableEventValidation="false" Culture="en-GB"%>
    ...
    <cc1:ToolkitScriptManager runat="server" ID="ScriptManager1" ScriptMode="Release" />    
        ...
        <fieldset Class="fieldset-AutoWidth"><legend>Search</legend>
           ...
           <br />
            ...
            <asp:Button ID="btnView" runat="server" Text="View Additional Posting" />
        </div>
        </fieldset>
        <fieldset><legend runat="server">Track Expense Posting - Additional
        ...
        <div id="divDatasorce">
            <asp:SqlDataSource ID="ExpenseSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                SelectCommand="GetFAPostingAdditional" SelectCommandType="StoredProcedure">
                <SelectParameters>
