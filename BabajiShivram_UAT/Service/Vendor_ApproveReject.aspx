<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Vendor_ApproveReject.aspx.cs" Inherits="Service_Vendor_ApproveReject"
 ...
 <%--   <asp:UpdatePanel ID="upnlVendorApproval" runat="server">--%>
        <ContentTemplate>
            <div align="center">
                ...
                <fieldset>
                    <legend>Vendor Approval</legend>                   
                     <div style="text-align: left;">
                     <asp:Button ID="btnApprove" Text="Approve" runat="server" ValidationGroup="Required" Height="25px" Width="80px" OnClick="btnApprove_Click" />
                    <asp:Button ID="btnReject" Text="Reject" runat="server" ValidationGroup="Required" Height="25px" Width="80px" OnClick="btnReject_Click" />

                      <asp:Button ID="btnback" Text="Back" runat="server" CausesValidation="false" ValidationGroup="Required" Height="25px" Width="80px" OnClick="btnback_Click" />       <%-- --%>
                    </div>
                     <br />
                     <table bgcolor="white" border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td style="width: 175px">Remark <asp:RequiredFieldValidator ID="RFV05" runat="server" ControlToValidate="txtremark" Text="*"
                            ...
                            <td>
                                <asp:TextBox ID="txtremark" runat="server" TextMode="MultiLine"  Width="550px"></asp:TextBox></td>
                             </tr>
                         <tr>
                            <td>
                                Company Code
                            <asp:RequiredFieldValidator ID="RFVCODE" runat="server" ControlToValidate="txtcompanycode" Text="*"
                            SetFocusOnError="true"  Display="Dynamic"  ErrorMessage="Please Enter Company Code" ValidationGroup="Required"></asp:RequiredFieldValidator>
                            </td>
                            <td>
                            <asp:TextBox ID="txtcompanycode" runat="server" Width="200px"></asp:TextBox></td>
                        </tr>
                        </table> 
                    <fieldset>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="white">
                ...
                <tr>
                    ...
                    <fieldset>
                    <legend>Vendor Approve History</legend>
                    ...
                    <SelectParameters>
                        <asp:SessionParameter Name="VendorKYCID" SessionField="KYCAPRID" />
                    </SelectParameters>
                    </asp:SqlDataSource>
