...
using System.Data;
using System.Text;
public partial class Service_LabourExpense : System.Web.UI.Page
{
    ...
    protected void btnApproveJob_OnClick(object sender, EventArgs e)
    {
        ...
        { 
            if (lblRemark1.Text.Trim() != "")
            {
                ...
                if (JobId > 0)
                {
                    int ApprovedJobExp = AccountExpense.ApproveLabourExpByJobID(JobId, strSytemRef, dtExpenseDate, 1, lblRemark1.Text.Trim(), LoggedInUser.glUserId);
    ...
    protected void btnPostAll_Click(object sender, EventArgs e)
    {
        ...
        // Not Required - Posting Exeis running from Sql Agenet Job
        //int ExeResult = AccountExpense.FAPostLabourExp();
            ...
            foreach (GridViewRow gvr1 in gvDetail.Rows)
            {
                if (gvr1.RowType == DataControlRowType.DataRow)
                {
                    ...
                    if (chk1.Checked)
                    {
                        ...
                        int ApprovedJobExp = AccountExpense.ApproveLabourExpByJobID(JobID, strSystemRefNo, dtExpenseDate, 1, lblRemark1.Text.Trim(), LoggedInUser.glUserId);
