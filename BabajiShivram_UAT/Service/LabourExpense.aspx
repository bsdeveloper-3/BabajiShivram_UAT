<%@ Page Title="A Labour Expense" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeFile="LabourExpense.aspx.cs" Inherits="Service_LabourExpense" EnableEventValidation="false" Culture="en-GB" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <cc1:ToolkitScriptManager runat="server" ID="ScriptManager1" ScriptMode="Release" />    
        ...
        <fieldset><legend>Expense Posting - A Labour</legend>
        <div>
            <asp:Button ID="btnPostAll" runat="server" Text="Post All Expense" OnClick="btnPostAll_Click" />
