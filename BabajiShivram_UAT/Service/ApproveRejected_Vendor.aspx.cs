...
public partial class Service_ApproveRejected_Vendor : System.Web.UI.Page
{
    ...
    {
        DataSet VnDetail = DBOperations.GetRejectedVendorDetails(lId);
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        string CompanyName = "", ContactPerson = "", LegalName = "", TradeName = "", Address = "", Email = "", GSTN = "", Location = "", Division = "",
              ...
              , Country = "", State = "", City = "", Pincode = "", strRemark = "", AccountNo = "";
        ...
        var GSTRegTypeName = Convert.ToInt32(((DropDownList)RejectedDetails.FindControl("ddlGSTRegType")).SelectedValue);
        ...
        TypeOfAccount = txtTypeOfAccount.Text.Trim();
        ...
        int result = VendorKYCOps.UpdateRejectedVendor(VendorKycId, ContactNo, OfficeTeliphone, CreditDays, GSTRegType, CompanyName, Vendor, ContactPerson, LegalName, TradeName, Address,
    ...
    //    if (ddlGSTRegType.SelectedItem.Text == "Registered" || ddlGSTRegType.SelectedValue == "SEZ")
    //    {
