        ...
        <ContentTemplate>
            <div align="center">
                ...
                <asp:Label ID="lblreject" runat="server" EnableViewState="false" CssClass="errorMsg"></asp:Label>
                  ...
                  <asp:HiddenField ID="hdngsttype" runat="server" />
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="white">
                                            ...
                                            <tr>
                                             ...
                                             <asp:DropDownList ID="ddlGSTRegType" runat="server" ><%-- AutoPostBack="true" OnSelectedIndexChanged="ddlGSTRegType_SelectedIndexChanged"--%>
                                                 ...
                                                 <asp:HiddenField ID="hdngsttype" runat="server" Value='<%#Eval("GSTRegTypeName") %>' />
                                             </td>
                                          ...
                                          <td>
                                              <asp:TextBox ID="txtPanNo" Text='<%# Bind("PanNo") %>' runat="server" MaxLength="15" Width="200"/>
                                          </td>                                       
                                      </tr>                                         
                                            <tr>
                                                  <td>HOD Name
                                          ...
                                          <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>Account Type</td>
                                            <td>
                                                <asp:TextBox ID="txtTypeOfAccount" Text='<%# Bind("AccountType") %>' runat="server" MaxLength="100" Width="200"/>
                                            </td>
                                            </tr>
                                            <tr>
                                                <td>IFSCCode
