...
public partial class Service_BranchExpense : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblTitle.Text = "Branch Maintenance Expense";
        //
        if (!IsPostBack)
        {
            Session["BrMaintainId"] = null;
        ...
        DataFilter1.FilterSessionID = "BranchExpense.aspx";
    ...
    protected void gvMaintenance_RowUpdating(Object sender, GridViewUpdateEventArgs e)
    {
        try
        {
            ...
            decimal.TryParse(txtAmount.Text.Trim(), out decPaidAmount);

            if (ddCategory.SelectedValue != "0" && txtExpenseDisc.Text.Trim() != "" && decPaidAmount > 0)
            {
    ...
    protected void gvMaintenance_RowCommand(Object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            Session["BrMaintainId"] = e.CommandArgument.ToString();
            Response.Redirect("EditBranchMaintenance.aspx");
        }
    }
    protected void btnPrintVoucher_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                MaintenanceId = Convert.ToInt32(txtRefNo.Text.ToUpper().Replace("AE", ""));
                
                DataSet dsApprovedExpense = DBOperations.GetWorkExpenseBranch(MaintenanceId);
                ...
                {
                    lblError.Text = "Maintenance Detail Not Found!";
                    lblError.CssClass = "errorMsg";
                }
            }
            else
    ...
    private void GenerateVoucherPDFSingle(int MaintenanceId, DataSet dsApprovedExpense)
    {
        ...
        if (dsApprovedExpense.Tables[0].Rows.Count > 0)
        {
            ...
            string BranchName = ""; string VehicleType = ""; string VehicleCompany = "NA";
            ...
            BranchID = Convert.ToInt32(dsApprovedExpense.Tables[0].Rows[0]["BranchID"]);
            BranchName = dsApprovedExpense.Tables[0].Rows[0]["BranchName"].ToString();

            VehicleCompany = dsApprovedExpense.Tables[0].Rows[0]["BranchName"].ToString();
            ...
            try
            {
                ...
                PdfWriterEvents writerEvent = new PdfWriterEvents(BranchName);
                ...
                string contents = "";
                contents = File.ReadAllText(Server.MapPath("PrintVoucherBranch.htm"));
                ...
                contents = contents.Replace("[BranchName]", BranchName);
                ...
                #region Add Branch Expense History
                
                // Get Branch Expense For Current Year
                ...
                DataSet dsVehicleExpense = DBOperations.GetBranchExpepsneByDate(MaintenanceId, BranchID, ExpStartDate, ExpEndDate);
    ...
    {
        string strFileName = "Branch_Maintenance_Expense_" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
    ...
    private void ExportFunction(string header, string contentType)
    {
        ...
        gvMaintenance.Caption = "Branch Expense Details - " + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt");
