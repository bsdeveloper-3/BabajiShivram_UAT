...
public partial class Service_MiscCancelledJobDetail : System.Web.UI.Page
{
    ...
    //{
    //    ScriptManager1.RegisterPostBackControl(gVCancelstatus);
    //    ScriptManager1.RegisterPostBackControl(gVJobActivity);
    //    // ScriptManager1.RegisterPostBackControl(GridViewDocument);


    //    Label lblTitle = (Label)Page.Master.FindControl("lblTitle");
    //    lblTitle.Text = "Cancelled Job Detail";
    ...
    //    // Canceled Job Detail
    //    DataSet dsJobDetail = JobOperation.GetMiscCancelJobDetail(JobId);
    ...
    //    Response.Redirect("MiscCancelledJob.aspx");
    //}
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Label lblTitle = (Label)Page.Master.FindControl("lblTitle");
        lblTitle.Text = " Cancel Job Detail";
