            ...
            <legend>New Vendor Entry</legend>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="white">
                    ...
                    <tr>
                                ...
                                <td>
                                 Mobile No
                                        <%--<asp:RequiredFieldValidator ID="RFVTelephone" runat="server" InitialValue="" ControlToValidate="txtOfficeTelephone" SetFocusOnError="true"
                                            Text="*"  ErrorMessage="Please Enter Mobile No" Display="Dynamic"  ValidationGroup="Required"></asp:RequiredFieldValidator>--%>
                                    </td>
                                    <td>
                    ...
                    <tr>
                                ...
                                <td>
                                    Contact No
                                     <asp:RequiredFieldValidator ID="RFVContact" runat="server" InitialValue="" ControlToValidate="txtContactNo" SetFocusOnError="true"
                                ...
                                <asp:RegularExpressionValidator   ID="RFVContactNo"  runat="server" ControlToValidate="txtContactNo" 
                                   ErrorMessage="Contact No.must be 10-digit numeric code." ForeColor="Red"  ValidationExpression="^\d{10}$" ValidationGroup="Required" Display="Dynamic">
                    ...
                    <tr>
                                   ...
                                   <td>
                                      ...
                                      <asp:RegularExpressionValidator   ID="RFVcreditDays"  runat="server" ControlToValidate="txtCrDays" 
                                        ErrorMessage="Credit Days Maximum 3-digit numeric code." ForeColor="Red"  ValidationExpression="^\d{1,3}$"
                    ...
                    <tr>
                            ...
                            <td>
                               ...
                               <%--    <asp:RegularExpressionValidator   ID="RegularExpressionValidator1"  runat="server" ControlToValidate="txtAcctNo" 
                                  ErrorMessage="Account No Should be numeric code." ForeColor="Red"  ValidationExpression="^\d{10}$" ValidationGroup="Required" Display="Dynamic">
                                 </asp:RegularExpressionValidator>--%>
                            </td>
                            <td>
                    ...
                    <tr>
                        ...
                        <tr>
                            ...
                            <td>
                            <asp:TextBox ID="txtRemark" runat="server" MaxLength="200" TextMode="MultiLine" Columns="3" Width="300px"></asp:TextBox>
                            </td>
                        </tr>
