<%@ Page Title="Cancelled Job Detail" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="MiscCancelledJobDetail.aspx.cs" Inherits="Service_MiscCancelledJobDetail" %>
                    ...
                    <ContentTemplate>
                        ...
                        <fieldset>
                            ...
                            <asp:FormView ID="FVJobDetail" HeaderStyle-Font-Bold="true" runat="server" DataKeyNames="JobId"
                                ...
                                <ItemTemplate>
                                    <div class="m clear">
                                        <asp:Button ID="btnCancelJob" runat="server" OnClick="btnCancelJob_Click" Text="Cancel Job" ValidationGroup="RequiredJobCancel" enas/>
                ...
                <AjaxToolkit:TabPanel runat="server" ID="TabPanelDailyActivity" HeaderText="Activity">
                    <ContentTemplate>
                        ...
                        <asp:SqlDataSource ID="SqlDataSourceStatusMS" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                            SelectCommand="MS_GetJobStatusMS" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                    </ContentTemplate>
                </AjaxToolkit:TabPanel>
            ...
            <AjaxToolkit:TabContainer runat="server" ID="Tabs" ActiveTabIndex="0" CssClass="Tab"
                    ...
                    <ContentTemplate>
                        ...
                        <fieldset>
                            ...
                            <asp:FormView ID="FVJobDetail" HeaderStyle-Font-Bold="true" runat="server" DataKeyNames="JobId"
                                ...
                                <ItemTemplate>
                                    <div class="m clear">
                                        <asp:Button ID="btnCancelJob" runat="server" OnClick="btnCancelJob_Click" Text="Cancel Job" ValidationGroup="RequiredJobCancel" Visible="false" />
                                          <%-- OnClientClick="return confirm('Sure to Cancel Job Detail? All Job related detail will be removed from system.');"--%>   
                                        <asp:Button ID="btnBackButton" runat="server" OnClick="btnBackButton_Click" Text="Back"  />
                                    </div>
                                    <%--Remark for Job Cancelation--%>
                ...
                <AjaxToolkit:TabPanel ID="TabPanelStatus" runat="server" HeaderText="Status">
                    <ContentTemplate>
                        <fieldset class="fieldset-AutoWidth">
                            ...
                            <div>
                                Status For
                            <asp:DropDownList ID="ddChangeStatus" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddChangeStatus_SelectedIndexChanged" Enabled="false">
                                <asp:ListItem Text="-Select-" Value=""></asp:ListItem>
                                <asp:ListItem Text="Cleared" Value="16"></asp:ListItem>
                                <asp:ListItem Text="File Sent to Billing" Value="11"></asp:ListItem>
                              </asp:DropDownList>
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:Button ID="btnUpdateStatusAdHoc" runat="server" OnClick="btnUpdateStatusAdHoc_Click" Text="Update Status" Visible="false" />
                            </div>
                        </fieldset>
                    </ContentTemplate>
                </AjaxToolkit:TabPanel>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="white">
                                <tr>
                                    ...
                                    <td>
                                        <asp:FileUpload ID="fuDocument" runat="server" /> &nbsp;&nbsp;
                                        <asp:Button ID="btnUpload" runat="server"
                                          OnClick="btnUpload_Click"  Text="Upload Document" visible="false" />
                                    </td>
                                    </tr>
                            </table>
                        </fieldset>
                ...
                <AjaxToolkit:TabPanel runat="server" ID="TabPanelDailyActivity" HeaderText="Activity">
                    <ContentTemplate>
                        ...
                        <%--<fieldset >--%>
                        <fieldset runat="server" id="fieldsetJobActivity" visible="false" ><%--visible="false"--%>
                            <legend>Add Job Activity</legend>
                            <div class="m clear">
                                <asp:Button ID="btnSaveDailyActivity" runat="server" ValidationGroup="RequiredActivity" OnClick="btnSaveDailyActivity_Click" visible="false"
                                    Text="Save" />
                                <asp:Button ID="btnCancel" Text="Cancel" runat="server" CausesValidation="false" OnClick="btnCancel_OnClick" TabIndex="6"  Visible="false" />
                                <asp:HiddenField ID="hdnActivityID" runat="server" Value="0" />
                            </div>
