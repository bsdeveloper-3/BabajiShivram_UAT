...
using System.IO;
public partial class BSCCPLTransport_PendingTransPaymentAPI : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            lblTitle.Text = "BSCCPL - Transporter Payment";
        ...
        DataFilter1.FilterSessionID = "PendingTransPaymentAPIBT.aspx";
    ...
    protected void gvDetail_RowCommand(Object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName.ToLower() == "select")
        {
            ...
            Response.Redirect("TransPaymentAPIBT.aspx"); ;
        }
