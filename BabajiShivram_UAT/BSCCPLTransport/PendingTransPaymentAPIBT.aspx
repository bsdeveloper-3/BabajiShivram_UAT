<%@ Page Title="BSCCPL - Pending Payment" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeFile="PendingTransPaymentAPIBT.aspx.cs" Inherits="BSCCPLTransport_PendingTransPaymentAPI" EnableEventValidation="false" %>
    ...
    <div>
        ...
        <asp:UpdatePanel ID="upFillDetails" runat="server" UpdateMode="Conditional">
            ...
            <asp:Panel ID="pnlFilter" runat="server">
                ...
                <div class="fleft" style="margin-left:30px; padding-top:3px;">
                <asp:Button ID="btnBatchPayment" runat="server" Text="Initiate Bach Payment" OnClick="btnBatchPayment_Click"
                    OnClientClick="return confirm('Sure to Initate Batch Payment for Selected Invoices??');" />
                </div>
            </asp:Panel>
            </div>
