...
public partial class BSCCPLTransport_TransPaymentAPI : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblTitle.Text = "Babaji - Transporter Payment";

        if (Session["TransPayId"] == null)
        {
            Response.Redirect("PendingTransPaymentAPIBT.aspx");
        }
        if (LoggedInUser.glUserId == 1 || LoggedInUser.glUserId == 3 || LoggedInUser.glUserId == 926 || LoggedInUser.glUserId == 1023 || LoggedInUser.glUserId == 13478)
        {
        }
        else
        {
    ...
    protected void btnSavePayment_Click(object sender, EventArgs e)
    {
        if (GridViewVehicle.Rows.Count == 0)
        {
            lblError.Text = "Vehicle Rate Details Not Available!!";
            lblError.CssClass = "errorMsg";
            return;
        }
    ...
    private string LiveTransportFund(int PaymentId)
    {
        ...
        if (isValidRequest == true)
        {
            ...
            objDebtorAccount.Identification = "061863700000570";
            objDebtorAccount.SecondaryIdentification = "8633756";
            ...
            int APITransactionResult = AccountExpense.AddTransBankPaymentAPIRequest(1, PaymentId, objInitiation.InstructionIdentification, objInstructedAmount.Amount, objInstructedAmount.Currency,
