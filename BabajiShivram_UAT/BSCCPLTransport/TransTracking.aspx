<%@ Page Title="Babaji Transport Tracking" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeFile="TransTracking.aspx.cs" Inherits="AccountTransport_TransTracking" EnableEventValidation="false" Culture="en-GB"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <cc1:ToolkitScriptManager runat="server" ID="ScriptManager1" ScriptMode="Release" />
        ...
        <fieldset><legend>BABAJI - Transporter Payment Request</legend>
        <div class="clear">
        ...
        <asp:GridView ID="gvDetail" runat="server" AutoGenerateColumns="False" CssClass="table" DataKeyNames="RequestId"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="PaymentRequiredDate" HeaderText="Pay Rqred Date" SortExpression="PaymentRequiredDate" DataFormatString="{0:dd/MM/yyyy}" />
                <asp:BoundField DataField="Amount" HeaderText="Total Value" SortExpression="TotalAmount" />
                <asp:BoundField DataField="NetPayable" HeaderText="Net Payable" SortExpression="NetPayable" />
                <asp:BoundField DataField="ToPay" HeaderText="Paid Amount" SortExpression="ToPay" />
                <asp:BoundField DataField="AdvanceAmt" HeaderText="Advance" SortExpression="AdvanceAmt" />
                ...
                <asp:BoundField DataField="updDate" HeaderText="Last Update" SortExpression="updDate" DataFormatString="{0:dd/MM/yyyy}"/>
            </Columns>
            <PagerTemplate>
        ...
        <div>
            <asp:SqlDataSource ID="InvoiceSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                SelectCommand="TRS_GetInvoiceForTracking" SelectCommandType="StoredProcedure">
                <SelectParameters>
