<%@ Page Title="BSCCPL Transporter Payment" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="TransPayment.aspx.cs" 
    Inherits="BSCCPLTransport_TransPayment" Culture="en-GB"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <ContentTemplate>
        <div>
                ...
                <fieldset>
                    <legend>BSCCPL - Payment Confirmation</legend>
                    ...
                    <tr>
                        <td>
                            ...
                            <asp:Button ID="btnPayFrom" Text="Move To Bank Transfer" OnClick="btnPayFrom_Click" ValidationGroup="Required" OnClientClick="return confirm('Are you sure to Move To API Payment Tab?')" runat="server" />
                        </td>
                    </tr>
                    </table>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <cc1:MaskedEditValidator ID="MskEdtValInstrumentDate" ControlExtender="MskEdtInstrumentDate" ControlToValidate="txtInstrumentDate" IsValidEmpty="false"
                                    ...
                                    MaximumValue='<%#DateTime.Now.ToString("dd/MM/yyyy") %>' MinimumValue='01/01/2022'
                        ...
                        <tr>
                            <td>
                                ...
                                <%--<asp:RequiredFieldValidator ID="RFVDocument" runat="server" ValidationGroup="RequiredPay" InitialValue=""
                                     ControlToValidate="fileUploadPaymentDocument" Text="Required"  SetFocusOnError="true"></asp:RequiredFieldValidator>--%>
                            </td>
                            <td>
