<%@ Page Title="BSCCPL - Pending Payment" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeFile="PendingTransPaymentAPI.aspx.cs" Inherits="AccountTransport_PendingTransPaymentAPI" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div>
        ...
        <asp:UpdatePanel ID="upFillDetails" runat="server" UpdateMode="Conditional">
            ...
            <fieldset><legend>BSCCPL - Transporter Payment</legend>
            <div class="clear">
            <asp:Panel ID="pnlFilter" runat="server">
                ...
                <div class="fleft" style="margin-left:30px; padding-top:3px;">
                <asp:Button ID="btnBatchPayment" runat="server" Text="Initiate Bach Payment" OnClick="btnBatchPayment_Click" OnClientClick="return confirm('Sure to Initate Batch Payment for Selected Invoices??');" />
                </div>
            </asp:Panel>
            </div>
        ...
        <div>
            <asp:SqlDataSource ID="InvoiceSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                SelectCommand="TRS_GetPendingInvoiceForPayAPI" SelectCommandType="StoredProcedure">
