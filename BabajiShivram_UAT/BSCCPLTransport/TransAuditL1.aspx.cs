...
public partial class BSCCPLTransport_TransAuditL1 : System.Web.UI.Page
{
    ...
    protected void ddBabajiBankAccount_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            //if (BankId == 47 && BankAccountID == 163) // Yes Bank NAVBHARAT Account
            //{
            //    rblFundTransferFromLiveTracking.Enabled = true;
            //}

            if (BankId == 47 && BankAccountID == 159) // Yes Bank Mumbai Account
            {
                rblFundTransferFromLiveTracking.Enabled = true;
            }
            else
