...
public partial class ExportReports_ViewExAdHocReport : System.Web.UI.Page
{
    ...
    protected void btnShowReport_Click(object sender, EventArgs e)
    {
        ...
        lblViewValue.Text = strReportFilter;

        DataView dvReport = EXOperations.EX_GetAdhocReport(ReportId, DateFrom, DateTo, strDeliveryStatus, strReportFilter, FinYear, LoggedInUser.glUserId);
    ...
    /* Test Comment
    private List<Control> CreateCustomAttributeUI(int FieldId, FieldDataType DataTypeId, string FieldName)
    {
        ...
        switch (DataTypeId)
        {
            case FieldDataType.Alphanumeric:
                ...
                Ctrls.Add(tbBox);
                //add RequiredFieldValidator
                Ctrls.Add(CreateRequiredFieldValidator(FieldId.ToString(), "Please Enter "+ FieldName +"", ""));
            ...
            case FieldDataType.Date:
                ...
                Ctrls.Add(calDate);
                //Add  a RequiredFieldvalidator
                Ctrls.Add(CreateRequiredFieldValidator(FieldId.ToString(), "Please Select "+FieldName +" "+"From"+"", ""));
                // Add a Date CompareValidator
                ...
                Ctrls.Add(calDateTo);
                //Add  a RequiredFieldvalidator
                Ctrls.Add(CreateRequiredFieldValidator(tbBoxDateTo.ID.ToString(), "Please Select "+FieldName+" "+"To"+"", ""));
                // Add a Date CompareValidator
                Ctrls.Add(CreateDataTypeCheckCompareValidator(tbBoxDateTo.ID, ValidationDataType.Date, "Invalid date value."));
                break;
            case FieldDataType.Percent:
                // use a  Text Box
