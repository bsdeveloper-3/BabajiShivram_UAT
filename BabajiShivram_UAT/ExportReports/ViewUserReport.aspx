<%@ Page Title="BS Group User Report" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ViewUserReport.aspx.cs"
    Inherits="ExportReports_ViewUserReport" EnableEventValidation="false" Culture="en-GB" %>
        ...
        <ContentTemplate>
            ...
            <div>
                <asp:SqlDataSource ID="ViewReportSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                    SelectCommand="GetAdhocReport" SelectCommandType="StoredProcedure" DeleteCommand="DelAdHocReport"
                    DeleteCommandType="StoredProcedure" OnDeleted="DataSourceReport_Deleted">
                    <SelectParameters>
                        <asp:SessionParameter Name="UserId" SessionField="UserId" />
                        <asp:ControlParameter ControlID="chkCustomer" Name="IsCustomer" PropertyName="Checked" />
                    </SelectParameters>
                    <DeleteParameters>
