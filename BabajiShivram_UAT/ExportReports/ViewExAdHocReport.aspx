<%@ Page Title="View User Report" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ViewExAdHocReport.aspx.cs"
    Inherits="ExportReports_ViewExAdHocReport" Culture="en-GB" EnableEventValidation="false" %>
    ...
    <div>
        ...
        <div class="m clear">
            <fieldset>
                ...
                <asp:Label ID="lblViewValue" runat="server" Visible="true"></asp:Label>
                <p>
