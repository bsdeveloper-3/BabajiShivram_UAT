...
public partial class ExportReports_UserReport : System.Web.UI.Page
{
    ...
    void Fill_ReportTree(int ReportType)
    {
        ...
        for (int loop = 0; loop < count; loop++)
        {
            ...
            DataSet dsChildNode = EXOperations.EX_GetAdhocReportChildNodeTest(ParentNode[loop, 0], ReportType, CustomerId);
