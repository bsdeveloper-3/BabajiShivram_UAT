<%@ Page Title="MIS Port Detail" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="MISPortDetail.aspx.cs"
    Inherits="ExportReports_MISPortDetail" EnableEventValidation="false" Culture="en-GB" %>
        ...
        <ContentTemplate>
            ...
            <div>
                <asp:SqlDataSource ID="PortJobDetailSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                    SelectCommand="EX_rptPortWsJobDetail" SelectCommandType="StoredProcedure">
                    <SelectParameters>
