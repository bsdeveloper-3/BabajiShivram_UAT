...
public partial class ExportReports_ViewUserReport : System.Web.UI.Page
{
    ...
    protected void gvReportMS_RowCommand(Object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName.ToLower() == "generatereport")
        {
            ...
            Response.Redirect("ViewExAdHocReport.aspx");
        }
        if (e.CommandName.ToLower() == "edit")
        {
            ...
            Session["Lid"] = Id.Text;
            Response.Redirect("../ExportReports/UserReport.aspx");
        }
