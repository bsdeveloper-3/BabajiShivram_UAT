<%@ Page Title="Quotations" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SavedQuotation.aspx.cs"
    Inherits="Quotation_SavedQuotation" Culture="en-GB" EnableEventValidation="false" %>
                        ...
                        <asp:TemplateField HeaderText="Status" SortExpression="ApprovalStatus">
                            <ItemTemplate>
                                <asp:LinkButton ID="lblStatus" runat="server" Text='<%# Eval("ApprovalStatus") %>' CommandArgument='<%#Eval("lid") %>'
                                    CommandName="getstatus" ToolTip="Update Status For Quotation." Enabled="false"></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <asp:Button ID="btnSave" runat="server" OnClick="btnSave_OnClick" CausesValidation="true" ValidationGroup="vgAddStatus"
                                            Text="Save Status" Visible="false" />
                                    </td>
                                </tr>
                            </table>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="white">
                            <tr id="trStartDt" runat="server">
                                <td>Contract Start Date
                                    ...
                                    <cc1:MaskedEditValidator ID="mevStartDt" ControlExtender="meeStartDt" ControlToValidate="txtContractStartDt" IsValidEmpty="true"
                            ...
                            <tr id="trEndDt" runat="server">
                                <td>Contract End Date
                                    ...
                                    <cc1:MaskedEditValidator ID="mevEndDt" ControlExtender="meeEndDt" ControlToValidate="txtContractEndDt" IsValidEmpty="true"
                            ...
                            <tr>
                                <td colspan="2">
                                    <asp:Button ID="btnAddContractCopy" runat="server" Visible="false" OnClick="btnAddContractCopy_OnClick" ValidationGroup="ContractReq" Text="Save Document" />
                                </td>
                            </tr>
                        </table>
                    </div>
