...
public partial class Master_DraftQuotation : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        ScriptManager1.RegisterPostBackControl(gvEnqDocs);
        ...
        ScriptManager1.RegisterPostBackControl(imgbtnDelTexture);
        //ScriptManager1.regi(btnSaveDocument2);
        if (!IsPostBack)
        {
            ...
            rblChooseQuoteCatg_SelectedIndexChanged(null, EventArgs.Empty);
            rblCustBabajiQuote_SelectedIndexChanged(rblCustBabajiQuote, EventArgs.Empty);
    ...
    protected void rblCustBabajiQuote_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (rblCustBabajiQuote.SelectedValue == "1") // Babaji Quote
        {
            ...
            chkLumpSum_CheckedChanged(chkLumpSum, EventArgs.Empty);
            ddlCopyQuote_SelectedIndexChanged(null, EventArgs.Empty);
            ddlIncludeTransportChg_OnSelectedIndexChanged(null, EventArgs.Empty);
            ddlTermCondition.DataBind();
            btnDraftQuote.Visible = true;
            //if (ddCustomer.Items.FindByText(lblNormal_CompanyName.Text) != null)
            //{
            //    int CustomerId = Convert.ToInt32(ddCustomer.Items.FindByText(lblNormal_CompanyName.Text).Value);
            //    ddCustomer.SelectedValue = CustomerId.ToString();
            //    ddCustomer_SelectedIndexChanged(null, EventArgs.Empty);
            //}
            //else
            //{
            //    txtCustomer.Text = lblNormal_CompanyName.Text;
            //}
        }
        else
        {
            ...
            btnDraftQuote.Visible = false;
            //ddlTenderCustomer.Focus();
            //if (ddlTenderCustomer.Items.FindByText(lblNormal_CompanyName.Text) != null)
            //{
            //    int CustomerId = Convert.ToInt32(ddlTenderCustomer.Items.FindByText(lblNormal_CompanyName.Text).Value);
            //    ddlTenderCustomer.SelectedValue = CustomerId.ToString();
            //    ddlTenderCustomer_SelectedIndexChanged(null, EventArgs.Empty);
            //}
            //else
            //{
            //    txtCustomer.Text = lblNormal_CompanyName.Text;
    ...
    {
        if (ddlIncludeDesc.SelectedValue == "2") //yes
        {
            string Script =
    ...
    {
        //trExistCustEnq_Quote.Visible = false;
        //trGetEnquiry_NormalQuote.Visible = true;
        //if (ddCustomer.SelectedValue != "0")
        //{
        //    txtCustomer.Enabled = false;
        //    txtCustomer.Text = ddCustomer.SelectedItem.Text.Trim();
        //    txtAddressLine1.Focus();
        //    ddlExistingCustEnquiryQuote.DataBind();
        //    if (ddlExistingCustEnquiryQuote != null)
        //    {
        //        if (ddlExistingCustEnquiryQuote.Items.Count > 0)
        //        {
        //            trExistCustEnq_Quote.Visible = true;
        //        }
        //    }

        //    // New Changes
        //    trGetEnquiry_NormalQuote.Visible = false;
        //}
        //else
        //{
        ...
        //if (ddCustomer.SelectedValue != "0")
        //{
        //    ddlEnquiry.DataSourceID = "DataSourceOtherEnquiryBabajiQuote";
        //    ddlEnquiry.DataTextField = "EnquiryNo";
        //    ddlEnquiry.DataValueField = "lid";
        //    ddlEnquiry.DataBind();
        //}
        //else
        //{
    ...
    //{
    //    trExistCustEnq_RfqQuote.Visible = false;
    //    if (ddlTenderCustomer.SelectedValue != "0")
    //    {
    //        txtCustomer.Enabled = false;
    //        txtCustomer.Text = ddlTenderCustomer.SelectedItem.Text.Trim();
    //        ddlExistingCustEnquiryRfqQuote.DataBind();
    //        if (ddlExistingCustEnquiryRfqQuote != null)
    //        {
    //            if (ddlExistingCustEnquiryRfqQuote.Items.Count > 0)
    //            {
    //                trExistCustEnq_RfqQuote.Visible = true;
    //            }
    //        }
    //    }
    //    else
    ...
    protected void ResetControls()
    {
        ...
        ddlLead_SelectedIndexChanged(null, EventArgs.Empty);
        rblCustBabajiQuote.SelectedValue = "1";
        rblCustBabajiQuote_SelectedIndexChanged(rblCustBabajiQuote, EventArgs.Empty);
    ...
    protected void ddlIncludeTransportChg_OnSelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            if (ddlIncludeTransportChg.SelectedValue == "1") // YES
            {
                trTransportCharges.Visible = true;
                TransportationInitialRow();
            }
            else // NO
                trTransportCharges.Visible = false;
            ddlIncludeTransportChg.Focus();
        }
        catch (Exception en)
        {
    ...
    protected void SaveData(int IsDraftQuote)
    {
        ...
        if (Customer != "")
        {
            if (rblCustBabajiQuote.SelectedValue == "2") // RFQ or Tender Quotation
            {
                #region RFQ & TENDER
                OtherNotes = txtNotes.Text.Trim();
                int SavedDraft = QuotationOperations.AddDraftQuotation(BranchId, EnquiryId, ServicesId, CustomerId, Customer, "", "", "", "", "", false, "", "", true, true, false, OtherNotes, LoggedInUser.glUserId, 0,
                ...
                if (SavedDraft > 0)
                {
                    ...
                    //foreach (HttpPostedFile postedFile in fuDocument2.PostedFiles)
                    //{
                    //    if (postedFile != null)
                    //    {
                    ...
                    //        {
                    //            if (System.IO.File.Exists(ServerFilePath + postedFile.FileName))
                    //            {
                    ...
                    //            }
                    //            fuDocument2.SaveAs(ServerFilePath + fileName);
                    //            int result_Doc = QuotationOperations.AddQuotationAnnexure(SavedDraft, fileName, LoggedInUser.glUserId);
                    //        }
                    //    }
                    //}
                    #endregion
                    ...
                    if (IsDraftQuote == 0)
                        ...
                        QuotationOperations.UpdateDraftApprovalStatus(SavedDraft, 1, LoggedInUser.glUserId);
                    DataSet dsGetQuoteRefNo = QuotationOperations.GetParticularQuotation(SavedDraft);
                    if (dsGetQuoteRefNo != null)
                    {
                        ...
                        if (gvGenerateCharge.Rows.Count > 0)
                        {
                            ...
                            if (result == 0)
                            {
                                ...
                                if (IsDraftQuote == 0)
                                {
                                    ...
                                    {
                                        int result_Draft = QuotationOperations.UpdateDraftApprovalStatus(QuotationId, 6, LoggedInUser.glUserId);
                                        DownloadQuotation(QuotationId);
                                        Response.Redirect("QuotationSuccess.aspx?id=" + QuotationId.ToString() + "&op=1");
                                    }
                                }
                                else
                                {
                                    ...
                                    DownloadQuotation(QuotationId);
                                    Response.Redirect("QuotationSuccess.aspx?id=" + QuotationId.ToString() + "&op=2");
                                }
                            }
                            else
                            {
    ...
    protected void ddlLead_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            DataSet dsGetLeadDetail = QuotationOperations.GetLeadAsPerLid(Convert.ToInt32(ddlLead.SelectedValue));
            if (dsGetLeadDetail != null && dsGetLeadDetail.Tables[0].Rows.Count > 0)
            {
                if (dsGetLeadDetail.Tables[0].Rows[0]["lid"] != DBNull.Value)
                {
                    txtCustomer.Text = "";
                    ddlEnquiry.Items.Clear();
                    ddlEnquiry.DataBind();
                    hdnEnquiryId.Value = "0";
                    txtEnquiryNotes.Text = "";
                    //ddCustomer.Visible = false;

                    txtKindAttn.Text = dsGetLeadDetail.Tables[0].Rows[0]["ContactName"].ToString();
                    txtAddressLine1.Text = dsGetLeadDetail.Tables[0].Rows[0]["Address"].ToString();
                    txtCustomer.Text = dsGetLeadDetail.Tables[0].Rows[0]["CompanyName"].ToString();
                    ddlEnquiry.DataSourceID = "DataSourceLeadEnquiry";
                    ddlEnquiry.DataBind();
                    ddlEnquiry_OnSelectedIndexChanged(null, EventArgs.Empty);
                    //if (ddCustomer.Items.FindByText(lblNormal_CompanyName.Text) != null)
                    //{
                    //    int CustomerId = Convert.ToInt32(ddCustomer.Items.FindByText(lblNormal_CompanyName.Text).Value);
                    //    ddCustomer.SelectedValue = CustomerId.ToString();
                    ...
                    //else
                    //{
                    //    if (rblCustBabajiQuote.SelectedValue == "1") // Normal quotation
                    //    {
                    //        txtCustomer.Text = dsGetLeadDetail.Tables[0].Rows[0]["CompanyName"].ToString();
                    //    }
                    //    else
    ...
    protected void ddlEnquiry_OnSelectedIndexChanged(object sender, EventArgs e)
    {
        if (ddlEnquiry.SelectedValue != "" && ddlEnquiry.SelectedValue != "0")
        {
            DataSet dsGetEnquiry = QuotationOperations.GetLeadEnquiryByLid(Convert.ToInt32(ddlEnquiry.SelectedValue));
            if (dsGetEnquiry != null && dsGetEnquiry.Tables[0].Rows.Count > 0)
            {
                if (dsGetEnquiry.Tables[0].Rows[0]["lid"] != DBNull.Value)
                {
                    hdnEnquiryId.Value = dsGetEnquiry.Tables[0].Rows[0]["lid"].ToString();
                    txtEnquiryNotes.Text = dsGetEnquiry.Tables[0].Rows[0]["Notes"].ToString();
                    txtServices.Text = dsGetEnquiry.Tables[0].Rows[0]["ServicesName"].ToString();
                    gvEnqDocs.DataBind();
                }
            }
            else
    ...
    protected void gvEnqDocs_RowCommand(Object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName.ToLower() == "download")
        {
            string DocPath = e.CommandArgument.ToString();
            DownloadEnqDoc(DocPath);
        }
    }

    protected void DownloadEnqDoc(string DocumentPath)
    {
        ...
        if (ServerPath == "")
        {
            ServerPath = HttpContext.Current.Server.MapPath("..\\UploadFiles\\CRM\\" + DocumentPath);
        }
        else
        {
            ServerPath = ServerPath + "CRM\\" + DocumentPath;
        }
        try
        {
    ...
    //protected void ddlExistingCustEnquiryQuote_OnSelectedIndexChanged(object sender, EventArgs e)
    //{
    //    if (ddlExistingCustEnquiryQuote.SelectedValue != "0")
    //    {
    //        DataSet dsGetEnquiry = QuotationOperations.GetLeadEnquiryByLid(Convert.ToInt32(ddlExistingCustEnquiryQuote.SelectedValue));
    //        if (dsGetEnquiry != null && dsGetEnquiry.Tables[0].Rows.Count > 0)
    //        {
    //            if (dsGetEnquiry.Tables[0].Rows[0]["lid"] != DBNull.Value)
    //            {
    //                txtKindAttn.Text = dsGetEnquiry.Tables[0].Rows[0]["ExistLeadContactName"].ToString();
    //                txtAddressLine1.Text = dsGetEnquiry.Tables[0].Rows[0]["ExistLeadAddress"].ToString();

    //                hdnEnquiryId.Value = dsGetEnquiry.Tables[0].Rows[0]["lid"].ToString();
    //                //txtNotes.Text = dsGetEnquiry.Tables[0].Rows[0]["Notes"].ToString();
    //                //txtServices.Text = dsGetEnquiry.Tables[0].Rows[0]["ServicesName"].ToString();
    //                //gvEnqDocs.DataBind();
    //            }
    //        }
    ...
    //protected void ddlExistingCustEnquiryRfqQuote_OnSelectedIndexChanged(object sender, EventArgs e)
    //{
    //    if (ddlExistingCustEnquiryRfqQuote.SelectedValue != "0")
    //    {
    //        DataSet dsGetEnquiry = QuotationOperations.GetLeadEnquiryByLid(Convert.ToInt32(ddlExistingCustEnquiryRfqQuote.SelectedValue));
    //        if (dsGetEnquiry != null && dsGetEnquiry.Tables[0].Rows.Count > 0)
    //        {
    //            if (dsGetEnquiry.Tables[0].Rows[0]["lid"] != DBNull.Value)
    //            {
    //                hdnEnquiryId.Value = dsGetEnquiry.Tables[0].Rows[0]["lid"].ToString();
    //                //txtNotes2.Text = dsGetEnquiry.Tables[0].Rows[0]["Notes"].ToString();
    //                //txtServices2.Text = dsGetEnquiry.Tables[0].Rows[0]["ServicesName"].ToString();
    //                //gvEnqDocs.DataBind();
    //            }
    //        }
    //        else
    ...
    #region TEXTURE POPUP

    protected void imgbtnDelTexture_Click(object sender, EventArgs e)
    {
        ddlIncludeDesc.SelectedValue = "0";
        ddlIncludeDesc.SelectedItem.Text = "-Select-";
        ddlIncludeDesc_OnSelectedIndexChanged(null, EventArgs.Empty);
        mpeTexture.Hide();
    }
    ...
    protected void rblChooseQuoteCatg_SelectedIndexChanged(object sender, EventArgs e)
    {
        txtEnquiryNotes.Text = "";
        txtServices.Text = "";
        hdnCustId.Value = "0";
        txtCustomer.Text = "";
        if (rblChooseQuoteCatg.SelectedValue == "0") // Babaji Customer
        {
            trLeadRefno.Visible = false;
            ddlEnquiry.DataSourceID = "DataSourceEnquiry";
            ddlEnquiry.DataBind();
            txtCustomer.Enabled = true;
        }
        else // Lead Enquiry
        {
            trLeadRefno.Visible = true;
            txtCustomer.Enabled = false;
        }
    }
    ...
    {
        trLeadRefno.Visible = true;
        trEnquiryDetail.Visible = true;
        txtEnquiryNotes.Visible = true;
        ...
        if (hdnCustId.Value != "" && hdnCustId.Value != "0")
        {
            ...
            ddlEnquiry.DataSourceID = "DataSourceEnquiry";
            ddlEnquiry.DataBind();
            ddlEnquiry_SelectedIndexChanged(null, EventArgs.Empty);
        }
        else
        {
            trLeadRefno.Visible = false;
            trEnquiryDetail.Visible = false;
            txtEnquiryNotes.Visible = false;
