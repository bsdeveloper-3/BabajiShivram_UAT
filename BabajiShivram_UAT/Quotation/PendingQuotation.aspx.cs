...
public partial class Quotation_PendingQuotation : System.Web.UI.Page
{
    ...
    protected void GetQuotationDetails(int QuotationId)
    {
        if (QuotationId != 0)
        {
            ...
            if (dsGetQuoteDetails != null)
            {
                ...
                fsEnquiryInfo.Visible = true;
                if (dsGetQuoteDetails.Tables[0].Rows[0]["EnquiryId"] == DBNull.Value)
                {
                    fsEnquiryInfo.Visible = false;
                }
                ...
                //txtLeadDate.Text = Convert.ToDateTime(dsGetQuoteDetails.Tables[0].Rows[0]["LeadDate"]).ToString("dd/MM/yyyy");
