...
public partial class Quotation_AdminLevelQuote : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DataFilter1.FilterSessionID = "AdminLevelQuote";
    ...
    protected void gvQuotationDetails_RowCommand(Object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName.ToLower() == "getquote")
        {
            ...
            Response.Redirect("EditQuoteByAdmin.aspx");
    ...
    protected void btnSave_OnClick(object sender, EventArgs e)
    {
        ...
        {
            int Save = QuotationOperations.UpdateQuoteStatus(Convert.ToInt32(Session["QuotationId"]), Convert.ToInt32(ddlStatus.SelectedValue), txtRemark.Text.Trim(), loggedInUser.glUserId);
            if (Save == 1)
            {
    ...
    protected void btnAddContractCopy_OnClick(object sender, EventArgs e)
    {
        ...
        if (txtContractStartDt.Text.Trim() != "")
        {
            ...
            int SaveUpdateDates = QuotationOperations.UpdateQuotationContractDates(Convert.ToInt32(Session["QuotationId"]), dtContractStart, dtContractEnd, Convert.ToInt32(loggedInUser.glUserId.ToString()));
