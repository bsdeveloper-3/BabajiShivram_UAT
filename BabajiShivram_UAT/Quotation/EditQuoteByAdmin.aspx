<%@ Page Title="Edit Quotation" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="EditQuoteByAdmin.aspx.cs" Inherits="Quotation_EditQuoteByAdmin" Culture="en-GB" ValidateRequest="false" %>
        ...
        <ContentTemplate>
            ...
            <div id="dvDraftSection" runat="server">
                <fieldset>
                    ...
                    <asp:HiddenField ID="hdnKAMName" runat="server" Value="0" />
                    <asp:HiddenField ID="hdnSalesPersonId" runat="server" Value="0" />
                    <asp:HiddenField ID="hdnSalesPersonName" runat="server" Value="0" />
