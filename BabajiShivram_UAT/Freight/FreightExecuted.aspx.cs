...
using System.IO;
public partial class Freight_FreightExecuted : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            lblTitle.Text = "Freight Executed";
        ...
        DataFilter1.FilterSessionID = "FreightExecuted.aspx";
    ...
    {
        string strFileName = "FreightExecuted_" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
