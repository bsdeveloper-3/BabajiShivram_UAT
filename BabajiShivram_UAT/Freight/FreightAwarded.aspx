<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="FreightAwarded.aspx.cs" 
    Inherits="Freight_FreightAwarded" Title="Freight Awarded" EnableEventValidation="false" Culture="en-GB" %>
...
<asp:ScriptManager runat="server" ID="ScriptManager1" />
    ...
    <asp:UpdatePanel ID="upPendingchecklist" runat="server" UpdateMode="Conditional"
        ...
        <div class="clear"></div>
        <div>
            <fieldset><legend>Freight Award Detail</legend>
            <div class="m clear">
                <div class="fleft">
        ...
        <div>
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Enquiry No" SortExpression="ENQRefNo">
                    <ItemTemplate>
                        <asp:LinkButton ID="lnkViewFreight" runat="Server" Text='<%#Eval("ENQRefNo") %>' CommandName="navigate"
                         CommandArgument='<%#Eval("EnqId")+";"+ Eval("TypeName") %>' CausesValidation="false" ></asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:BoundField DataField="AwardDate" HeaderText="Award Date" DataFormatString="{0:dd/MM/yyyy}" SortExpression="AwardDate"/>
                ...
                <asp:BoundField DataField="ETD" HeaderText="ETD" SortExpression="ETD" DataFormatString="{0:dd/MM/yyyy}"/>
        ...
        <div>
            <asp:SqlDataSource ID="GridViewSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                SelectCommand="FR_GetFreightForAward" SelectCommandType="StoredProcedure">
                <SelectParameters>
