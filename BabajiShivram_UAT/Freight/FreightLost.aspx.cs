...
using System.IO;
public partial class Freight_FreightLost : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DataFilter1.FilterSessionID = "FreightLost.aspx";
    ...
    {
        string strFileName = "FreightLost_" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
