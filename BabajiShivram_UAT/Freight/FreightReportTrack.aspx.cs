...
public partial class Freight_FreightReportTrack : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DataFilter1.FilterSessionID = "FreightReportTrack.aspx";
    ...
    protected void gvReportMS_RowCommand(Object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName.ToLower() == "generatereport")
        {
            ...
            Response.Redirect("FreightViewReport.aspx");
        }
        if (e.CommandName.ToLower() == "edit")
        {
            ...
            Session["Lid"] = Id.Text;
            Response.Redirect("FreightReport.aspx");
        }
