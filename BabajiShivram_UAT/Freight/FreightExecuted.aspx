<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FreightExecuted.aspx.cs" Inherits="Freight_FreightExecuted" 
    MasterPageFile="~/MasterPage.master" Title="Freight Executed" EnableEventValidation="false" Culture="en-GB" %>
...
<asp:ScriptManager runat="server" ID="ScriptManager1" />
    ...
    <asp:UpdatePanel ID="upPendingchecklist" runat="server" UpdateMode="Conditional"
        ...
        <div>
            <fieldset>
        <legend>Freight Executed Detail</legend>
        <div class="m clear">
            <div class="fleft">
    ...
    <div>
        <asp:GridView ID="gvFreight" runat="server" DataSourceID="GridViewSqlDataSource" DataKeyNames="EnqId" Width="100%" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="ExecutedDate" HeaderText="Execution Date" DataFormatString="{0:dd/MM/yyyy}" SortExpression="ExecutedDate"/>
        ...
        <div>
            <asp:SqlDataSource ID="GridViewSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                SelectCommand="FR_GetFreightForExecuted" SelectCommandType="StoredProcedure">
                <SelectParameters>
