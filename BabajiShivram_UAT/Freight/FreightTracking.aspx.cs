...
using System.IO;
public partial class Freight_FreightTracking : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DataFilter1.FilterSessionID = "FreightTracking.aspx";
    ...
    {
        Response.Redirect("FreightEnquiry.aspx");
    }
    ...
    protected void gvFreight_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName.ToLower() == "navigate")
        {
            ...
            Response.Redirect("FreightDetail.aspx");
        }
    }
