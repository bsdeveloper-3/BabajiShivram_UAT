...
public partial class Freight_FreightBudgetary : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            lblTitle.Text = "Freight Budgetary";
        ...
        DataFilter1.FilterSessionID = "FreightBudgetary.aspx";
    ...
    {
        string strFileName = "FreightBudgetary_" + DateTime.Now.ToString("dd/MM/yyyy hh:mm") + ".xls";
