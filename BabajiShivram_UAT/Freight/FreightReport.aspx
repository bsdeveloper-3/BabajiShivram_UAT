<%@ Page Title="Freight Report" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeFile="FreightReport.aspx.cs" Inherits="Freight_FreightReport" %>
    ...
    <asp:UpdatePanel ID="updAdhocReport" runat="server">
        <ContentTemplate>
            ...
            <div class="clear">
                ...
                <fieldset><legend>Report Field</legend>
