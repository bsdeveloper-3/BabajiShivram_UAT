<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="FreightMISProfit.aspx.cs" 
    Inherits="Freight_FreightMISProfit" Title="Month Wise Profit" EnableEventValidation="false" Culture="en-GB" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" runat="server" ID="content1">
    ...
    <asp:UpdatePanel ID="upFreightReport" runat="server" UpdateMode="Conditional" RenderMode="Inline">
        <ContentTemplate>
            <fieldset><legend>SPC - Buy/Sell</legend>
                <div>
                ...
                <div>
                    <asp:GridView ID="gvProfit" runat="server" AutoGenerateColumns="False" CssClass="table"
                        DataKeyNames="UserId" OnRowCommand="gvProfit_RowCommand" DataSourceID="DataSourceProfit">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="SPC">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lnkSPC" runat="server" Text='<%#Eval("SPC") %>' CommandName="select" CommandArgument='<%#Container.DataItemIndex + ";0" %>'></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
            ...
            <div class="clear"> </div>
            <fieldset><legend>Profit Detail</legend>        
            <!-- Aging Job Detail -->
            ...
            <asp:SqlDataSource ID="DataSourceProfit" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                SelectCommandType="StoredProcedure" SelectCommand="FR_MISProfit" >
                <SelectParameters>
            ...
            <asp:SqlDataSource ID="ProfitDetailSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                SelectCommand="FR_MISProfitDetail" SelectCommandType="StoredProcedure">
                <SelectParameters>
