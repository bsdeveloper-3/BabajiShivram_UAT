<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="FreightBudgetary.aspx.cs" 
    Inherits="Freight_FreightBudgetary" Title="Budgetary Enquiry" EnableEventValidation="false" Culture="en-GB" %>
...
<asp:ScriptManager runat="server" ID="ScriptManager1" />
    ...
    <asp:UpdatePanel ID="upPendingchecklist" runat="server" UpdateMode="Conditional"
        ...
        <div>
            <fieldset>
        <legend>Freight Budgetary Enquiry</legend>
        <div class="m clear">
            <div class="fleft">
    ...
    <div>
        <asp:GridView ID="gvFreight" runat="server" DataSourceID="GridViewSqlDataSource" DataKeyNames="EnqId" Width="100%" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="BudgetaryDate" HeaderText="Budgetary Date" DataFormatString="{0:dd/MM/yyyy}" SortExpression="BudgetaryDate"/>
        ...
        <div>
            <asp:SqlDataSource ID="GridViewSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                SelectCommand="FR_GetFreightForBudgetary" SelectCommandType="StoredProcedure">
                <SelectParameters>
