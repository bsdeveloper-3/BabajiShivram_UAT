<%@ Page Title="View Report" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="FreightViewReport.aspx.cs" 
    Inherits="Freight_FreightViewReport" Culture="en-GB" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        ...
        <div class="m clear">
            <p>
                <asp:CheckBox ID="chkMerge" Text="Merge Records" runat="server" Visible="false" />&nbsp;&nbsp;
