...
//                + '</div>'
//                + '<div class="text-center">'
//                + '<button onclick="resetSwitcher();" class="btn btn-primary btn-sm" style="background-color: #f35b3f;font-weight: bold;">OK, LOG IN</button>'
//                + '</div>'
//                + '<div id="hideSwitcher">x</div>'
//                + '</div></div>'
                + '<div id="showSwitcher" class="styleSecondColor hidden-xs" style="margin-left: 0px; display: block;top: 10px;right: 0px;left: 91%;">'
                + '<i class="fa fa-key styleColor"></i>'
                + '<span style="margin-left:2px; font-family: sans-serif; font-size: 15px;">LOGOUT</span></div>'
                + '<!-- /STYLESWITCHER -->';
    ...
    jQuery("#showSwitcher").click(function () {
