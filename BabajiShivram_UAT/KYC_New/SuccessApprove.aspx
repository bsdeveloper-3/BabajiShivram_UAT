<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SuccessApprove.aspx.cs" Inherits="KYC_New_SuccessApprove" %>
                                    ...
                                    <div class="row" style="padding-top: 2px;">
                                        <div class="form-group">
                                            <div class="col-sm-12 col-md-12" style="text-align: -webkit-center">
                                                <label class="SuccessMsg"><asp:Label ID="lblMessage" runat="server"></asp:Label></label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group">
                                            <div class="col-sm-12 col-md-12" style="text-align: center">
                                                <label style="font-weight: 600; color: #ec2500">
                                                    <u>NOTE</u> :- <asp:Label ID="lblNote" runat="server"></asp:Label>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
