<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SaveKYC.aspx.cs" Inherits="KYC_New_SaveKYC" %>
...
<head runat="server">
    <title>Upload KYC Form Copy</title>
    <meta charset="utf-8">
...
<body class="smoothscroll enable-animation" style="text-align: center">
    <form id="frmSaveKYC" runat="server">
        <div>
            ...
            <!-- Top content -->
            <asp:ValidationSummary ID="vsRequired" runat="server" ShowMessageBox="true" ValidationGroup="vgRequired" />
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <div class="col-sm-12 col-md-12">
                                                <label>
                                                    Upload KYC Copy
                                                    <asp:RequiredFieldValidator ID="rfvKYCCopy" runat="server" SetFocusOnError="true" Display="Dynamic" ErrorMessage="Please browse KYC copy."
                                                        Text="*" ValidationGroup="vgRequired" ForeColor="Red" ControlToValidate="fuUploadKYC"></asp:RequiredFieldValidator>
                                                </label>
                                                <asp:FileUpload ID="fuUploadKYC" runat="server" CssClass="form-control" TabIndex="1" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-2 col-md-2 pull-right">
                                                <asp:Button ID="btnSaveKYC" runat="server" TabIndex="2" CssClass="btn btn-primary" BackColor="#f35b3f" ForeColor="White" Text="&nbsp; &nbsp; SAVE KYC? &nbsp; &nbsp;"
                                                    OnClick="btnSaveKYC_Click" ValidationGroup="vgRequired" />
                                            </div>
                                        </div>
                                    </div>
                                </fieldset>
