...
public partial class CRMReports_SPWiseLeadStatus : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            lblTitle.Text = "Sales Person Wise Lead Status";
        ...
        DataFilter1.FilterSessionID = "SPWiseLeadStatus.aspx";
    ...
    protected void gvLeads_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName.ToLower().Trim() == "status_1")
        {
            ...
            {
                hdnSalesPersonId.Value = e.CommandArgument.ToString();
                hdnStageId.Value = "1";
                lblStatusTitle.Text = "Sales Person Wise Lead Status - MGMT Approval Pending";
                mpeLeadStatus.Show();
                gvLeadDetail.DataBind();
            }
        }
        else if (e.CommandName.ToLower().Trim() == "status_2")
        {
            if (e.CommandArgument.ToString() != "")
            {
                hdnSalesPersonId.Value = e.CommandArgument.ToString();
                hdnStageId.Value = "2";
                lblStatusTitle.Text = "Sales Person Wise Lead Status - Lead Approved";
                mpeLeadStatus.Show();
                gvLeadDetail.DataBind();
            }
        }
        else if (e.CommandName.ToLower().Trim() == "status_3")
        {
            if (e.CommandArgument.ToString() != "")
            {
                hdnSalesPersonId.Value = e.CommandArgument.ToString();
                hdnStageId.Value = "3";
                lblStatusTitle.Text = "Sales Person Wise Lead Status - Lead Rejected";
                mpeLeadStatus.Show();
                gvLeadDetail.DataBind();
            }
        }
        else if (e.CommandName.ToLower().Trim() == "status_4")
        {
            if (e.CommandArgument.ToString() != "")
            {
                hdnSalesPersonId.Value = e.CommandArgument.ToString();
                hdnStageId.Value = "4";
                lblStatusTitle.Text = "Sales Person Wise Lead Status - Follow Up";
                mpeLeadStatus.Show();
                gvLeadDetail.DataBind();
            }
        }
        else if (e.CommandName.ToLower().Trim() == "status_5")
        {
            if (e.CommandArgument.ToString() != "")
            {
                hdnSalesPersonId.Value = e.CommandArgument.ToString();
                hdnStageId.Value = "5";
                lblStatusTitle.Text = "Sales Person Wise Lead Status - Under Progress";
                mpeLeadStatus.Show();
                gvLeadDetail.DataBind();
            }
        }
        else if (e.CommandName.ToLower().Trim() == "status_6")
        {
            if (e.CommandArgument.ToString() != "")
            {
                hdnSalesPersonId.Value = e.CommandArgument.ToString();
                hdnStageId.Value = "6";
                lblStatusTitle.Text = "Sales Person Wise Lead Status - Quote Pending";
                mpeLeadStatus.Show();
                gvLeadDetail.DataBind();
            }
        }
        else if (e.CommandName.ToLower().Trim() == "status_7")
        {
            if (e.CommandArgument.ToString() != "")
            {
                hdnSalesPersonId.Value = e.CommandArgument.ToString();
                hdnStageId.Value = "7";
                lblStatusTitle.Text = "Sales Person Wise Lead Status - KYC Pending";
                mpeLeadStatus.Show();
                gvLeadDetail.DataBind();
            }
        }
        else if (e.CommandName.ToLower().Trim() == "status_8")
        {
            if (e.CommandArgument.ToString() != "")
            {
                hdnSalesPersonId.Value = e.CommandArgument.ToString();
                hdnStageId.Value = "8";
                lblStatusTitle.Text = "Sales Person Wise Lead Status - Contract Pending";
                mpeLeadStatus.Show();
                gvLeadDetail.DataBind();
            }
        }
        else if (e.CommandName.ToLower().Trim() == "status_9")
        {
            if (e.CommandArgument.ToString() != "")
            {
                hdnSalesPersonId.Value = e.CommandArgument.ToString();
                hdnStageId.Value = "9";
                lblStatusTitle.Text = "Sales Person Wise Lead Status";
                mpeLeadStatus.Show();
                gvLeadDetail.DataBind();
            }
        }
    ...
    protected void ExportFunction(string header, string contentType)
    {
        ...
        gvLeads.Caption = "Sales Person Wise Lead Status On " + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt");
    ...
    protected void ExportStatusFunction(string header, string contentType)
    {
        ...
        gvLeadDetail.Caption = "Sales Person Wise Lead Status Detail On " + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt");
