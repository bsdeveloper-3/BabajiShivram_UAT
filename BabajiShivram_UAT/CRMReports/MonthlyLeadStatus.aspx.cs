...
public partial class CRMReports_MonthlyLeadStatus : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            lblTitle.Text = "Month Wise Lead Status";
            pnlFilter.Visible = false;
        }

        DataFilter1.DataSource = DataSourceLeads;
        DataFilter1.DataColumns = gvLeads.Columns;
        DataFilter1.FilterSessionID = "MonthlyLeadStatus.aspx";
    ...
    protected void gvLeads_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName.ToLower().Trim() == "status_1")
        {
            ...
            {
                hdnMonthId.Value = e.CommandArgument.ToString();
                hdnStageId.Value = "1";
                lblStatusTitle.Text = "Month Wise Lead Status - MGMT Approval Pending";
                mpeLeadStatus.Show();
                gvLeadDetail.DataBind();
            }
        }
        else if (e.CommandName.ToLower().Trim() == "status_2")
        {
            if (e.CommandArgument.ToString() != "")
            {
                hdnMonthId.Value = e.CommandArgument.ToString();
                hdnStageId.Value = "2";
                lblStatusTitle.Text = "Month Wise Lead Status - Lead Approved";
                mpeLeadStatus.Show();
                gvLeadDetail.DataBind();
            }
        }
        else if (e.CommandName.ToLower().Trim() == "status_3")
        {
            if (e.CommandArgument.ToString() != "")
            {
                hdnMonthId.Value = e.CommandArgument.ToString();
                hdnStageId.Value = "3";
                lblStatusTitle.Text = "Month Wise Lead Status - Lead Rejected";
                mpeLeadStatus.Show();
                gvLeadDetail.DataBind();
            }
        }
        else if (e.CommandName.ToLower().Trim() == "status_4")
        {
            if (e.CommandArgument.ToString() != "")
            {
                hdnMonthId.Value = e.CommandArgument.ToString();
                hdnStageId.Value = "4";
                lblStatusTitle.Text = "Month Wise Lead Status - Follow Up";
                mpeLeadStatus.Show();
                gvLeadDetail.DataBind();
            }
        }
        else if (e.CommandName.ToLower().Trim() == "status_5")
        {
            if (e.CommandArgument.ToString() != "")
            {
                hdnMonthId.Value = e.CommandArgument.ToString();
                hdnStageId.Value = "5";
                lblStatusTitle.Text = "Month Wise Lead Status - Under Progress";
                mpeLeadStatus.Show();
                gvLeadDetail.DataBind();
            }
        }
        else if (e.CommandName.ToLower().Trim() == "status_6")
        {
            if (e.CommandArgument.ToString() != "")
            {
                hdnMonthId.Value = e.CommandArgument.ToString();
                hdnStageId.Value = "6";
                lblStatusTitle.Text = "Month Wise Lead Status - Quote Pending";
                mpeLeadStatus.Show();
                gvLeadDetail.DataBind();
            }
        }
        else if (e.CommandName.ToLower().Trim() == "status_7")
        {
            if (e.CommandArgument.ToString() != "")
            {
                hdnMonthId.Value = e.CommandArgument.ToString();
                hdnStageId.Value = "7";
                lblStatusTitle.Text = "Month Wise Lead Status - KYC Pending";
                mpeLeadStatus.Show();
                gvLeadDetail.DataBind();
            }
        }
        else if (e.CommandName.ToLower().Trim() == "status_8")
        {
            if (e.CommandArgument.ToString() != "")
            {
                hdnMonthId.Value = e.CommandArgument.ToString();
                hdnStageId.Value = "8";
                lblStatusTitle.Text = "Month Wise Lead Status - Contract Pending";
                mpeLeadStatus.Show();
                gvLeadDetail.DataBind();
            }
        }
        else if (e.CommandName.ToLower().Trim() == "status_9")
        {
            if (e.CommandArgument.ToString() != "")
            {
                hdnMonthId.Value = e.CommandArgument.ToString();
                hdnStageId.Value = "9";
                lblStatusTitle.Text = "Month Wise Lead Status";
                mpeLeadStatus.Show();
                gvLeadDetail.DataBind();
            }
        }
    ...
    {
        string strFileName = "MonthlyLeadStatusOn" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
    ...
    protected void ExportFunction(string header, string contentType)
    {
        ...
        gvLeads.Caption = "Month Wise Lead Status On " + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt");
        if (ddlUser.SelectedValue != "0")
            gvLeads.Caption = "Month Wise Lead Status (User - " + ddlUser.SelectedItem.Text.Trim() + ") On " + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt");
        DataFilter1.FilterSessionID = "MonthlyLeadStatus.aspx";
    ...
    protected void ExportStatusFunction(string header, string contentType)
    {
        ...
        gvLeadDetail.Caption = "Month Wise Lead Status Detail On " + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt");
