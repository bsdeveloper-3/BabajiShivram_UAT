<%@ Page Title="Sales Person Wise Status" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SPWiseLeadStatus.aspx.cs"
    Inherits="CRMReports_SPWiseLeadStatus" Culture="en-GB" %>
    ...
    <asp:UpdatePanel ID="upnlSPWiseLeadStatus" runat="server" UpdateMode="Conditional" RenderMode="Inline">
        <ContentTemplate>
            ...
            <fieldset>
                ...
                <legend>Sales Person Wise Lead Status</legend>
                <div class="clear">
                ...
                <asp:GridView ID="gvLeads" runat="server" AutoGenerateColumns="False" Width="100%" PagerStyle-CssClass="pgr" DataSourceID="DataSourceLeads"
                    DataKeyNames="SalePersonId" CssClass="table" OnPreRender="gvLeads_PreRender" OnRowCommand="gvLeads_RowCommand" EmptyDataText="No data found!" EmptyDataRowStyle-ForeColor="Red" EmptyDataRowStyle-HorizontalAlign="Center">
                    <Columns>
                        ...
                        <asp:BoundField DataField="SalePersonName" HeaderText="Sales Person" SortExpression="SalePersonName" ReadOnly="true" />
                        <asp:TemplateField HeaderText="MGMT Approval Pending">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkbtnMGMTApproval" runat="server" Text='<%#Eval("MGMTApproval") %>' Font-Underline="false" CommandName="Status_1" CommandArgument='<%#Eval("SalePersonId") %>'></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Lead Approved">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkbtnLeadApproved" runat="server" Text='<%#Eval("LeadApproved") %>' Font-Underline="false" CommandName="Status_2" CommandArgument='<%#Eval("SalePersonId") %>'></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Rejected">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkbtnRejected" runat="server" Text='<%#Eval("Rejected") %>' Font-Underline="false" CommandName="Status_3" CommandArgument='<%#Eval("SalePersonId") %>'></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Follow Up">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkbtnFollowUp" runat="server" Text='<%#Eval("FollowUp") %>' Font-Underline="false" CommandName="Status_4" CommandArgument='<%#Eval("SalePersonId") %>'></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Under Progress">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkbtnUnderProgress" runat="server" Text='<%#Eval("UnderProgress") %>' Font-Underline="false" CommandName="Status_5" CommandArgument='<%#Eval("SalePersonId") %>'></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Quote Pending">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkbtnQuotePending" runat="server" Text='<%#Eval("QuotePending") %>' Font-Underline="false" CommandName="Status_6" CommandArgument='<%#Eval("SalePersonId") %>'></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="KYC Pending">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkbtnKycPending" runat="server" Text='<%#Eval("KycPending") %>' Font-Underline="false" CommandName="Status_7" CommandArgument='<%#Eval("SalePersonId") %>'></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Contract Pending">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkbtnContractPending" runat="server" Text='<%#Eval("ContractPending") %>' Font-Underline="false" CommandName="Status_8" CommandArgument='<%#Eval("SalePersonId") %>'></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Total">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkbtnTotal" runat="server" Text='<%#Eval("Total") %>' Font-Underline="false" CommandName="Status_9" CommandArgument='<%#Eval("SalePersonId") %>'></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
            ...
            <div>
                <asp:SqlDataSource ID="DataSourceLeads" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                    SelectCommand="CRM_rptUserWiseLeadStatus" SelectCommandType="StoredProcedure">
                    <SelectParameters>
                    ...
                    <div>
                        <asp:GridView ID="gvLeadDetail" runat="server" CssClass="table" AutoGenerateColumns="false" DataSourceID="DataSourceLeadDetail" Style="white-space: initial">
                            <Columns>
                                ...
                                <asp:BoundField DataField="Lead Ref No" HeaderText="Lead Ref No" ItemStyle-Width="10%" />
                                ...
                                <asp:BoundField DataField="Lead Source" HeaderText="Lead Source" ItemStyle-Width="8%" />
                                <asp:BoundField DataField="Contact Name" HeaderText="Contact Name" ItemStyle-Width="12%" />
                                ...
                                <asp:BoundField DataField="Lead Owner" HeaderText="Lead Owner" ItemStyle-Width="10%" />
            ...
            <div>
                ...
                <asp:SqlDataSource ID="DataSourceLeadDetail" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                    SelectCommand="CRM_rptUserWiseLeadStatusDetail" SelectCommandType="StoredProcedure">
                    <SelectParameters>
                        ...
                        <asp:ControlParameter Name="UserId" ControlID="hdnSalesPersonId" PropertyName="Value" DbType="Int32" DefaultValue="0" />
