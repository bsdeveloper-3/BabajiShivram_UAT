...
public partial class ContMovement_JobTracking : System.Web.UI.Page
{
    ...
    private void ExportFunction(string header, string contentType)
    {
        ...
        gvJobDetail.Columns[1].Visible = false; // job ref no link button
        gvJobDetail.Columns[2].Visible = true;  // job ref no boundfield
