<%@ Page Title="Movement Detail" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="MovementDetail.aspx.cs"
    Inherits="ContMovement_MovementDetail" EnableEventValidation="false" %>
        ...
        <ContentTemplate>
            ...
            <div>
                <asp:SqlDataSource ID="DataSourceMovementDetail" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                    SelectCommand="CM_GetMovementJobs" SelectCommandType="StoredProcedure">
                    <SelectParameters>
