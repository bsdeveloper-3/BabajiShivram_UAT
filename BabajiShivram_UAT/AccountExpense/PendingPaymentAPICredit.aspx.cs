...
using System.Data;
using System.IO;
public partial class AccountExpense_PendingPaymentAPICredit : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            lblTitle.Text = "Pending API Payment - Credit";
        ...
        DataFilter1.FilterSessionID = "PendingPaymentAPICredit.aspx";
    ...
    {
        string strFileName = "Pending_Payment_Credit_Vendor" + DateTime.Now.ToString("dd/MM/yyyy hh:mm") + ".xls";
