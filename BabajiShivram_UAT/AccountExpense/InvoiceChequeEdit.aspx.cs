...
using System.Text;
using System.IO;
public partial class AccountExpense_InvoiceChequeEdit : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblTitle.Text = "Update Invoice Detail";
        ...
        if (!IsPostBack)
        {
            ...
            if (Session["ChequeId"] != null)
            {
                ...
                if (dsChequeDetail.Tables.Count > 0)
                {
                    if (dsChequeDetail.Tables[0].Rows.Count > 0)
                    {
                        ...
                        if (dsChequeDetail.Tables[0].Rows[0]["ChequeAmount"] != DBNull.Value)
                        {
                            txtChequeAmount.Text = dsChequeDetail.Tables[0].Rows[0]["ChequeAmount"].ToString();
                        }
                    }
                }
            }
            ...
            {
                // Not Valid Invoice -- Session Error
                txtInvoiceNo.Text = "";
        ...
        if (dsDetail.Tables[0].Rows.Count > 0)
        {
            ...
            if (dsDetail.Tables[0].Rows[0]["ProformaInvoiceId"] != DBNull.Value)
            {
                ...
                if (ProformaInvoiceId > 0)
                {
                    ...
                    // Can not Change Invoice Type - Final
    ...
    protected void wzRequest_FinishButtonClick(object sender, WizardNavigationEventArgs e)
    {
        ...
        if (bIsInputValid)
        {
            ...
            string strVendorName, strVendorCode, strVendorGSTNo, strVendorPAN, strInvoiceNo, strRemark;
            bool IsAdvanceReceived = false; bool IsImmediatePayment = true;
            ...
            int Result = AccountExpense.UpdateInvoiceDetail(InvoiceId, JobId, strJobRefNO, ModuleID, ExpenseTypeId,
                ...
                decInvoiceCurrencyAmt, decInvoiceCurrencyExchangeRate, strPaymentTerms, IsImmediatePayment, BillType, HODId,0, strRemark, LoggedInUser.glUserId);
            ...
            if (Result == 0)
            {
                ...
                // Invoice Updated and Send To Account Department
                int NewStatusid = 120;

                int result = AccountExpense.AddInvoiceStatus(InvoiceId, NewStatusid, txtRemark.Text.Trim(), LoggedInUser.glUserId);

                AccountExpense.UpdateBankChequeInvoiceNo(ChequeId, decChequAmount, InvoiceId, LoggedInUser.glUserId);
            ...
            {
                lblError.Text = "Invoice Details Already Submitted!";
                lblError.CssClass = "errorMsg";
