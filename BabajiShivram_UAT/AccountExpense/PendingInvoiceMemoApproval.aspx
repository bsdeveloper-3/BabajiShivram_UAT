<%@ Page Title="Memo Approval" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeFile="PendingInvoiceMemoApproval.aspx.cs" Inherits="AccountExpense_PendingInvoiceMemoApproval" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div>
        ...
        <asp:UpdatePanel ID="upFillDetails" runat="server" UpdateMode="Conditional">
            ...
            <fieldset><legend>Vendor Memo Approval</legend>
            <div class="clear">
            <asp:Panel ID="pnlFilter" runat="server">
                ...
                <div class="fleft" style="margin-left:30px; padding-top:3px;">
                <asp:Button ID="btnApproveMemo" runat="server" Text="Approve Memo For Payment" OnClick="btnApproveMemo_Click" OnClientClick="return confirm('Sure to Approve Vendor Memo for Payment ?');" />
                </div>
            </asp:Panel>
            </div>
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Memo Ref No">
                    <ItemTemplate>
                        <asp:LinkButton ID="lnkMemoRefNo" CommandName="select" runat="server" Text='<%#Eval("InvoiceMemoRefNo") %>'
                            CommandArgument='<%#Eval("lid") %>' />
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="InvoiceMemoRefNo" HeaderText="Memo Ref No" SortExpression="InvoiceMemoRefNo" Visible="false" />
                ...
                <asp:TemplateField HeaderText="Remark" SortExpression="Remark">
                    <ItemTemplate>
                        ...
                        <asp:Label ID="lblRemarkView" runat="server" 
                            Text='<%# Eval("Remark")%>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="View Doc" SortExpression="DocPath">
                    <ItemTemplate>
                        <asp:LinkButton ID="lnkDoc" CommandName="ViewDOC" runat="server" Text="View DOC"
                            CommandArgument='<%#Eval("DocPath") %>' ToolTip="View Profit Detail" />
                    </ItemTemplate>
                </asp:TemplateField>
        ...
        <div>
            <asp:SqlDataSource ID="InvoiceSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                SelectCommand="INV_GetPendingMemoForApproval" SelectCommandType="StoredProcedure">
            </asp:SqlDataSource>
        </div>
    </ContentTemplate>
    </asp:UpdatePanel>
