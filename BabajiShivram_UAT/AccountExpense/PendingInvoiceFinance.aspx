<%@ Page Title="Invoice Audit - L2" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeFile="PendingInvoiceFinance.aspx.cs" Inherits="AccountExpense_PendingInvoiceFinance" EnableEventValidation="false" Culture="en-GB" %>
    ...
    <fieldset><legend>Invoice Audit - L2</legend>
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="" ItemStyle-Width="8%">
                    <ItemTemplate>
                        ...
                        <%--<asp:ImageButton ID="btnPaymentApprove" Visible="false" runat="server" ImageUrl="~/Images/success.png" OnClientClick="return confirm('Are you sure to approve Payment?');"
                            CommandArgument='<%#Eval("InvoiceId") %>' CommandName="PaymentApprove" Width="17px" Height="17px" ToolTip="Approve Payment"
                            Style="padding-right: 1px; margin-right: 0px; padding-left: 1px"></asp:ImageButton>--%>
                ...
                <asp:BoundField DataField="InvoiceCurrencyExchangeRate" HeaderText="Exch Rate" SortExpression="InvoiceCurrencyExchangeRate" />
        ...
        <div>
            <asp:SqlDataSource ID="InvoiceSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                SelectCommand="AC_GetPendingInvoiceForFinance" SelectCommandType="StoredProcedure">
            </asp:SqlDataSource>
        </div>
    </ContentTemplate>
    </asp:UpdatePanel>
