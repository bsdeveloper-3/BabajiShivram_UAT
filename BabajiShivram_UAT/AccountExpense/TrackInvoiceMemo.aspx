<%@ Page Title="Vendor Invoice Memo" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeFile="TrackInvoiceMemo.aspx.cs" Inherits="AccountExpense_TrackInvoiceMemo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:UpdatePanel ID="upFillDetails" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <fieldset><legend>Track Invoice Memo</legend>
            <div class="clear">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="PaymentDate" HeaderText="Pay Date" SortExpression="PaymentDate" DataFormatString="{0:dd/MM/yyyy}"/>
        ...
        <div>
            <asp:SqlDataSource ID="InvoiceSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                SelectCommand="INV_GetInvoiceMemo" SelectCommandType="StoredProcedure">
            </asp:SqlDataSource>
        </div>
    </ContentTemplate>
    </asp:UpdatePanel>
