...
public partial class AccountExpense_PendingInvoiceApprovalCredit : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            lblTitle.Text = "Credit Vendor Invoice Approval";
        ...
        DataFilter1.FilterSessionID = "PendingInvoiceApprovalCredit.aspx";
    ...
    protected void gvDetail_RowCommand(Object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName.ToLower() == "select")
        {
            ...
            Response.Redirect("InvoiceApprovalCredit.aspx"); ;
        }
    ...
    protected void btnApproveJob_OnClick(object sender, EventArgs e)
    {
        if (txtReason.Text.Trim() != "")
        {
            ...
            if (InvoiceID > 0)
            {
                ...
                int ApprovedJobExp = AccountExpense.AddInvoiceStatus(InvoiceID, 115, txtReason.Text.Trim(), LoggedInUser.glUserId);

                if (ApprovedJobExp == 0)
                {
                    gvDetail.DataBind();
                    lblMessage.Text = "Invoice Approved!. Sent For Audit L2";
    ...
    protected void btnRejectJob_OnClick(object sender, EventArgs e)
    {
        if (txtReason.Text.Trim() != "")
        {
            ...
            if (InvoiceID > 0)
            {
                ...
                {
                    int result = AccountExpense.AddInvoiceStatus(InvoiceID, 112, txtReason.Text.Trim(), LoggedInUser.glUserId);
                    ...
                    if (result == 0)
                    {
                        ...
                        SendHoldRejectMail(InvoiceID, "Management Reject", txtReason.Text.Trim());
                    }
                    else if (result == 2)
                    {
    ...
    protected void btnHoldJob_OnClick(object sender, EventArgs e)
    {
        if (txtReason.Text.Trim() != "")
        {
            ...
            int result = AccountExpense.AddInvoiceStatus(InvoiceID, 111, txtReason.Text.Trim(), LoggedInUser.glUserId);
            ...
            if (result == 0)
            {
                ...
                SendHoldRejectMail(InvoiceID, "Management On Hold", txtReason.Text.Trim());
    ...
    protected void gvDetail_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (DataBinder.Eval(e.Row.DataItem, "InvoiceAging") != DBNull.Value)
            {
                int InvoiceAging = Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "InvoiceAging").ToString());
                
                if (InvoiceAging > 30) // Invoice Aging Above 30 days - Show row color as Bule 
                {
                    e.Row.BackColor = System.Drawing.Color.AliceBlue;
                    e.Row.ToolTip = "Invoice Aging Above 30 Days";
                }
            }
    ...
    {
        string strFileName = "InvoiceApproval_CreditVendor" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
