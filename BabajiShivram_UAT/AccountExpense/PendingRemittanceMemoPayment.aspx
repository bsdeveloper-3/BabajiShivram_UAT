<%@ Page Title="Remittance Memo Payment" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeFile="PendingRemittanceMemoPayment.aspx.cs" Inherits="AccountExpense_PendingRemittanceMemoPayment" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div>
        ...
        <asp:UpdatePanel ID="upFillDetails" runat="server" UpdateMode="Conditional">
            ...
            <fieldset><legend>Remittance Memo Payment</legend>
            <div class="clear">
        ...
        <div>
            <asp:SqlDataSource ID="InvoiceSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                SelectCommand="INV_GetRemittancegMemoForPayment" SelectCommandType="StoredProcedure">
            </asp:SqlDataSource>
        </div>
    </ContentTemplate>
    </asp:UpdatePanel>
