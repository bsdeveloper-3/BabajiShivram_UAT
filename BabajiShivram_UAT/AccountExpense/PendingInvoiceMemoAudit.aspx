<%@ Page Title="Memo Audit" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeFile="PendingInvoiceMemoAudit.aspx.cs" Inherits="AccountExpense_PendingInvoiceMemoAudit" EnableEventValidation="false"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div>
        ...
        <asp:UpdatePanel ID="upFillDetails" runat="server" UpdateMode="Conditional">
            ...
            <fieldset><legend>Vendor Memo Audit</legend>
            <div class="clear">
            <asp:Panel ID="pnlFilter" runat="server">
                ...
                <div class="fleft" style="margin-left:30px; padding-top:3px;">
                <asp:Button ID="btnAuditMemo" runat="server" Text="Audit Memo For Payment" OnClick="btnAuditMemo_Click" OnClientClick="return confirm('Sure to Complete Memo Audit ?');" />
                </div>
            </asp:Panel>
            </div>
        ...
        <div>
            <asp:SqlDataSource ID="InvoiceSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                SelectCommand="INV_GetPendingMemoForAudit" SelectCommandType="StoredProcedure">
            </asp:SqlDataSource>
        </div>
    </ContentTemplate>
    </asp:UpdatePanel>
