...
using System.IO;
public partial class AccountExpense_AuditAgingReport : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblTitle.Text = "Audit Aging Report";
    ...
    {
        lblMessage.Text = "";
        string strFileName = "Vendor_Payment_Aging_" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
