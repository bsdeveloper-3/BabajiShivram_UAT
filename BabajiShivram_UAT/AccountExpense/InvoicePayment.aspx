<%@ Page Title="Invoice Payment" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeFile="InvoicePayment.aspx.cs" Inherits="AccountExpense_InvoicePayment" Culture="en-GB"%>
        ...
        <ContentTemplate>
            <div>
                <div align="center">
                    ...
                    <asp:HiddenField ID="hdnVendorBankAccountId" runat="server" Value="0" />
                ...
                <fieldset>
                    ...
                    <legend>Job Detail</legend>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="lblExpenseType" runat="server" Font-Bold="true" Font-Size="Large"></asp:Label>
                            </td>
                            <td>
                                Duty Amount
                            </td>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="white">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="lblVendorBankAccountName" runat="server" Font-Bold="true" Font-Size="Medium"></asp:Label>
                            </td>
                        </tr>
                        <tr>                            
                            <td>
                            ...
                            <td>
                                <asp:Label ID="lblVendorBankAccountNo" runat="server" Font-Bold="true" Font-Size="Medium"></asp:Label>
                            </td>
                            ...
                            <td>
                                <asp:Label ID="lblVendorBankAccountIFSC" runat="server" Font-Bold="true" Font-Size="Medium"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>Account Type</td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="lblPaymentRequestDate" runat="server"></asp:Label>
                            </td>
                        </tr>
                    </table>
                    </fieldset>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="white">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="lblInvoiceDate" runat="server" Font-Bold="true" Font-Size="Medium"></asp:Label>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="lblGSTValue" runat="server" Text="0" Font-Bold="true" Font-Size="Medium"></asp:Label>
                            </td>
                            <td>
                                TDS Amount
                            </td>
                            <td>
                                <asp:Label ID="lblTDSAmount" runat="server" Text="0" Font-Bold="true" Font-Size="Medium"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <asp:Label ID="lblRequestBy" runat="server" Font-Bold="true" Font-Size="Medium"></asp:Label>
                            </td>
                        </tr>
                    </table>
                    </fieldset>
                    ...
                    <asp:GridView ID="gvInvoiceHistory" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Remark">
                                <ItemTemplate>
                                    <div style="word-wrap: break-word; width: 80%; white-space:normal;"; >
                                    <asp:Label ID="lblRemarkStatus" runat="server" Text='<%#Eval("sRemark") %>'></asp:Label>
                                    </div>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:BoundField HeaderText="User" DataField="UserName" />
                ...
                <fieldset runat="server" id="fldPayment">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="white">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddCurrency" runat="server" DataSourceID="dataSourceCurrency" Enabled="false"
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlPaymentType" runat="server" AppendDataBoundItems="true" DataSourceID="DataSourcePaymentType"
                                   Enabled="false"  DataTextField="sName" DataValueField="lid" AutoPostBack="true" OnSelectedIndexChanged="ddlPaymentType_SelectedIndexChanged">
                                </asp:DropDownList>
                            </td>
                            <td>
                                Bank Name
                            ...
                            <td>
                                <asp:DropDownList ID="ddBabajiBankName" runat="server" AutoPostBack="true" Enabled="false"
                        ...
                        <tr>
                            <td>
                                Instrument No
                                <asp:RequiredFieldValidator ID="rfvInstrumentNo" runat="server" ValidationGroup="RequiredPay" InitialValue=""
                                     ControlToValidate="txtInstrumentNo" Text="Required"  SetFocusOnError="true" Enabled="true"></asp:RequiredFieldValidator>
                            </td>
                            <td>
                                <asp:TextBox ID="txtInstrumentNo" runat="server" MaxLength="50"></asp:TextBox>
                            </td>
                            <td>
                                Instrument Date
                                <cc1:CalendarExtender ID="CalExtInstrumentDate" runat="server" FirstDayOfWeek="Sunday" PopupButtonID="imgInstrumentDate"
                                    Format="dd/MM/yyyy" PopupPosition="BottomRight" TargetControlID="txtInstrumentDate">
                                </cc1:CalendarExtender>
                                <cc1:MaskedEditExtender ID="MskEdtInstrumentDate" TargetControlID="txtInstrumentDate" Mask="99/99/9999" MessageValidatorTip="true"
                                    MaskType="Date" AutoComplete="false" runat="server">
                                </cc1:MaskedEditExtender>
                                <cc1:MaskedEditValidator ID="MskEdtValInstrumentDate" ControlExtender="MskEdtInstrumentDate" ControlToValidate="txtInstrumentDate" IsValidEmpty="false"
                                    InvalidValueMessage="Instrument Date is invalid" InvalidValueBlurredMessage="Invalid Date" SetFocusOnError="true"
                                    MinimumValueMessage="Invalid Instrument Date" MaximumValueMessage="Invalid Instrument Date" ValidationGroup="RequiredPay"
                                    MaximumValue='<%#DateTime.Now.ToString("dd/MM/yyyy") %>' MinimumValue='01/01/2020'
                                    EmptyValueBlurredText="Required" EmptyValueMessage="Invalid Instrument Date" runat="Server"></cc1:MaskedEditValidator>
                            </td>
                            <td>
                                <asp:TextBox ID="txtInstrumentDate" runat="server" Width="80px"></asp:TextBox>
                                <asp:Image ID="imgInstrumentDate" ImageAlign="Top" ImageUrl="../Images/btn_calendar.gif" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                                Document
                                <asp:RequiredFieldValidator ID="RFVDocument" runat="server" ValidationGroup="RequiredPay" InitialValue=""
                                     ControlToValidate="fileUploadPaymentDocument" Text="Required" SetFocusOnError="true" Enabled="false"></asp:RequiredFieldValidator>
                            </td>
                            <td>
                                <asp:FileUpload ID="fileUploadPaymentDocument" runat="server"></asp:FileUpload>
                            </td>
                            <td>
                                Payment Remark
                            ...
                            <td>
                                <asp:TextBox ID="txtPaymentRemark" runat="server" MaxLength="200"></asp:TextBox>
                    ...
                    <legend>Payment History</legend>
                        <asp:GridView ID="gvPaymentHistory" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Remark" DataField="Remark" />
                                <asp:BoundField HeaderText="User" DataField="UserName" />
                                <asp:BoundField HeaderText="Request Date" DataField="CreatedDate" DataFormatString="{0:dd/MM/yyyy hh:mm tt}" />
                                </Columns>
                        </asp:GridView>
                </fieldset>
                <fieldset>
