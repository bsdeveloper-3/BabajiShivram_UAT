...
public partial class AccountExpense_TrackExpenseBooking : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            lblTitle.Text = "Track Expense Booking";
        ...
        DataFilter1.FilterSessionID = "TrackExpenseBooking.aspx";
        DataFilter1.OnDataBound += new DynamicData_Content_DataFilter.BindDataGridView(DataFilter1_OnDataBound);
    }

    protected void btnNew_Click(object sender, EventArgs e)
    {
        Response.Redirect("ExpenseBooking.aspx");
    }
