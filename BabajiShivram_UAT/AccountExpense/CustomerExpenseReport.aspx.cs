...
public partial class AccountExpense_CustomerExpenseReport : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblTitle.Text = "Vendor Payment Report";
    }
    ...
    {
        lblMessage.Text = "";
        string strFileName =  txtCustomer.Text.Trim() + "_Vendor_Pay_" + DateTime.Now.ToString("dd/MM/yyyy hh:mm") + ".xls";
