<%@ Page Title="Credit Vendor Invoice Approval" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PendingInvoiceApprovalCredit.aspx.cs" 
    Inherits="AccountExpense_PendingInvoiceApprovalCredit" EnableEventValidation="false" Culture="en-GB" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <ContentTemplate>
        ...
        <fieldset><legend>Credit Vendor Invoice Approval</legend>
        ...
        <asp:GridView ID="gvDetail" runat="server" AutoGenerateColumns="False" CssClass="table" DataKeyNames="InvoiceId"
            ...
            Width="100%" OnRowCommand="gvDetail_RowCommand" OnRowDataBound="gvDetail_RowDataBound" OnPreRender="gvBJVDetail_PreRender">
            <Columns>
                ...
                <asp:BoundField DataField="InvoiceDate" HeaderText="Invoice Date" SortExpression="InvoiceDate" DataFormatString="{0:dd/MM/yyyy}" Headerstyle-CssClass="HeaderWrap"/>
                <asp:BoundField DataField="InvoiceAging" HeaderText="Invoice Aging" SortExpression="InvoiceAging" Headerstyle-CssClass="HeaderWrap" />
                <asp:BoundField DataField="HODAging" HeaderText="HOD Aging" SortExpression="HODAging" Headerstyle-CssClass="HeaderWrap"/>
                <asp:BoundField DataField="L1Aging" HeaderText="L1 Aging" SortExpression="L1Aging" Headerstyle-CssClass="HeaderWrap"/>
                ...
                <asp:BoundField DataField="VendorSellValue" HeaderText="Selling Value" SortExpression="VendorSellValue" />
                <asp:BoundField DataField="JobMargin" HeaderText="Value" SortExpression="JobMargin" />
                <asp:BoundField DataField="ImmediatePayment" HeaderText="Immediate Payment" SortExpression="ImmediatePayment" Headerstyle-CssClass="HeaderWrap"/>
            </Columns>
            <PagerTemplate>
        ...
        <div>
            <asp:SqlDataSource ID="InvoiceSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                SelectCommand="AC_GetPendingInvoiceForApprovalCredit" SelectCommandType="StoredProcedure">
            </asp:SqlDataSource>
        </div>
    </ContentTemplate>
    </asp:UpdatePanel>
