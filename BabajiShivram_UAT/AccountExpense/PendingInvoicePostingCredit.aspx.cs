...
public partial class AccountExpense_PendingInvoicePostingCredit : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            lblTitle.Text = "Invoice Audit - Credit";
        ...
        DataFilter1.FilterSessionID = "PendingInvoicePostingCredit.aspx";
    ...
    {
        string strFileName = "PendingInvoicePostingCredit" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
