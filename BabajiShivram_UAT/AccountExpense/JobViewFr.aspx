<%@ Page Title="Job Detail" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="JobViewFr.aspx.cs" Inherits="AccountExpense_JobViewFr" %>
                        ...
                        <div>
                            ...
                            <div id="div1">
                                <asp:SqlDataSource ID="DataSourceBillingScrutiny" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                                    ...
                                    <SelectParameters>
                                        <asp:SessionParameter Name="EnqId" SessionField="JobIdV" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
