...
using System.Data;
using System.Text;
public partial class AccountExpense_PendingInvoiceApproval : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            lblTitle.Text = "Pending Approval";
        ...
        DataFilter1.FilterSessionID = "PendingInvoiceApproval.aspx";
    ...
    protected void gvDetail_RowCommand(Object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName.ToLower().Trim() == "approvejob")
        {
            ...
            {
                StatusID = Convert.ToInt32(dsGetPaymentDetails.Tables[0].Rows[0]["lStatus"]);
            ...
            if (StatusID < 115 && StatusID != 112) // 115- Approved/ 112 Mgmt Rejected
            {
    ...
    {
        string strFileName = "PendingInvoiceApproval_" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
