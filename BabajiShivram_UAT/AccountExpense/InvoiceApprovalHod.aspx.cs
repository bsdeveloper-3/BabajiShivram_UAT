...
public partial class AccountExpense_InvoiceApprovalHod : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblTitle.Text = "HOD Approval - Credit Vendor Payment";

        if (Session["InvoiceId"] == null)
        {
            Response.Redirect("PendingInvoiceApprovalHOD.aspx");
        }
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        int result = AccountExpense.AddInvoiceStatus(InvoiceID, 110, strRemark, LoggedInUser.glUserId);

        if (result == 0)
        {
            lblError.Text = "Invoice Payment Approved!";
    ...
    protected void btnHold_Click(object sender, EventArgs e)
    {
        ...
        int result = AccountExpense.AddInvoiceStatus(InvoiceID, 108, strRemark, LoggedInUser.glUserId);
        ...
        if (result == 0)
        {
            ...
            SendHoldRejectMail(InvoiceID, "HOD On Hold", strRemark);
    ...
    protected void btnReject_Click(object sender, EventArgs e)
    {
        ...
        int result = AccountExpense.AddInvoiceStatus(InvoiceID, 109, strRemark, LoggedInUser.glUserId);
        ...
        if (result == 0)
        {
            ...
            SendHoldRejectMail(InvoiceID, "HOD Reject", strRemark);
