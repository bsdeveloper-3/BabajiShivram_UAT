<%@ Page Title="Expense Report" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="VendorExpenseReport.aspx.cs"
    Inherits="AccountExpense_VendorExpenseReport" EnableEventValidation="false" Culture="en-GB" %>
            ...
            <div class="clear"></div>
                ...
                <asp:GridView ID="gvPaymentReport" runat="server" AutoGenerateColumns="False" CssClass="table" DataSourceID="DataSourcePayment">
                    <Columns>
                        ...
                        <asp:BoundField DataField="InstrumentDate" HeaderText="UTR Date" SortExpression="InstrumentNo" DataFormatString="{0:dd/MM/yyyy}"/>
                    </Columns>
                </asp:GridView>
                </div>
        <asp:SqlDataSource ID="DataSourcePayment" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
            SelectCommandType="StoredProcedure" SelectCommand="AC_rptInvoiceExpense" DataSourceMode="DataSet">
            <SelectParameters>
