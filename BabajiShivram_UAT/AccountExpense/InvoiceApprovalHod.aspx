<%@ Page Title="HOD Approval" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="InvoiceApprovalHod.aspx.cs" 
        Inherits="AccountExpense_InvoiceApprovalHod" %>
                ...
                <fieldset>
                    ...
                    <legend>Job Detail</legend>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="lblJobNumber" Width="160px" runat="server" Font-Bold="true" Font-Size="Medium"></asp:Label>
                            </td>
                            <td>LT Ref No
                            </td>
                            <td>
