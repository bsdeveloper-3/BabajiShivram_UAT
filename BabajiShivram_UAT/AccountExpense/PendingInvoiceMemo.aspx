<%@ Page Title="Memo Preparation" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeFile="PendingInvoiceMemo.aspx.cs" Inherits="AccountExpense_PendingInvoiceMemo" %>
    ...
    <div>
        ...
        <asp:UpdatePanel ID="upFillDetails" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                //Loop through the CheckBoxes.
                    for (var i = 1; i < checkBoxes.length; i++) {
                        ...
                        if (checkBoxes[i].checked) {
                            ...
                            decTotalToPay = decTotalToPay + parseFloat(row.cells[10].innerText);
                ...
                //  Display selected Row data in Alert Box.
                    ...
                    objMessage.innerText = "Total Payable: Rs. " + decTotalToPay.toFixed(2);
            ...
            <fieldset><legend>Memo Generation</legend>
            <div class="clear">
            <asp:Panel ID="pnlFilter" runat="server">
                ...
                <div class="fleft" style="margin-left:30px; padding-top:3px;">
                <asp:Button ID="btnMemoGeneration" runat="server" Text="Generate Memo For Payment" OnClick="btnMemoGeneration_Click" OnClientClick="return confirm('Sure to Create Memo for Selected Invoices??');" />
                </div>
            </asp:Panel>
            </div>
            <div class="m clear"></div>
            <asp:GridView ID="gvDetail" runat="server" AutoGenerateColumns="False" CssClass="table" DataKeyNames="InvoiceId,VendorId"
            ...
            <Columns>
                ...
                <%--<asp:BoundField DataField="ToPay" HeaderText="Net Payable" SortExpression="ToPay" />--%>
                 <asp:TemplateField HeaderText="Net Payable" SortExpression="ToPay">
                    <ItemTemplate>
                        <asp:Label ID="lblToPay" runat="server" Text='<%#Eval("ToPay") %>'> </asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
        ...
        <div>
            <asp:SqlDataSource ID="InvoiceSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                SelectCommand="INV_GetPendingInvoiceForMemo" SelectCommandType="StoredProcedure">
            </asp:SqlDataSource>
        </div>
    </ContentTemplate>
    </asp:UpdatePanel>
