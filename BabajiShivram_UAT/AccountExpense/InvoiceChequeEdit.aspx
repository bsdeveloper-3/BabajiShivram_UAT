<%@ Page Title="Edit Invoice" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="InvoiceChequeEdit.aspx.cs" 
    Inherits="AccountExpense_InvoiceChequeEdit" Culture="en-GB" %>
...
<%--    <asp:UpdatePanel ID="upFillDetails" runat="server" UpdateMode="Conditional">
        <ContentTemplate>--%>
            ...
            <fieldset style="width: 80%;">
                <legend>Invoice Submission</legend>
                ...
                <WizardSteps>
                    ...
                    <table border="0" cellpadding="50" cellspacing="50" width="100%" style="font-size:14px" bgcolor="white">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtJobNumber" Width="160px" runat="server" ToolTip="Enter Job Number." Enabled="false">
                                 </asp:TextBox>
                                </td>
                            <td>
                                Type of Expense
                            ...
                            <td>
                                <asp:DropDownList ID="ddlExpenseType" runat="server" AppendDataBoundItems="false" DataSourceID="DataSourceExpense"
                                 Enabled="false" DataTextField="sName" DataValueField="lid" OnSelectedIndexChanged="ddlExpenseType_OnSelectedIndexChanged" AutoPostBack="true">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlPaymentType" runat="server" Enabled="false">
                                    ...
                                    <asp:ListItem Text="NEFT" Value="6"></asp:ListItem>
                                </asp:DropDownList>
                            </td>
                            <td>
                                Advance Received
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <cc1:MaskedEditValidator ID="MskEdtValInvoice" ControlExtender="MskEdtInvoice" ControlToValidate="txtInvoiceDate" IsValidEmpty="false"
                                    ...
                                    MinimumValueMessage="Invalid Invoice Date" MaximumValueMessage="Invoice Invalid Date" MinimumValue="01/04/2021"
                        ...
                        <tr>
                            ...
                            <td>
                                Cheque Amount
                                <asp:RequiredFieldValidator ID="RFVChequeAmount" runat="server" ValidationGroup="JobRequired"
                                    Display="Dynamic" SetFocusOnError="true" ControlToValidate="txtChequeAmount" InitialValue=""
                                    Text="Required" ErrorMessage="Please Enter Cheque Value"> </asp:RequiredFieldValidator>
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtChequeAmount"
                                    SetFocusOnError="true" ErrorMessage="Invalid Cheque Amount." Display="Dynamic"
                                    ValidationGroup="JobRequired" ValidationExpression="^[0-9]\d{0,13}(\.\d{1,2})?$"></asp:RegularExpressionValidator>
                            </td>
                            <td>
                        ...
                        <fieldset>
                            ...
                            <td>
                                ...
                                <cc1:AutoCompleteExtender ID="AutoCompleteConsigneeGSTIN" runat="server" TargetControlID="txtCongisgneeGSTIN"
                                    ...
                                    ServiceMethod="GetCustomerByGSTIN" MinimumPrefixLength="10" BehaviorID="divwidthConsigneeCode"
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="font-size:14px" bgcolor="white">
                        ...
                        <tr>
                            <td>
                             ...
                             <td>   
                                 <asp:TextBox ID="lblTotalTaxableValue" runat="server" Enabled="false" OnTextChanged="lblTotalTaxableValue_TextChanged" AutoPostBack="true"></asp:TextBox>
                             </td>
                             <td>   
                                 Total Tax 
                            </td>
