<%@ Page Title="Audit-Immediate Payment" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeFile="PendingInvoicePosting.aspx.cs" Inherits="AccountExpense_PendingInvoicePosting" EnableEventValidation="false" Culture="en-GB"%>
...
<meta http-equiv="refresh" content="120">
    ...
    <fieldset><legend>Audit-Immediate Payment</legend>
        <div align="center">
    ...
    <div id="BJV_Popup">
        ...
        <div>
            <asp:SqlDataSource ID="InvoiceSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                ...
                <SelectParameters>
                    <asp:Parameter Name="IsImmediatePayment" DefaultValue="true" DbType="Boolean" />
                </SelectParameters>
            </asp:SqlDataSource>
        </div>
</asp:Content>
