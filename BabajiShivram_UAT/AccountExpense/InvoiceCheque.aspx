<%@ Page Title="Vendor Cheque Detail" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="InvoiceCheque.aspx.cs" 
    Inherits="AccountExpense_InvoiceCheque" Culture="en-GB" %>
...
<%--    <asp:UpdatePanel ID="upFillDetails" runat="server" UpdateMode="Conditional">
        <ContentTemplate>--%>
            ...
            <asp:Label ID="lblError" runat="server" EnableViewState="false"></asp:Label>
                ...
                <legend>Cheque Payment Invoice Submission</legend>
                ...
                <WizardSteps>
                    ...
                    <table border="0" cellpadding="50" cellspacing="50" width="100%" style="font-size:14px" bgcolor="white">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtJobNumber" Width="160px" runat="server" ToolTip="Enter Job Number." Enabled="false"></asp:TextBox>
                            </td>
                            <td>
                                Type of Expense
                            ...
                            <td>
                                <asp:DropDownList ID="ddlExpenseType" runat="server">
                                    ...
                                    <asp:ListItem Text="CFS Payment" Value="2"></asp:ListItem>
