...
using System.IO;
public partial class AccountExpense_PendingInvoicePostingFinal : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            lblTitle.Text = "Pending Audit - Final";
        ...
        DataFilter1.FilterSessionID = "PendingInvoicePostingFinal.aspx";
    ...
    {
        string strFileName = "PendingInvoicePostingFinal" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
