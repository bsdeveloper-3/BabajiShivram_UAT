<%@ Page Title="Edit Vendor invoice" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeFile="PaymentRequestEdit2.aspx.cs" Inherits="AccountExpense_PaymentRequestEdit2" Culture="en-GB" %>
...
<%--    <asp:UpdatePanel ID="upFillDetails" runat="server" UpdateMode="Conditional">
        <ContentTemplate>--%>
            ...
            <asp:HiddenField ID="hdnIsCreditVendor" runat="server" Value="0" />
                ...
                <WizardSteps>
                    ...
                    <table border="0" cellpadding="50" cellspacing="50" width="100%" style="font-size:14px" bgcolor="white">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:RadioButtonList ID="rblCreditVendor" runat="server" RepeatDirection="Horizontal" Enabled="false">
                                    <asp:ListItem Text="Yes" Value="1"></asp:ListItem>
                                    <asp:ListItem Text="No" Value="0" Selected="True"></asp:ListItem>
                                </asp:RadioButtonList>
                            </td>
                    ...
                    <asp:WizardStep ID="stpVendor" runat="server" Title="Vendor /Invoice Party" AllowReturn="true" StepType="Step">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtVendorName" runat="server" Width="260px" Enabled="false"></asp:TextBox>
                        ...
                        <tr>
                            <td>Vendor Payment Due Date
                                ...
                                <cc1:MaskedEditValidator ID="MskEdtValPayDueDate" ControlExtender="MskEdtPayDueDate" ControlToValidate="txtPaymentDueDate" IsValidEmpty="false"
                                    ...
                                    MinimumValue='<%#DateTime.Now.AddDays(-100).ToString("dd/MM/yyyy") %>' MaximumValue='<%#DateTime.Now.AddDays(100).ToString("dd/MM/yyyy") %>'
                            ...
                            <td>Payment Required Date
                                ...
                                <cc1:MaskedEditValidator ID="MskEdtValPayReqrdDate" ControlExtender="MskEdtPayReqrdDate" ControlToValidate="txtPaymentRequiredDate" IsValidEmpty="false"
                                    ...
                                    MinimumValueMessage="Invalid Payment Required Date" MaximumValueMessage="Invalid Payment Required Date" ValidationGroup="InvoiceRequired"
