<%@ Page Title="Invoice Payment" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeFile="PendingInvoicePayment.aspx.cs" Inherits="AccountExpense_PendingInvoicePayment" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <fieldset><legend>Vendor Invoice Payment</legend>
        <div align="left">
            &nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="lblMessage" runat="server" CssClass="errorMsg" EnableViewState="false" Font-Size="Medium" ></asp:Label>
        </div>
        ...
        <div class="clear">
            <asp:Panel ID="pnlFilter" runat="server">
                ...
                <div class="fleft" style="margin-left:30px; padding-top:3px;">
                    <asp:Button ID="btnConsolePayment" runat="server" Text="Consolidate Payment" Visible="true" OnClick="btnConsolePayment_Click" OnClientClick="return confirm('Sure to Update Payment as Consolidated ?');" />
                </div>
            </asp:Panel>
        </div>
            ...
            <Columns>
                ...
                <asp:BoundField DataField="PaymentRequiredDate" HeaderText="Payment Required Date" SortExpression="PaymentRequiredDate" DataFormatString="{0:dd/MM/yyyy}"/>
                 <asp:TemplateField HeaderText="Net Payable" SortExpression="ToPay">
                    <ItemTemplate>
                        <asp:Label ID="lblToPay" runat="server" Text='<%#Eval("PaidAmount") %>'> </asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
        ...
        <div>
            <asp:SqlDataSource ID="InvoiceSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                SelectCommand="AC_GetPendingInvoiceForPayment" SelectCommandType="StoredProcedure">
            </asp:SqlDataSource>
        </div>
</asp:Content>
