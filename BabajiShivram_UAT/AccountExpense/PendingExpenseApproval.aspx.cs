...
public partial class AccountExpense_PendingExpenseApproval : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            lblTitle.Text = "Pending Expense Approval";

            if (gvDetail.Rows.Count == 0)
            {
                lblMessage.Text = "No Detail Found!";
        ...
        //
        DataFilter1.DataSource = BookingSqlDataSource;
        DataFilter1.DataColumns = gvDetail.Columns;
        DataFilter1.FilterSessionID = "PendingExpenseApproval.aspx";
    ...
    protected void gvDetail_RowCommand(Object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            string strBookingId = (string)e.CommandArgument;

            Session["BookingId"] = strBookingId;
    ...
    {
        string strFileName = "ExpenseBooking" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
    ...
    private void ExportFunction(string header, string contentType)
    {
        ...
        gvDetail.Caption = "ExpenseBooking On " + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt");
