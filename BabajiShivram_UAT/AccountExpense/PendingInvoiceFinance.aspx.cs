...
using System.Data;
using System.Text;
public partial class AccountExpense_PendingInvoiceFinance : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DataFilter1.FilterSessionID = "PendingInvoiceFinance.aspx";
    ...
    protected void gvDetail_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (DataBinder.Eval(e.Row.DataItem, "lStatus") != DBNull.Value)
            {
                ...
                // Invoice Approval
                ImageButton imgInvoiceApprove = (ImageButton)e.Row.FindControl("btnInvoiceApprove");
                ImageButton imgInvoiceReject = (ImageButton)e.Row.FindControl("btnInvoiceReject");

                // Payment Approval
                //ImageButton imgPaymentApprove = (ImageButton)e.Row.FindControl("btnPaymentApprove");
                
                ImageButton imgPaymentHold = (ImageButton)e.Row.FindControl("btnPaymentHold");
                ...
                if (StatusId == 141) // Audit L2 ON Hold
                {
                    ...
                    //   imgInvoiceApprove.Visible = false;
                    //   imgInvoiceReject.Visible = false;

                    //imgPaymentApprove.Visible = true;
                    imgPaymentHold.Visible = false;
                }
                else if (StatusId == 148) // Finanace Rejected
                {
                ...
                //if (StatusId == 140) // Audit Complete - 
                //{
                //    e.Row.BackColor = System.Drawing.Color.FromName("#87AFC7");  //LightSalmon;    
                //    e.Row.ToolTip = strStatusName;

                //    imgInvoiceApprove.Visible = true;
                //    imgInvoiceReject.Visible = true;

                //    imgPaymentApprove.Visible = false;
                //    imgPaymentHold.Visible = false;
                //}
                //else if (StatusId == 145) // Finance Approved
                //{
                //    e.Row.BackColor = System.Drawing.Color.FromName("#E8ADAA");  //#E77471
                //    e.Row.ToolTip = strStatusName;
    ...
    protected void btnApproveInvoice_OnClick(object sender, EventArgs e)
    {
        if (txtReason.Text.Trim() != "")
        {
            ...
            if (InvoiceID > 0 && BillType == 0 && isStatusChanged == false)
            {
            ...
            else if (InvoiceID > 0 && BillType == 10 && isStatusChanged == false)// Vendor Cheque Payment
            {
                int ApprovedJobExp = AccountExpense.AddInvoiceStatus(InvoiceID, 145, txtReason.Text.Trim(), LoggedInUser.glUserId);
            ...
            else if (InvoiceID > 0 && BillType == 11 && isStatusChanged == false)// PD Account - Payment Not From Live Tracking
            {
                int ApprovedJobExp = AccountExpense.AddInvoiceStatus(InvoiceID, 145, txtReason.Text.Trim(), LoggedInUser.glUserId);
                ...
                {
                    gvDetail.DataBind();
                    lblMessage.Text = "Successfully Completed Invoice Audit L2. PD Account Payment Not From Live Tracking.";
                    lblMessage.CssClass = "success";
                }
                else if (ApprovedJobExp == 2)
                {
    ...
    {
        string strFileName = "PendingInvoiceFinance_" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
