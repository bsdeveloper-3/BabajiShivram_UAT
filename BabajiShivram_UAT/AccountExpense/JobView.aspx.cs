...
public partial class AccountExpense_JobView : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else if (!IsPostBack)
        {
            ...
            Get_BillingInstruction(Convert.ToInt32(Session["JobIdV"]));
    ...
    protected void PCDDocumentSqlDataSource_Selected(object sender, SqlDataSourceStatusEventArgs e)
    {
        if (e.Exception != null)
        {
            ...
            ErrorLog.LogToDatabase(Convert.ToInt32(Session["JobIdV"]), "PCDDocumentSqlDataSource_Selected:JobView.aspx",
