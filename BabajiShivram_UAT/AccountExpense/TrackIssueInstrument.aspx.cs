...
using System.IO;
public partial class AccountExpense_TrackIssueInstrument : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            lblTitle.Text = "Track Issue Instrument";
        ...
        DataFilter1.FilterSessionID = "IssueInstrument.aspx";
        DataFilter1.OnDataBound += new DynamicData_Content_DataFilter.BindDataGridView(DataFilter1_OnDataBound);
    }

    protected void btnNew_Click(object sender, EventArgs e)
    {
        Response.Redirect("IssueInstrument.aspx");
    }
    ...
    {
        string strFileName = "Issue_Instrument_" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
    ...
    private void ExportFunction(string header, string contentType)
    {
        ...
        gvDetail.Caption = "Issue Instrument On " + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt");
