<%@ Page Title="Pending Expense Approval" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeFile="PendingExpenseApproval.aspx.cs" Inherits="AccountExpense_PendingExpenseApproval" Culture="en-GB" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<%@ Register Src="~/DynamicData/Content/GridViewPager.ascx" TagName="GridViewPager" TagPrefix="asp" %>
<%@ Register Src="~/DynamicData/Content/DataFilter.ascx" TagName="DataFilter" TagPrefix="uc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <fieldset><legend>Expense Booking Approval</legend>
        <div align="center">
        ...
        <div>
            <asp:SqlDataSource ID="BookingSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                SelectCommand="AC_FAGetExpenseBooking" SelectCommandType="StoredProcedure">
            </asp:SqlDataSource>
        </div>
</asp:Content>
