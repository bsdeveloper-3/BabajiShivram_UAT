...
using System.IO;
public partial class AccountExpense_PendingInvoiceMemoApproval : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            lblTitle.Text = "Payment Memo Approval";
        ...
        DataFilter1.FilterSessionID = "PendingInvoiceMemoApproval.aspx";
        ...
        foreach (GridViewRow gvr1 in gvDetail.Rows)
        {
            if (gvr1.RowType == DataControlRowType.DataRow)
            {
                ...
                if (chk1.Checked)
                {
                    ...
                    int Result = AccountExpense.AddInvoiceMemoApproval(MemoId, ApprovalStatus, InvoiceStatus, LoggedInUser.glUserId);
                    
                    if (Result == 0)
                    {
                        lblMessage.Text = "Vendor Payment Memo Approved Successfully!";
                        lblMessage.CssClass = "success";

                    }
                    else
                    {
                        lblMessage.Text = "Memo details Not Found For Payment!";
                        lblMessage.CssClass = "errorMsg";
                    }
                }
            }
