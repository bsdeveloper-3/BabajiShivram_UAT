...
public partial class AccountExpense_PendingInvoicePosting : System.Web.UI.Page
{
    ...
    {
        string strFileName = "PendingInvoicePosting" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
