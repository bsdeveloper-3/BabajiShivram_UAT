<%@ Page Title="Credit Vendor Payment" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeFile="PendingPaymentAPICredit.aspx.cs" Inherits="AccountExpense_PendingPaymentAPICredit" EnableEventValidation="false" %>
...
<asp:ScriptManager runat="server" ID="ScriptManager1" />
    ...
    <asp:UpdatePanel ID="upReport" runat="server" UpdateMode="Conditional" RenderMode="Inline">
       <ContentTemplate> 
    <fieldset><legend>API - Credit Invoice Payment</legend>
        <div align="center">
        ...
        <asp:GridView ID="gvDetail" runat="server" AutoGenerateColumns="False" CssClass="table" DataKeyNames="InvoiceId"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="StatusName" HeaderText="Status" SortExpression="BilledStatus"/>
        ...
        <div>
            <asp:SqlDataSource ID="InvoiceSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                SelectCommand="AC_GetPendingPaymentAPICredit" SelectCommandType="StoredProcedure">
                <SelectParameters>
