<%@ Page Title="Final Invoice" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeFile="InvoiceFinal2.aspx.cs" Inherits="AccountExpense_InvoiceFinal2" Culture="en-GB" %>
...
<%--    <asp:UpdatePanel ID="upFillDetails" runat="server" UpdateMode="Conditional">
        <ContentTemplate>--%>
            ...
            <fieldset style="width: 80%;">
                <legend>Final Invoice Submission</legend>
                ...
                <WizardSteps>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlExpenseType" runat="server" AppendDataBoundItems="true" DataSourceID="DataSourceExpense"
                                 Enabled="false" DataTextField="sName" DataValueField="lid" OnSelectedIndexChanged="ddlExpenseType_OnSelectedIndexChanged" AutoPostBack="true">
                                    <asp:ListItem Text="Other Payment" Value="6"></asp:ListItem>
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="rfvInvoiceType" runat="server" ValidationGroup="JobRequired"
                                    Display="Dynamic" SetFocusOnError="true" ControlToValidate="ddInvoiceType" InitialValue="0"
                            ...
                            <td>
                                <asp:DropDownList ID="ddGSTINType" runat="server" Enabled="false">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <cc1:MaskedEditValidator ID="MskEdtValInvoice" ControlExtender="MskEdtInvoice" ControlToValidate="txtInvoiceDate" IsValidEmpty="false"
                                    ...
                                    MinimumValueMessage="Invalid Invoice Date" MaximumValueMessage="Invoice Invalid Date" MinimumValue="01/04/2023"
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="white">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="lblProformaTotalInvoiceValue" runat="server" Font-Bold="true" Font-Size="Large"></asp:Label>
                            </td>
                            <td>
                                Paid Amount
                            </td>
                            <td>
                                <asp:Label ID="lblPaidAmount" runat="server" Font-Bold="true" Font-Size="Large"></asp:Label>
                            </td>
                        </tr>
                         <tr>
                            <td>
                        ...
                        <tr>
                            <td>Vendor Payment Due Date
                                ...
                                <cc1:MaskedEditValidator ID="MskEdtValPayDueDate" ControlExtender="MskEdtPayDueDate" ControlToValidate="txtPaymentDueDate" IsValidEmpty="false"
                                    ...
                                    MinimumValue='<%#DateTime.Now.ToString("dd/MM/yyyy") %>' MaximumValue='12/12/2025'
                            ...
                            <td>Payment Required Date
                                ...
                                <cc1:MaskedEditValidator ID="MskEdtValPayReqrdDate" ControlExtender="MskEdtPayReqrdDate" ControlToValidate="txtPaymentRequiredDate" IsValidEmpty="false"
                                    ...
                                    MinimumValueMessage="Invalid Payment Requirede Date" MaximumValueMessage="Invalid Payment Required Date" ValidationGroup="InvoiceRequired"
