<%@ Page Title="Vendor Memo Payment" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeFile="PendingInvoiceMemoPayment.aspx.cs" Inherits="AccountExpense_PendingInvoiceMemoPayment" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div>
        ...
        <asp:UpdatePanel ID="upFillDetails" runat="server" UpdateMode="Conditional">
            ...
            <fieldset><legend>Vedndor Memo Payment</legend>
            <div class="clear">
            <asp:Panel ID="pnlFilter" runat="server">
                ...
                <div class="fleft" style="margin-left:30px; padding-top:3px;">
                <asp:Button ID="btnPayMemo" runat="server" Text="API - Initiate Payment To Vendor " OnClick="btnPayMemo_Click" OnClientClick="return confirm('Sure to Pay Memo Amount To Vendor?');" />
                </div>
            </asp:Panel>
            </div>
        ...
        <div>
            <asp:SqlDataSource ID="InvoiceSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                SelectCommand="INV_GetPendingMemoForPayment" SelectCommandType="StoredProcedure">
            </asp:SqlDataSource>
        </div>
    </ContentTemplate>
    </asp:UpdatePanel>
