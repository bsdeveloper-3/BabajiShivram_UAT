<%@ Page Title="Pending Operation" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ExpPendingOperation.aspx.cs" 
    Inherits="FreightExport_ExpPendingOperation" Culture="en-GB"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div>
        <asp:UpdateProgress ID="updProgress" AssociatedUpdatePanelID="updateExportOperation" runat="server">
            <ProgressTemplate>
    ...
    <asp:UpdatePanel ID="updateExportOperation" runat="server" UpdateMode="Conditional" RenderMode="Inline">
        <ContentTemplate>
            <fieldset><legend>Pending Operation</legend>
            <div class="m clear">
                <div class="fleft">
<%--                    <asp:LinkButton ID="lnkexport" runat="server" OnClick="lnkexport_Click">
            ...
            <div>
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="ExportTypeName" HeaderText="Export Type" SortExpression="ExportTypeName"/>
                ...
                <asp:SqlDataSource ID="GridViewSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                    SelectCommand="FOP_GetExpOperation" SelectCommandType="StoredProcedure">
                    <SelectParameters>
