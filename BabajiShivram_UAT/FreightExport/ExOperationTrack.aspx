<%@ Page Title="Tracking" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ExOperationTrack.aspx.cs"
    Inherits="FreightExport_ExOperationTrack" Culture="en-GB" %>
                ...
                <div>
                    <asp:GridView ID="gvFreight" runat="server" DataSourceID="GridViewSqlDataSource" DataKeyNames="EnqId" Width="100%"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="StatusName" HeaderText="Status Complete" SortExpression="StatusName" />
...
<%--                            <asp:TemplateField SortExpression="BillingKPI">
                    ...
                    <asp:SqlDataSource ID="GridViewSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                        SelectCommand="FOP_GetExpOperationTracking" SelectCommandType="StoredProcedure">
                        <SelectParameters>
