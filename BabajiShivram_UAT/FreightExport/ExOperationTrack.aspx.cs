...
using System.IO;
public partial class FreightExport_ExOperationTrack : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DataFilter1.FilterSessionID = "ExOperationTrack.aspx";
    ...
    protected void gvFreight_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName.ToLower() == "navigate")
        {
            ...
            Response.Redirect("ExTrackingDetail.aspx");
        }
    }
    ...
    {
        string strFileName = "Freight_Export" + DateTime.Now.ToString("dd/MM/yyyy hh:mm tt") + ".xls";
