<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ExpPendingPreAlert.aspx.cs" 
    Inherits="FreightExport_ExpPendingPreAlert" Culture="en-GB" %>
...
<asp:UpdatePanel ID="updateExportOperation" runat="server" UpdateMode="Conditional" RenderMode="Inline">
        <ContentTemplate>
            <fieldset><legend>Pending Customer PreAlert</legend>
            <div class="m clear">
                <div class="fleft">
<%--                    <asp:LinkButton ID="lnkexport" runat="server" OnClick="lnkexport_Click">
            ...
            <div>
                ...
                <asp:SqlDataSource ID="GridViewSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                    SelectCommand="FOP_GetExpPreAlert" SelectCommandType="StoredProcedure">
                    <SelectParameters>
