<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ExpPendingVGM.aspx.cs"
    Inherits="FreightExport_ExpPendingVGM" Culture="en-GB"%>
...
<asp:UpdatePanel ID="updateExportOperation" runat="server" UpdateMode="Conditional" RenderMode="Inline">
        <ContentTemplate>
            <fieldset><legend>Pending VGM/Form13</legend>
            <div class="m clear">
                <div class="fleft">
            ...
            <div>
               ...
               <%--     <asp:BoundField DataField="ENQRefNo" HeaderText="Enquiry No" Visible="false" />--%>
                ...
                <asp:SqlDataSource ID="GridViewSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                    SelectCommand="FOP_GetVGMForm13" SelectCommandType="StoredProcedure">
                    <SelectParameters>
