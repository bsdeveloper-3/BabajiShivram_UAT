<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ExpPendingShipOnboard.aspx.cs" 
    Inherits="FreightExport_ExpPendingShipOnboard" Culture="en-GB" %>
...
<asp:UpdatePanel ID="updateExportOperation" runat="server" UpdateMode="Conditional" RenderMode="Inline">
        <ContentTemplate>
            <fieldset><legend>Pending Shipped On Board</legend>
            <div class="m clear">
                <div class="fleft">
<%--                    <asp:LinkButton ID="lnkexport" runat="server" OnClick="lnkexport_Click">
            ...
            <div>
                ...
                <asp:SqlDataSource ID="GridViewSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConBSImport %>"
                    SelectCommand="FOP_GetExpShipOnBoard" SelectCommandType="StoredProcedure">
                    <SelectParameters>
